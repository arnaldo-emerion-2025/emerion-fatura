inherited fmFatR17: TfmFatR17
  Left = 0
  Caption = 'Relação Analitica de Notas com Tributação de IPI'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação Analitica de Notas com Tributação de IPI'#13#10#13#10
      BandColor = clWhite
