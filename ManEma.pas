...
begin
  ...
  lbPesLiqDes.Caption := FormatFloat('#,##0.00', vlPesLiqDes);
  lbPesDes.Caption := FormatFloat('#,##0.00', vlPesDes);

end;

procedure TfmManEma.ppPesDesBeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
...
procedure TfmManEma.RLBand5BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  QtdCar: real;
begin
...
procedure TfmManEma.RLReport1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  vlPesDes := 0;
  vlPesLiqDes := 0;
