object fmLote: TfmLote
  ...
  object Panel2: TPanel
    ...
    object EdQLote: TdxDBColorCurrencyEdit
      Tag = 1
      Left = 116
      Top = 1
      Width = 79
    ...
    object EdVPMC: TdxDBColorCurrencyEdit
      Tag = 4
      Left = 196
      Top = 1
      Width = 130
    ...
    object EdDFab: TdxDBColorDateEdit
      Tag = 2
      Left = 327
      Top = 1
      Width = 113
    ...
    object EdDVal: TdxDBColorDateEdit
      Tag = 3
      Left = 441
      Top = 1
      Width = 113
  ...
  object updLote: TUpdateSQL
    ...
    DeleteSQL.Strings = (
      'delete from FATPED_LOTE'
      'where'
      '  ID = :OLD_ID')
    Left = 200
    Top = 88
  end
  object fatPedLote: TwwQuery
    Tag = 99
    CachedUpdates = True
    AfterOpen = fatPedLoteAfterOpen
    AfterInsert = fatPedLoteAfterInsert
    BeforeEdit = fatPedLoteBeforeEdit
    AfterCancel = fatPedLoteAfterCancel
    DatabaseName = 'ISade'
    SQL.Strings = (
      'select * from FATPED_LOTE l'
      'where '
      '   l.codemp = :CODEMP and'
      '   l.dteres = :DTERES and'
      '   l.numres = :NUMRES and'
