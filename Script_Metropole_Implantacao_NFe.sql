--Scrip para METROPOLE - implantação da NF-e
...
ADD flgapr CHAR(1),
ADD flgqtd CHAR(1);
--ALTER TABLE FATPED ADD flgapr CHAR(1);
--
...
--Operação 8,5
--primeiro acertar os campos
alter table lojfat add flgnfe char(3);
alter table cmpnfs add flgnfe char(3);
--segundo alterar o texto das before update das tabelas fatped, fatdev e fatager




--Operação 9
update geremp set qtdnfs = 1, nronfs = 1 where codemp = 1
...
select fp.numres, fp.flgnfe, fp.envnfe from fatped fp where fp.numres>10860
