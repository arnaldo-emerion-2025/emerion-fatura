object FrmEditNfe: TFrmEditNfe
  ...
  object cdsProd: TClientDataSet
    ...
    Left = 536
    Top = 274
    object cdsProdCODCLP: TStringField
      FieldName = 'CODCLP'
      Size = 1
    end
    object cdsProdCODGRU: TStringField
      FieldName = 'CODGRU'
      Size = 3
    end
    object cdsProdCODSUB: TStringField
      FieldName = 'CODSUB'
      Size = 4
    end
    ...
    object cdsProdDESCRICAOPRO: TStringField
      FieldName = 'DESCRICAOPRO'
      Size = 120
    end
    object cdsProdNCM: TStringField
      FieldName = 'NCM'
      Size = 8
    end
    object cdsProdORIG: TStringField
      FieldName = 'ORIG'
      Size = 1
    end
    object cdsProdCSTICMS: TFloatField
      FieldName = 'CSTICMS'
    end
    object cdsProdCFOP: TStringField
      FieldName = 'CFOP'
      Size = 5
    end
    ...
    object cdsProdQTDPRO: TFloatField
      FieldName = 'QTDPRO'
    end
    object cdsProdVALUNITARIO: TFloatField
      FieldName = 'VALUNITARIO'
    end
    object cdsProdVALDESC: TFloatField
      FieldName = 'VALDESC'
    end
    object cdsProdVALLIQ: TFloatField
      FieldName = 'VALLIQ'
    end
    object cdsProdBASICMS: TFloatField
      FieldName = 'BASICMS'
    end
    object cdsProdALIQICMS: TFloatField
      FieldName = 'ALIQICMS'
    end
    object cdsProdVALICMS: TFloatField
      FieldName = 'VALICMS'
    end
    object cdsProdALIQIPI: TFloatField
      FieldName = 'ALIQIPI'
    end
    object cdsProdVALIPI: TFloatField
      FieldName = 'VALIPI'
    end
    object cdsProdCSTIPI: TFloatField
      FieldName = 'CSTIPI'
    end
    object cdsProdVALSUB: TFloatField
      FieldName = 'VALSUB'
    end
    object cdsProdBASESUB: TFloatField
      FieldName = 'BASESUB'
    end
  end
