inherited fmFatR12: TfmFatR12
  Left = 0
  Caption = 'Relação de Pedidos Faturados no Periodo'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grFat: TdxDBGrid
    ...
    object grFatDTERES: TdxDBGridDateColumn
      Caption = 'Emitido Em'
      Width = 98
      BandIndex = 0
      RowIndex = 0
    ...
    object grFatDTEFAT: TdxDBGridDateColumn
      Caption = 'Faturado Em '
      Width = 104
      BandIndex = 0
      RowIndex = 0
    ...
    object grFatNOMVEN: TdxDBGridMaskColumn
      Caption = 'Vendedor'
      Width = 115
      BandIndex = 0
      RowIndex = 0
    ...
    object grFatNOMCLI: TdxDBGridMaskColumn
      Caption = 'Cliente'
      Width = 168
      BandIndex = 0
      RowIndex = 0
  ...
  object FatPed: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           PedLib.DteFat,'
        ...
        '           TextoOcor(IntStrZeros(PedRes.CodCli,05),'#39'-'#39',FinCli.Ap' +
        'eCli,'#39#39','#39#39','#39#39','#39#39') as NomCli,'
      
        '           TextoOcor(IntStrZeros(PedRes.CodVen,05),'#39'-'#39',FinVen.Ap' +
      ...
      'From PedLib LEFT JOIN PedRes ON (PedLib.CodEmp = PedRes.CodEmp)'
        ...
        '                         LEFT JOIN FinCli ON (PedRes.CodCli = Fi' +
        'nCli.CodCli)'
      
        '                       LEFT JOIN FinVen ON (PedRes.CodVen = FinV' +
        'en.CodVen)'
    ...
    object FatPedNOMVEN: TStringField
      FieldName = 'NOMVEN'
      FixedChar = True
      Size = 100
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Pedidos Faturados no Periodo'#13#10#13#10
      BandColor = clWhite
