inherited fmFatR09: TfmFatR09
  Left = 0
  Caption = 'Relação de Itens Faturados'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object bPsqPfa: TSpeedButton
    ...
    Width = 23
    Height = 21
    Hint = 'Pesquisar Royats Existentes'
    Flat = True
    Glyph.Data = {
      36030000424D3603000000000000360000002800000010000000100000000100
      18000000000000030000C40E0000C40E00000000000000000000C0CFD0C0CFD0
  ...
  object grFat: TdxDBGrid
    ...
    object grFatCLIENTE: TdxDBGridMaskColumn
      Sorted = csUp
      Visible = False
      Width = 624
      BandIndex = 0
    ...
    object grFatITEM: TdxDBGridMaskColumn
      Width = 617
      BandIndex = 0
      RowIndex = 0
      FieldName = 'ITEM'
    end
    object grFatULTQTS: TdxDBGridMaskColumn
  ...
  object FatPed: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           PedLb2.UltQts,'
        ...
        'CodPro,'#39'-'#39',PedLb2.DesLb2) as Item'
    ...
    object FatPedITEM: TStringField
      DisplayLabel = 'Item'
      FieldName = 'ITEM'
      FixedChar = True
      Size = 100
    end
    object FatPedULTQTS: TFloatField
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Itens Faturados'#13#10#13#10
      BandColor = clWhite
