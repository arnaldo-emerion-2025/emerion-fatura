inherited fmFatR11: TfmFatR11
  Left = 553
  Top = 205
  Caption = 'Devoluções de Pedidos Realizadas no Periodo'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grCre: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          item
            ColumnName = 'grCreTOTDEV'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grCreTOTIPI'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grCreTOTCOM'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end>
        Name = 'grCreSummaryGroup1'
      end>
    SummarySeparator = ', '
    BorderStyle = bsNone
    Color = clInfoBk
    ...
    OptionsCustomize = [edgoBandPanelSizing, edgoBandSizing, edgoColumnMoving, edgoColumnSizing, edgoExtCustomizing, edgoFullSizing, edgoRowSizing]
    ...
    ShowRowFooter = True
    OnReloadGroupList = grCreReloadGroupList
    object grCreNUMRES: TdxDBGridMaskColumn
    ...
    object grCreDTERES: TdxDBGridDateColumn
      Caption = 'Faturado Em '
      Width = 107
      BandIndex = 0
      RowIndex = 0
    ...
    object grCreNUMNFS: TdxDBGridMaskColumn
      Alignment = taLeftJustify
      Caption = 'Nota Fiscal'
      Width = 86
      BandIndex = 0
    ...
    object grCreNFSDEV: TdxDBGridMaskColumn
      Caption = 'NF. Cliente'
      Sorted = csUp
      Width = 91
      BandIndex = 0
    ...
    object grCreNFSCLI: TdxDBGridMaskColumn
      Caption = 'NF. Devolução'
      Width = 98
      BandIndex = 0
      RowIndex = 0
      FieldName = 'NFSCLI'
    end
    object grCreDTEDEV: TdxDBGridDateColumn
      Width = 95
      BandIndex = 0
      RowIndex = 0
      FieldName = 'DTEDEV'
    end
    object grCreNOMCLI: TdxDBGridMaskColumn
      Width = 125
      BandIndex = 0
      RowIndex = 0
      FieldName = 'NOMCLI'
    end
    object grCreNOMVEN: TdxDBGridMaskColumn
      Width = 109
      BandIndex = 0
      RowIndex = 0
      FieldName = 'NOMVEN'
    end
    object grCreTOTDEV: TdxDBGridMaskColumn
    ...
    object grCreTOTIPI: TdxDBGridColumn
    ...
    object grCreTOTCOM: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 94
      BandIndex = 0
      RowIndex = 0
    ...
    object grCreOBSDEV: TdxDBGridMemoColumn
      Width = 159
      BandIndex = 0
      RowIndex = 0
      FieldName = 'OBSDEV'
    end
    object grCreLOGUSU: TdxDBGridMaskColumn
      Width = 101
      BandIndex = 0
      RowIndex = 0
      FieldName = 'LOGUSU'
  ...
  object FatCre: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           HreDev,'
        ...
        '           TextoOcor(IntStrZeros(CodCli,05),'#39'-'#39',ApeCli,'#39#39','#39#39','#39#39',' +
        #39#39') as NomCli,'
      
        '           TextoOcor(IntStrZeros(CodVen,05),'#39'-'#39',ApeVen,'#39#39','#39#39','#39#39',' +
        #39#39') as NomVen,'
      
        '           TextoOcor(IntStrZeros(CodUsu,03),'#39'-'#39',LogUsu,'#39#39','#39#39','#39#39',' +
        #39#39') as LogUsu,'
      '           TotIpi,'
      '           TotDev,'
      '           BasCom,'
      ...
      'From FatR11'
      'Where SeqArq = :SeqArq'
      'Order by DteDev,CodEmp,DteRes,NumRes')
    ...
    object FatCreDTEDEV: TDateTimeField
      DisplayLabel = 'Devolvido Em '
      FieldName = 'DTEDEV'
    end
    object FatCreHREDEV: TStringField
      DisplayLabel = 'Hora'
      FieldName = 'HREDEV'
      FixedChar = True
      Size = 8
    ...
    object FatCreNOMVEN: TStringField
    ...
    object FatCreTOTDEV: TFloatField
    ...
    object FatCreBASCOM: TFloatField
      DisplayLabel = 'Base Comissão'
      FieldName = 'BASCOM'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object FatCreTOTCOM: TFloatField
      DisplayLabel = 'Total Debitos'
      FieldName = 'TOTCOM'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object FatCreOBSDEV: TMemoField
    ...
    object FatCreTOTIPI: TFloatField
      FieldName = 'TOTIPI'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object FatCreNFSCLI: TIntegerField
      FieldName = 'NFSCLI'
    end
    object FatCreNFSDEV: TIntegerField
      FieldName = 'NFSDEV'
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Devoluções de Pedidos Realizadas no Periodo'#13#10
      BandColor = clWhite
