inherited fmRomR01: TfmRomR01
  Left = 0
  Caption = 'Relação de Romaneios Emitidos no Periodo'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grOrc: TdxDBGrid
    ...
    object grOrcDTERES: TdxDBGridDateColumn
      Caption = 'Emitido Em'
      Width = 91
      BandIndex = 0
      RowIndex = 0
    ...
    object grOrcDTEORC: TdxDBGridDateColumn
      Caption = 'Faturado Em '
      Width = 108
      BandIndex = 0
      RowIndex = 0
    ...
    object grOrcNOMVEN: TdxDBGridMaskColumn
      Caption = 'Vendedor'
      Width = 207
      BandIndex = 0
      RowIndex = 0
    ...
    object grOrcNOMCLI: TdxDBGridMaskColumn
      Caption = 'Cliente'
      Width = 248
      BandIndex = 0
      RowIndex = 0
    ...
    object grOrcAPETRA: TdxDBGridColumn
  ...
  object FatOrc: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           FatOrc.DteOrc,'
        ...
        ' = FatOrc.TraSda) as ApeTra,'
      
        '           TextoOcor(IntStrZeros(FatOrc.CodCli,05),'#39'-'#39',FinCli.Ap' +
        'eCli,'#39#39','#39#39','#39#39','#39#39') as NomCli,'
      
        '           TextoOcor(IntStrZeros(FatOrc.CodVen,05),'#39'-'#39',FinVen.Ap' +
    ...
    object FatOrcNOMVEN: TStringField
      FieldName = 'NOMVEN'
      FixedChar = True
      Size = 100
    end
    ...
    object FatOrcAPETRA: TStringField
      FieldName = 'APETRA'
      FixedChar = True
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Romaneios Emitidos no Periodo'#13#10#13#10
      BandColor = clWhite
