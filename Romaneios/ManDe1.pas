...
begin
  ...
  begin
    ...
    begin
      ...
      if CodEmp > 0 then
        fmManDep.FatDep.Locate('CodEmp;DteRes;NumRes;SeqLib;SeqDep', VarArrayOf([CodEmp, DteRes, NumRes, SeqLib, SeqDep]), [loPartialKey]);
    ...
    try
      ...
      begin
        ...
        begin
          ...
          if Trim(FatDe2CodGru.Value) <> '' then
            Text := Text + ' and EstPro.CodGru = ''' + FatDe2CodGru.Value + '''';
          if Trim(FatDe2CodSub.Value) <> '' then
            Text := Text + ' and EstPro.CodSub = ''' + FatDe2CodSub.Value + '''';
          if Trim(FatDe2CodPro.Value) <> '' then
            Text := Text + ' and EstPro.CodPro = ''' + FatDe2CodPro.Value + '''';
...
begin
  ...
  begin
    ...
    if FatDepDteDep.Value = 0 then
      fmsgErro('Campo de Preenchimento Obrigatorio não Informado', EdDteDep);
    ...
    begin
      ...
      if FatDepDteRes.Value = 0 then
        fmsgErro('Campo de Preenchimento Obrigatorio não Informado.', EdDteRes);
      if FatDepNumRes.Value = 0 then
        fmsgErro('Campo de Preenchimento Obrigatorio não Informado.', EdNumRes);
...
begin
  ...
  begin
    ...
    begin
      ...
      FatDe2.Locate('CodEmp;DteRes;NumRes;SeqLib;SeqDep;SeqDe2', VarArrayOf([FatDe2CodEmp.Value, FatDe2DteRes.Value, FatDe2NumRes.Value, FatDe2SeqLib.Value,
        FatDe2SeqDep.Value, SeqDe2]), [LoPartialKey]);
...
begin
  ...
  try
    ...
    if fmPsqLib.SeqLib > 0 then
      FatDepSeqLib.Value := fmPsqLib.SeqLib;
      ...
      begin
        ...
        begin
          ...
          if quSQL.FieldbyName('Reg').AsInteger = 0 then
            fmsgErro('Liberação não Encontrada para o Pedido.', EdSeqLib);
