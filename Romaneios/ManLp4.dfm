inherited fmManLp4: TfmManLp4
  Left = 0
  Caption = 'Impressão de Boletos'
  ClientHeight = 481
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grDup: ThGrid
    ...
    Height = 277
    Selected.Strings = (
      'NUMCRE'#9'10'#9'No. Documento'
      'NUMCRP'#9'4'#9'Nº'
      'PRACRP'#9'5'#9'Prazo'
      'DTVCRP'#9'10'#9'       Vencto'
      'VLPCRP'#9'10'#9'     Valor da Parcela'
      'VPPCRP'#9'10'#9'            Valor Pago'
      'DULCRP'#9'10'#9'  Data Pgto'
      'VJPCRP'#9'10'#9'         Juros'
      'VDSCRP'#9'10'#9'        Descontos'
      'FLGIMP'#9'3'#9'  E  ')
  ...
  object FatDup: TwwQuery
    ...
    SQL.Strings = (
        ...
        'Select FatDup.*,TotCre,QtpCre,NroNfs,TecCli,EncCli,BacCli,CicCli' +
        ',CecCli,'
      '           UfcCli,NrcCli,CodCli,NomCli,CgcCli,InsCli,RfcCli'
    ...
    object FatDupQTPCRE: TIntegerField
      DisplayWidth = 10
      FieldName = 'QTPCRE'
      Visible = False
    end
  ...
  object RDprint1: TRDprint
    ...
    OpcoesPreview.CaptionPreview = 'Impressão de Boletos'
    ...
    CaptionSetup = 'Setup'
    TitulodoRelatorio = 'Impressão de Boletos'
  ...
  object UpDup: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into FatDup'
        ...
        '(ARQDUP, CODEMP, DTECRE, NUMCRE, NUMCRP, PRACRP, DTVCRP, VLPCRP,' +
        ' '
      'VPPCRP, VJPCRP, VDSCRP, DULCRP, CODBAN, CODUSU, FLGIMP)'
      'values'
      '(:ARQDUP, :CODEMP, :DTECRE, :NUMCRE, :NUMCRP, :PRACRP, :DTVCRP, '
      ':VLPCRP, :VPPCRP, :VJPCRP, :VDSCRP, :DULCRP, :CODBAN, :CODUSU, '
      ':FLGIMP)')
    DeleteSQL.Strings = (
      'delete from FatDup'
      'where'
