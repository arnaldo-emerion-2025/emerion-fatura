inherited fmManLp2: TfmManLp2
  Left = 0
  Caption = 'Reimpressão de Romaneios'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grOr3: ThGrid
    ...
    Height = 144
    Selected.Strings = (
      'CODITE'#9'16'#9'Item'#9'F'
      'DESOR2'#9'34'#9' '#9'F'
      'QTPOR2'#9'10'#9'              Quantidade'#9'F'
      'VLUOR2'#9'10'#9'          Unitario'#9'F'
      'IPIOR2'#9'3'#9' IPI'#9'F'
      'ICMOR2'#9'4'#9' ICMS'#9'F'
      'TOTOR2'#9'10'#9'            Total Item'#9'F')
    IniAttributes.Delimiter = ';;'
    TitleColor = clBtnFace
    FixedCols = 0
    ShowHorzScrollBar = True
  ...
  object FatOrc: TwwQuery
    ...
    object FatOrcPRFVEN: TStringField
      FieldName = 'PRFVEN'
      Visible = False
      FixedChar = True
      Size = 4
    end
    object FatOrcFONVEN: TStringField
      FieldName = 'FONVEN'
      Visible = False
      FixedChar = True
    end
  ...
  object RDprint1: TRDprint
    ...
    OpcoesPreview.CaptionPreview = 'Reimpressão de Romaneios'
    ...
    CaptionSetup = 'Setup'
    TitulodoRelatorio = 'Reimpressão de Romaneios'
