...
begin
  ...
  begin
    ...
    ppMenBco1.Caption := 'Pag�vel em qualquer banco at� o vencimento. Ap�s, atualize o boleto no site bb.com.br.';
  ...
  begin
    ...
    ppMenBco1.Caption := 'Pag�vel preferencialmente no Banco Santander.';
  ...
  begin
    ...
    ppMenBco1.Caption := 'Pag�vel preferencialmente nas ag�ncias do Bradesco.';
  ...
  begin
    ...
    ppNomBan1.Caption := 'Banco Ita� S.A.';
    ppNomBan2.Caption := 'Banco Ita� S.A.';

    ppSiglaBanco1.Caption := '341-7';
    ppSiglaBanco2.Caption := '341-7';

    ppMenBco1.Caption := 'At� o vencimento, preferencialmente no Ita� e ap�s o vencimento, somente no Ita�.';
  ...
  begin
    ...
    ppMenBco1.Caption := 'PAG�VEL PREFERENCIALMENTE NAS COOPERATIVAS DE CR�DITO DO SICREDI.';
  ...
  begin
    ...
    begin
      ...
      case StrToInt(Trim(FatBolCodTco.AsString)) of
        101: RLLabel2.Caption := 'COBRAN�A SIMPLES - RCR';
        102: RLLabel2.Caption := 'COBRAN�A SIMPLES - CSR';
        201: RLLabel2.Caption := 'COBRAN�A PENHOR - RCR';
      end;
    ...
    begin
      RLLabel25.Caption := 'Uso do Banco/Conv�nio';
      RLDraw8.Height := 62;
    ...
    begin
      ...
      ppMensa101.Caption := 'Protestar ' + IntToStr(FieldbyName('QtdPro').AsInteger) + ' dias corridos ap�s o vencimento';
      ppMensa201.Caption := 'Protestar ' + IntToStr(FieldbyName('QtdPro').AsInteger) + ' dias corridos ap�s o vencimento';
    ...
    begin
      ...
      ppMensa102.Caption := 'Ap�s o vencimento cobrar mora de R$ ' + Trim(PreString(FormatFloat('###,###,##0.00', ValJur), 18)) + ' ao dia';
      ppMensa202.Caption := 'Ap�s o vencimento cobrar mora de R$ ' + Trim(PreString(FormatFloat('###,###,##0.00', ValJur), 18)) + ' ao dia';
    ...
    begin
      ...
      ppMensa103.Caption := 'Ap�s o vencimento cobrar multa de R$ ' + Trim(PreString(FormatFloat('###,###,##0.00', ValMulta), 18));
      ppMensa203.Caption := 'Ap�s o vencimento cobrar multa de R$ ' + Trim(PreString(FormatFloat('###,###,##0.00', ValMulta), 18));
