      ...
      begin
        ...
        begin
          ...
          begin
            ...
            begin
              if fMsg('Confirma a exclus�o do processo de devolu��o ?', 'O') then
              begin
                FatDev.Delete;
                with FatDev do
                begin
...
begin
  ...
  begin
    ...
    case MessageBox(handle,'Deseja imprimir a Vers�o Simplificada da Devolu��o?','Qual o Tipo de Relat�rio?',MB_YESNO) of
       idYes:
       begin
        if FatDevCodEmp.Value > 0 then
        begin
