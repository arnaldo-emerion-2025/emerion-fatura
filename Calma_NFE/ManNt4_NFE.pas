...
begin
  ...
  begin
    ...
    if fmManNot_NFE.FatPedLanDup.Value < fmManNot_NFE.FatPedTotDup.Value then
      fmsgErro('Total de Boletos � Menor que o Valor a ser Lan�ado.', nil)
    else
      fmsgErro('Total de Boletos � Maior que o Total a ser Lan�ado.', nil);
...
begin
  ...
  begin {Tecla - Seta para Baixo}
    ...
    if FatPe4NroPe4.Value = fmManNot_NFE.FatPedQtpDup.Value then
      FatPe4.Append;
    ...
    begin
      ...
      if SeqPe4 < fmManNot_NFE.FatPedQtpDup.Value then
        FatPe4.Locate('CodEmp;DteRes;NumRes;SeqLib;SeqFat;SeqPe4', VarArrayOf([FatPe4CodEmp.Value, FatPe4DteRes.Value, FatPe4NumRes.Value, FatPe4SeqLib.Value,
          FatPe4SeqFat.Value, SeqPe4]), [LoPartialKey])
      else
      begin
