inherited fmManEn4_NFE: TfmManEn4_NFE
  Left = 250
  Top = 102
  Caption = 'Devoluções - Notas fiscais (Comercial)  - Reimpressão do DANFE'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grFatDev: ThGrid
    ...
    Height = 100
    Selected.Strings = (
      'NRONFS'#9'10'#9'No. Nota fiscal'
      'NUMRES'#9'10'#9'Pedido'
      'DTEDEV'#9'10'#9'Emissão'
      'NOMCLI'#9'42'#9'Cliente'
      'APEVEN'#9'18'#9'Vendedor'#9'F'
  ...
  object grFatDv2: ThGrid
    ...
    Selected.Strings = (
      'CODITE'#9'15'#9'Item'
      'CODCFO'#9'7'#9'  CFOP'#9'F'
      'NCMDV2'#9'10'#9'     NCM  '
      'CODST1'#9'4'#9'ST1'
      'CODST2'#9'3'#9'ST2'
      'CODUND'#9'4'#9' UN'
      'ULTQTD'#9'12'#9' Qtde devolvida'
      'VLQDV2'#9'12'#9'         Unitário'
      'TOTDV2'#9'12'#9'      Total item'
      'ICMDV2'#9'5'#9' ICMS'
      'IPIDV2'#9'5'#9'     IPI'
  ...
  object FatDev: TwwQuery
    ...
    SQL.Strings = (
      ...
      '     and FatDev.FlgNot = '#39'Sim'#39
      '     and FatDev.FlgNfe = '#39'Sim'#39
      '     and FatDev.EnvNfe = '#39'Sim'#39
    ...
    object FatDevEM1CLI: TStringField
      FieldName = 'EM1CLI'
      Visible = False
      Size = 70
    end
  ...
  object UpFatDev: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into FatDev'
        ...
        '  (CODEMP, DTERES, NUMRES, SEQLIB, SEQFAT, SEQDEV, CODCLI, DTEDE' +
        'V, '
      'NRONFS, '
      
        '   TOTDEV, IMPNFE, SEQNFE, RECNFE, PRONFE, PRCNFE, DTEPNF, HREPN' +
        'F, '
      'DTCNFE, '
      '   HRCNFE, RETNFE, DTECNE, HRECNE, FLGATU, SITDEV)'
      'values'
      
        '  (:CODEMP, :DTERES, :NUMRES, :SEQLIB, :SEQFAT, :SEQDEV, :CODCLI' +
        ', '
      ':DTEDEV, '
      
        '   :NRONFS, :TOTDEV, :IMPNFE, :SEQNFE, :RECNFE, :PRONFE, :PRCNFE' +
        ', '
      ':DTEPNF, '
      
        '   :HREPNF, :DTCNFE, :HRCNFE, :RETNFE, :DTECNE, :HRECNE, :FLGATU' +
        ', '
      ':SITDEV)')
    DeleteSQL.Strings = (
      'delete from FatDev'
