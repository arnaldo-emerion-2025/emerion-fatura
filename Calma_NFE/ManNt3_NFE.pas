...
begin
  ...
  begin
    ...
    if fmManNot_NFE.FatPedLanNot.Value < fmManNot_NFE.FatPedTotGer.Value then
      fmsgErro('Total de vencimentos informados � menor que o total a ser lan�ado.', nil)
    else
      fmsgErro('Total de vencimentos informados � maior que o total a ser lan�ado.', nil);
  ...
  begin
    ...
    begin
      if fMsg('Existe uma diferen�a de ' + formatfloat('R$ #,##0.00', fmManNot_NFE.FatPedTotDup.asfloat) +
