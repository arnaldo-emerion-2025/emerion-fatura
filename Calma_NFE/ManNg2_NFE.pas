...
uses dxDemoUtils, BbMensag, Bbgeral, Bbfuncao, ManGDB, ManNg3_NFE, ManIng_NFE,
  ManNge_NFE2;
...
begin
  ...
  if Trim(fmManNge_NFE2.FatGerOb1Ger.Value) = '' then
  begin
    ...
    if Trim(fmManNge_NFE2.FatGerObsGer.Value) <> '' then
    begin

      DscTxf := fmManNge_NFE2.FatGerObsGer.Value;
    ...
    fmManNge_NFE2.FatGerOb1Ger.Value := Ob1Ger;
    fmManNge_NFE2.FatGerOb2Ger.Value := Ob2Ger;
    fmManNge_NFE2.FatGerOb3Ger.Value := Ob3Ger;
    fmManNge_NFE2.FatGerOb4Ger.Value := Ob4Ger;
    fmManNge_NFE2.FatGerOb5Ger.Value := Ob5Ger;
    fmManNge_NFE2.FatGerOb6Ger.Value := Ob6Ger;
    fmManNge_NFE2.FatGerOb7Ger.Value := Ob7Ger;
    fmManNge_NFE2.FatGerOb8Ger.Value := Ob8Ger;

    EdOb1Ger.Text := fmManNge_NFE2.FatGerOb1Ger.Value;
    EdOb2Ger.Text := fmManNge_NFE2.FatGerOb2Ger.Value;
    EdOb3Ger.Text := fmManNge_NFE2.FatGerOb3Ger.Value;
    EdOb4Ger.Text := fmManNge_NFE2.FatGerOb4Ger.Value;
    EdOb5Ger.Text := fmManNge_NFE2.FatGerOb5Ger.Value;
    EdOb6Ger.Text := fmManNge_NFE2.FatGerOb6Ger.Value;
    EdOb7Ger.Text := fmManNge_NFE2.FatGerOb7Ger.Value;
    EdOb8Ger.Text := fmManNge_NFE2.FatGerOb8Ger.Value;
...
begin
  ...
  fmManNge_NFE2.FatGerOb1Ger.Value := EdOb1Ger.Text;
  fmManNge_NFE2.FatGerOb2Ger.Value := EdOb2Ger.Text;
  fmManNge_NFE2.FatGerOb3Ger.Value := EdOb3Ger.Text;
  fmManNge_NFE2.FatGerOb4Ger.Value := EdOb4Ger.Text;
  fmManNge_NFE2.FatGerOb5Ger.Value := EdOb5Ger.Text;
  fmManNge_NFE2.FatGerOb6Ger.Value := EdOb6Ger.Text;
  fmManNge_NFE2.FatGerOb7Ger.Value := EdOb7Ger.Text;
  fmManNge_NFE2.FatGerOb8Ger.Value := EdOb8Ger.Text;
