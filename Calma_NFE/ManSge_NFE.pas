        ...
        begin
          ...
          begin
            ...
            begin
              ...
              if Trim(FatGerNomEnt.Value) <> '' then
              begin
                ...
                if Trim(FatGerTenCli.Value) <> '' then
                  EndEnt2 := Trim(FatGerTenCli.Value) + ' ';
                ...
                EndEnt2 := EndEnt2 + Trim(FatGerBaiCli.Value) + ' - ' + Trim(FatGerCidCli.Value) + ' ' + Trim(FatGerUfeCli.Value) + ' Cep ' +
                  Trim(FatGerCepCli.Value);
              ...
              begin
                ...
                if Trim(FatGerTenCli.Value) <> '' then
                  EndEnt1 := Trim(FatGerTenCli.Value) + ' ';
                ...
                EndEnt1 := EndEnt1 + Trim(FatGerBaiCli.Value) + ' - ' + Trim(FatGerCidCli.Value) + ' ' + Trim(FatGerUfeCli.Value) + ' Cep ' +
                  Trim(FatGerCepCli.Value);
              ...
              begin
                ...
                if qtdnfis = FatGerQtdNfs.Value then
                begin
                                          ...
                                          begin
                                            ...
                                            begin
                                              ...
                                              begin
                                                ...
                                                if (FatGerTotDsr.Value > 0) and (SeqNfg = QtiNfg) then
                                                begin
                            ...
                            begin
                              ...
                              begin
                                ...
                                begin
                                  ...
                                  if (Reg = 67) and (qtdnfis < FatGerQtdNfs.Value) then
                                  begin
                                  ...
                                  begin
                                    ...
                                    if (Reg >= 68) and (Reg <= 81) and (qtdnfis < FatGerQtdNfs.Value) then
                                    begin
                                    ...
                                    begin
                                      ...
                                      if (reg >= 187) and (reg <= 194) and (qtdnfis < FatGerQtdNfs.Value) then
                                      begin
              ...
              if FatGerFlgImp.Value = 'Nao' then
              begin
