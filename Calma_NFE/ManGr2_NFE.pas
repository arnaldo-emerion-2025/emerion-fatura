...
begin
  ...
  begin
    ...
    pnHreNfe.Caption := ' Hor�rio: ' + FatGerHrcNfe.Value;
  ...
  begin
    ...
    pnHreNfe.Caption := ' Hor�rio: ' + FatGerHrePNF.Value;
    ...
    begin
      ...
      begin
        ...
        if ehomologacao = 1 then
          ...
          ePara := inputbox('E-mail do XML', 'Digite o endere�o de e-mail do destinat�rio', FatGerEm1Cli.Value);
