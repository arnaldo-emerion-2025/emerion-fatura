...
begin
  ...
  begin
    ...
    pnHreNfe.Caption := ' Hor�rio: ' + FatPedHrcNfe.Value;
  ...
  begin
    ...
    pnHreNfe.Caption := ' Hor�rio: ' + FatPedHrePNF.Value;
  ...
  begin
    ...
    pnSitImp.Caption := 'Impress�o confirmada';
    ...
    begin
      ...
      begin
        ...
        if ehomologacao = 1 then
          epara := inputbox('E-mail do XML', 'Digite o endere�o de e-mail do destinat�rio', 'fernanda@emerion.com.br')
        else
          ePara := inputbox('E-mail do XML', 'Digite o endere�o de e-mail do destinat�rio', FatPedEm1Cli.Value);
...
begin
  inherited;
  SendMailMAPI('Teste de Gerenciador de Email', 'Fun��o gerenciador de email.', 'C:\Users\Sergio\Desktop\Retorno\CB240501.RET',
