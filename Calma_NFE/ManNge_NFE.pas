...
type
   TfmManNge_NFE = class(TfmPadrao)
      ...
      procedure EdDesGe2Enter(Sender: TObject);
...
procedure TfmManNge_NFE.FormCreate(Sender: TObject);
begin
   inherited;
   sEnc := 'N';
...
procedure TfmManNge_NFE.PaintBoxPaint(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.FormDestroy(Sender: TObject);
begin
   inherited;
   fmManNge_NFE := nil;
end;

procedure TfmManNge_NFE.EdCodEmpKeyPress(Sender: TObject; var Key: Char);
begin
   inherited;
...
procedure TfmManNge_NFE.FormActivate(Sender: TObject);
begin
   inherited;
   if sEnc = 'S' then
      begin
         ...
         if FatGerSitGer.Value = 'Faturado' then
            fMsg('Operacao nao Pode ser Realizada. Nota j� Emitida.', 'E')

         else if FatGerSitGer.Value = 'Cancelado' then
            fMsg('Operacao nao Pode ser Realizada. Nota Cancelada.', 'E');
...
procedure TfmManNge_NFE.PaintBox1Paint(Sender: TObject);
begin
   inherited;
   with Sender as TPaintBox do
...
procedure TfmManNge_NFE.EdTipPfaExit(Sender: TObject);
begin
   inherited;
   if Tecla = 'UP' then
      EdTipPfa.SetFocus
...
procedure TfmManNge_NFE.EdCodEmpKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
   if key = 112 then
      begin {F1 - Iniciais}
...
procedure TfmManNge_NFE.EdCodEmpKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodEmpMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
   inherited;
...
procedure TfmManNge_NFE.Panel1Exit(Sender: TObject);
var
   ...
   if FatGer.State <> dsBrowse then
      begin
         ...
         if FatGerDteFat.Value = 0 then
            fmsgErro('Campo de preenchimento obrigatorio nao informado.', EdDteFat);
         ...
         if FatGer.State = dsInsert then
            begin
               ...
               if FatGerCodCli.Value = 0 then
                  fmsgErro('Campo de preenchimento obrigatorio nao informado.', EdCodCli);
         ...
         if Trim(quSQL.FieldbyName('ModPfa').AsString) = 'Complemento' then
            begin

               FatGerUfeCom.Value := FatGerUfeGer.Value;

               try

                  fmManC01 := TfmManC01.Create(Self);
                  fmManC01.FormStyle := fsnormal;
                  fmManC01.Showmodal;

                  FatGerUFECOM.Value := VCufecom;
                  FatGerDTECOM.Value := STRtodate(VCDTEcom);
                  FatGerNFSCOM.Value := strtoint(VCNFScom);
                  FatGerSEQCOM.Value := VCSEQcom;

                  sContinuar := fmManC01.sContinuar;
                        ...
                        begin
                           ...
                           with Params do
                              begin
                                 ...
                                 Params[1].Asdate := FatGerDTEGER.Value;
...
procedure TfmManNge_NFE.EdCodEmpExit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodCliKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
   if key = 112 then
      begin {F1 - Iniciais}
...
procedure TfmManNge_NFE.EdCodCliKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodCliMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodCliExit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
                  ...
                  begin
                     ...
                     if FatGerCodCli.Value > 0 then
                        begin
                           ...
                           if quSql.FieldbyName('CodCli').AsInteger = FatGerCodCli.Value then
                              begin
...
procedure TfmManNge_NFE.EdCodVenKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
   if key = 112 then
      begin {F1 - Iniciais}
...
procedure TfmManNge_NFE.EdCodVenExit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodPfaKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var
   LocPfa: string;
begin
   inherited;
...
procedure TfmManNge_NFE.Es(Sender: TObject);
var
   saida: boolean;
   LocPfa: string;
begin
                        ...
                        begin
                           ...
                           with quSql, SQL do
                              begin
                                 ...
                                 FatGerLANEST.Value := quSql.FieldbyName('atuest').AsString;
                                 FatGerINTFIN.Value := quSql.FieldbyName('intfin').AsString;
                                 vcodicm := '';
...
procedure TfmManNge_NFE.FatGerNewRecord(DataSet: TDataSet);
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodClpExit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodClpKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodGruKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
   if key = 112 then
      begin {F1 - Iniciais}
...
procedure TfmManNge_NFE.EdCodGruExit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodSubKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
   if key = 112 then
      begin {F1 - Iniciais}
...
procedure TfmManNge_NFE.EdCodSubExit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
                              ...
                              begin
                                 ...
                                 with quSql, SQL do
                                    begin
                                       ...
                                       if quSql.FieldbyName('Reg').AsInteger = 0 then
                                          fmsgErro('Grupo e Sub-Grupo nao Encontrado.', EdCodGru);
...
procedure TfmManNge_NFE.EdCodSubKeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodSubMouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodProKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
   if key = 112 then
      begin {f1 - Iniciais}
...
procedure TfmManNge_NFE.EdCodProExit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
                  ...
                  begin
                     ...
                     if FatGe2.State <> dsBrowse then
                        begin
                           ...
                           if (FatGe2CodPro.Value <> '88888') and (FatGe2CodPro.Value <> '99999') then
                              begin
                                 ...
                                 if Trim(quSQL.FieldbyName('CodPro').AsString) <> '' then
                                    begin
                                       ...
                                       if Trim(quSQL.FieldbyName('CodSts').AsString) <> '' then
                                          begin
                                       ...
                                       qusql.Active := false;
                                       qusql.sql.text := 'Select CODICM, TIPICM, codipi, tipipi from ESTPFA where CODPFA = (Select codpfa from FATGER where codemp = ' + QuotedStr(FatGerCODEMP.asstring) + ' and dteger = ' + QuotedStr(FormatDateTime('mm/dd/yyyy', FatGerDTEGER.asdatetime)) + ' and numger = ' + QuotedStr(FatGerNUMGER.asstring) + ');';
                                       qusql.Active := true;

                                       if Trim(quSQL.FieldbyName('CODIpi').AsString) <> '' then
                                          begin

                                             FatGe2RegIpi.Value := Trim(quSQL.FieldbyName('CODIpi').AsString);
                                             FatGe2TipIpi.Value := Trim(quSQL.FieldbyName('TIPIpi').AsString);
                                       ...
                                       if Trim(quSQL.FieldbyName('CODIcm').AsString) <> '' then
                                          begin
                                             ...
                                             FatGe2RegIcm.Value := Trim(quSQL.FieldbyName('CODIcm').AsString);
                                             FatGe2TipIcm.Value := Trim(quSQL.FieldbyName('TIPIcm').AsString);
                                       ...
                                       if quSql.FieldbyName('CodPro').AsString = FatGe2CodPro.Value then
                                          begin
                                             ...
                                             with quSql, SQL do
                                                begin
                                                   ...
                                                   if FieldbyName('QtdReg').AsInteger = 0 then
                                                      fmsgErro('Item Informado nao Encontrado no Estoque da Empresa.', EdCodPro);
...
procedure TfmManNge_NFE.EdQtpGe2KeyUp(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
...
procedure TfmManNge_NFE.EdQtpGe2MouseUp(Sender: TObject; Button: TMouseButton; Shift: TShiftState; X, Y: Integer);
begin
   inherited;
...
procedure TfmManNge_NFE.EdQtpGe2Exit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
...
procedure TfmManNge_NFE.EdVluGe2Exit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodSt1KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
   if key = 112 then
      begin {F1 - Iniciais}
...
procedure TfmManNge_NFE.EdCodSt2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
   if key = 112 then
      begin {F1 - Iniciais}
...
procedure TfmManNge_NFE.EdCodUndKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
   if key = 112 then
      begin {F1 - Iniciais}
...
procedure TfmManNge_NFE.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
   inherited;
...
procedure TfmManNge_NFE.grGe2KeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var
   NroGe2: integer;
begin
   inherited;
      ...
      begin {Tecla - DEL}
         ...
         if FatGe2CodEmp.Value > 0 then
            begin
               ...
               if ((checkbox1.Checked) and (Fatge2.IsEmpty = false)) then
                  begin
                     finalizarDI := false;
                     try
                        fmManDI := TfmManDI.Create(Self);
                        fmManDI.ShowModal;
                     finally
                        FreeAndNil(fmManDI);
                     end;
...
procedure TfmManNge_NFE.FormShow(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.FatGe2NewRecord(DataSet: TDataSet);
begin
   inherited;
...
procedure TfmManNge_NFE.Panel3Exit(Sender: TObject);
var
   NroGe2: integer;
         ...
         if FatGe2.State <> dsBrowse then
            begin
               if (FatGe2CodClp.Value <> '8') and (FatGe2CodClp.Value <> '9') then
                  begin
                     if FatGe2VluGe2.Value = 0 then
                        fmsgErro('Campo de Preenchimento Obrigatorio nao Informado.', EdVluGe2);
                     if FatGe2QtpGe2.Value = 0 then
                        begin
                           with quSql, SQL do
                              begin
                           ...
                           if (quSQL.FieldbyName('ModPfa').AsString <> 'Complemento') then
                              fmsgErro('Campo de Preenchimento Obrigatorio nao Informado.', EdQtpGe2);
                        end;
                  end
               else
                  begin

                     if Trim(FatGe2DesGe2.Value) = '' then
                        fmsgErro('Campo de Preenchimento Obrigatorio nao Informado.', EdDesGe2);
               ...
               try
                  ...
                  if ((checkbox1.Checked) and (Fatge2.IsEmpty = false)) then
                     begin
                        ...
                        try
                           fmManDI := TfmManDI.Create(Self);
                           fmmandi.label7.caption := FatGe2CODGRU.AsString + '.' + FatGe2CODSUB.AsString + '.' + FatGe2CODPRO.AsString + ' - ' + FatGe2desge2.AsString;
                           fmManDI.ShowModal;
                        finally
                           FreeAndNil(fmManDI);
                        end;
...
procedure TfmManNge_NFE.FormClose(Sender: TObject; var Action: TCloseAction);
begin
   inherited;
   if Finalizar = 'N' then
      begin
...
procedure TfmManNge_NFE.Panel4Exit(Sender: TObject);
begin
   inherited;
   if FatGer.State <> dsBrowse then
      begin
...
procedure TfmManNge_NFE.bpsqEmpClick(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.bpsqCliClick(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.bpsqVenClick(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.bpsqPfaClick(Sender: TObject);
var
   LocPfa: string;
begin
   inherited;
...
procedure TfmManNge_NFE.DsGe2DataChange(Sender: TObject; Field: TField);
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodGruEnter(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.EdTipPfaEnter(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodSt1Enter(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.EdQtpPe2Exit(Sender: TObject);
var
   saida: boolean;
begin
   inherited;
...
procedure TfmManNge_NFE.EdCodClpEnter(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.grGe2Enter(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.FatGerBeforePost(DataSet: TDataSet);
begin
   inherited;
...
procedure TfmManNge_NFE.EdDesGe2Enter(Sender: TObject);
begin
   inherited;
   pnDesGe2.Visible := False;
   pnObsGe2.Visible := False;
...
procedure TfmManNge_NFE.Panel3Enter(Sender: TObject);
begin
   inherited;
   psaida := 'Sim';
end;

procedure TfmManNge_NFE.Edit1KeyPress(Sender: TObject; var Key: Char);
begin
   inherited;
   if not (Key in ['0'..'9', Chr(8)]) then Key := #0;
end;

procedure TfmManNge_NFE.SpeedButton2Click(Sender: TObject);
var linha, coluna, linhaaux, Plaux: integer;
...
procedure TfmManNge_NFE.SpeedButton3Click(Sender: TObject);
var
   Excel: OleVariant;
   COLCodigo, COLQtde, COLIPI, COLICMS, COLunitario, COLbasePISCOF, COLBaseICMS, COLSIscomex, COLadicao, COLitem, COLdi, COLdatadi, COLdatades, COLUFdes, COLcodexp, COLlocaldes, COLBCII, COLII, COLPERII, COLDespAdu, COLIOF: integer;
...
begin
   ...
   try
      ...
      Excel.WorkBooks.Open(opendialog1.filename, EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam, EmptyParam);
      linha := 2;
      ...
      while (string(Excel.WorkBooks[1].Sheets[1].cells[linha, 1]) <> '') do
         begin
            ...
            qusql.active := false;
            qusql.sql.Text := 'INSERT INTO DI (ID_DI, ID_CMPNF2, NUMDI, DATADI, LOCALDESEMB, UFDESEMB, DATADESEMB, CODEXPORT) VALUES (' + Inttostr(VGenid) + ', ' + QuotedStr(inttostr(vfatge2)) + ', ' + quotedstr(SDI) + ', ' + QuotedStr(formatdatetime('mm/dd/yyyy', Sdatadi)) + ', ' + QuotedStr(SLocalDes) + ', ' + QuotedStr(SUFDES) + ', ' + QuotedStr(formatdatetime('mm/dd/yyyy', SDATADES)) + ', ' + QuotedStr(SCODEXP) + ')';
            quSql.ExecSQL;
...
procedure TfmManNge_NFE.CheckBox1Click(Sender: TObject);
begin
   inherited;
...
procedure TfmManNge_NFE.FatGerAfterOpen(DataSet: TDataSet);
begin
   inherited;
   //CheckBox1.Checked := false;
end;

procedure TfmManNge_NFE.EdClsIpiKeyDown(Sender: TObject; var Key: Word;
   Shift: TShiftState);
begin
   inherited;
   if ((key = vk_return) or (Key = vk_tab)) then
