...
type
  TfmManNt2_NFE = class(TfmShowPadrao)
    ...
    Label10: TLabel;
    Label8: TLabel;
    EdOb8Fat: TdxDBColorEdit;
    EdOb7Fat: TdxDBColorEdit;
    EdOb6Fat: TdxDBColorEdit;
    EdOb5Fat: TdxDBColorEdit;
    EdOb4Fat: TdxDBColorEdit;
    EdOb3Fat: TdxDBColorEdit;
    EdOb2Fat: TdxDBColorEdit;
    EdOb1Fat: TdxDBColorEdit;
    quSql1: TwwQuery;
    quSql2: TwwQuery;
    bretornar: TBitBtn;
    bcontinuar: TBitBtn;
...
begin
  ...
  if fmManNot_NFE.SeqImpText = 'N' then begin

     fmManNot_NFE.SeqImpText := 'S';

     SeqLin := 1;

     if Trim( fmManNot_NFE.FatPedOb1Fat.Value) = '' then begin
        ...
        if Trim( fmManNot_NFE.FatPedObsFat.Value ) <> '' then begin
        ...
        if (Trim( fmManNot_NFE.FatPedCodCf1.Value ) = '6.403') or
           ...
           (Trim( fmManNot_NFE.FatPedCodCf1.Value ) = '6.411') or
           (Trim( fmManNot_NFE.FatPedCodCf2.Value ) = '6.411') then begin
        ...
        fmManNot_NFE.FatPedOb1Fat.Value := Ob1Fat;
        fmManNot_NFE.FatPedOb2Fat.Value := Ob2Fat;
        fmManNot_NFE.FatPedOb3Fat.Value := Ob3Fat;
        fmManNot_NFE.FatPedOb4Fat.Value := Ob4Fat;
        fmManNot_NFE.FatPedOb5Fat.Value := Ob5Fat;
        fmManNot_NFE.FatPedOb6Fat.Value := Ob6Fat;
        fmManNot_NFE.FatPedOb7Fat.Value := Ob7Fat;
        fmManNot_NFE.FatPedOb8Fat.Value := Ob8Fat;

        EdOb1Fat.Text := fmManNot_NFE.FatPedOb1Fat.Value;
        EdOb2Fat.Text := fmManNot_NFE.FatPedOb2Fat.Value;
        EdOb3Fat.Text := fmManNot_NFE.FatPedOb3Fat.Value;
        EdOb4Fat.Text := fmManNot_NFE.FatPedOb4Fat.Value;
        EdOb5Fat.Text := fmManNot_NFE.FatPedOb5Fat.Value;
        EdOb6Fat.Text := fmManNot_NFE.FatPedOb6Fat.Value;
        EdOb7Fat.Text := fmManNot_NFE.FatPedOb7Fat.Value;
        EdOb8Fat.Text := fmManNot_NFE.FatPedOb8Fat.Value;
...
begin
  ...
  fmManNot_NFE.FatPedOb1Fat.Value := Trim(fmManNot_NFE.FatPedOb1Fat.Value);
  fmManNot_NFE.FatPedOb2Fat.Value := Trim(fmManNot_NFE.FatPedOb2Fat.Value);
  fmManNot_NFE.FatPedOb3Fat.Value := Trim(fmManNot_NFE.FatPedOb3Fat.Value);
  fmManNot_NFE.FatPedOb4Fat.Value := Trim(fmManNot_NFE.FatPedOb4Fat.Value);
  fmManNot_NFE.FatPedOb5Fat.Value := Trim(fmManNot_NFE.FatPedOb5Fat.Value);
  fmManNot_NFE.FatPedOb6Fat.Value := Trim(fmManNot_NFE.FatPedOb6Fat.Value);
  fmManNot_NFE.FatPedOb7Fat.Value := Trim(fmManNot_NFE.FatPedOb7Fat.Value);
  fmManNot_NFE.FatPedOb8Fat.Value := Trim(fmManNot_NFE.FatPedOb8Fat.Value);
