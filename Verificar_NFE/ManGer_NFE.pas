...
uses dxDemoUtils, Bbgeral, Bbfuncao, Bbmensag, ManGDB, PsqEmp, PsqCli, PsqVen,
     PsqPfa, ManPri, AuxPsq, ManNge_NFE, ManCge_NFE, ManSge_NFE;
...
procedure TfmManGer_NFE.PaintBoxPaint(Sender: TObject);
begin
  inherited;
...
begin
  ...
  if Trim(UpperCase(GLibAce)) = 'SIM' then begin
     ...
     for i := 0 to Screen.FormCount - 1 do begin
         ...
         if Screen.Forms[i] is TfmManNge_NFE then Found := i;
              ...
              if Trim( FatGerSitGer.Value ) = 'Faturado' then begin
                 ...
                 if fMsg('Confirma o Cancelamento da Nota Fiscal ?','O') then begin
                    ...
                    try
                       ...
                       fmManCge_NFE := TfmManCge_NFE.Create(Self);

                       fmManCge_NFE.ShowModal;

                    finally

                       FreeAndNil(fmManCge_NFE);
