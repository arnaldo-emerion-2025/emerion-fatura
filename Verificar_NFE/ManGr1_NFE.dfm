inherited fmManGr1_NFE: TfmManGr1_NFE
  ...
  Top = 204
  Caption = 
    'Outros tipos de notas fiscais - Emissão de nota fiscal eletrônic' +
    'a'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  ...
  object FatGer: TwwQuery
    ...
    DatabaseName = 'ISade'
    SQL.Strings = (
      'Select fatger.sitger,FatGer.EnvNfe, fatger.flgnfe,'
  ...
  object UpFatGer: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into FatGer'
        ...
        '  (CODEMP, DTEGER, NUMGER, QTIGER, UFEGER, DTEFAT, HREFAT, NRONF' +
        'S, '
      'DTECOM, '
      
        '   NFSCOM, SEQCOM, CODPFA, TIPPFA, CODCF1, CODCF2, CODCLI, FLGSA' +
        'I, '
      'FLGENT, '
      
        '   TIPFRT, ESPGER, MARGER, INTFIN, DESNAT, INSSUB, CODTRA, NOMTR' +
        'A, '
      'CGCTRA, '
      
        '   INSTRA, TENTRA, ENDTRA, REFTRA, NUMTRA, BAITRA, CIDTRA, UFETR' +
        'A, '
      'CEPTRA, '
      
        '   NROGER, PLCTRA, UFEPLC, CEFCLI, TEFCLI, ENFCLI, RFFCLI, NRFCL' +
        'I, BAFCLI, '
      
        '   CIFCLI, UFFCLI, CEPCLI, TENCLI, ENDCLI, REFCLI, NUMCLI, BAICL' +
        'I, CIDCLI, '
      
        '   UFECLI, CGECLI, INECLI, INFLIQ, INFBRT, ALTVOL, RETNFE, LOTNF' +
        'E, ENVNFE, '
      ...
      'HREPNF, '
        ...
        '   IMPNFE, NFEPIS, NFECOF, FLGATU, ID_FINUFF, ID_FINCIF, ID_FINU' +
        'FE, '
      'ID_FINCIE, '
      
        '   ID_TRAUFE, ID_TRACIE, TRBPIS, PERPIS, TRBCOF, PERCOF, TOTIT1,' +
        ' '
      'TOTDSR, '
      
        '   TOTFRT, TOTSEG, TOTDES, TOTIP1, TOTPIS, TOTCOF, BASIC1, TOTIC' +
        '1, '
      'BASSU1, '
      
        '   TOTSU1, TOTGE1, OB1GER, OB2GER, OB3GER, OB4GER, OB5GER, OB6GE' +
        'R, '
      'OB7GER, '
      '   OB8GER, MODPFA, ID_ESTSIP)'
      'values'
      
        '  (:CODEMP, :DTEGER, :NUMGER, :QTIGER, :UFEGER, :DTEFAT, :HREFAT' +
        ', '
      ':NRONFS, '
      
        '   :DTECOM, :NFSCOM, :SEQCOM, :CODPFA, :TIPPFA, :CODCF1, :CODCF2' +
        ', '
      ':CODCLI, '
      
        '   :FLGSAI, :FLGENT, :TIPFRT, :ESPGER, :MARGER, :INTFIN, :DESNAT' +
        ', :INSSUB, '
      
        '   :CODTRA, :NOMTRA, :CGCTRA, :INSTRA, :TENTRA, :ENDTRA, :REFTRA' +
        ', '
      ':NUMTRA, '
      
        '   :BAITRA, :CIDTRA, :UFETRA, :CEPTRA, :NROGER, :PLCTRA, :UFEPLC' +
        ', :CEFCLI, '
        ...
        '   :INECLI, :INFLIQ, :INFBRT, :ALTVOL, :RETNFE, :LOTNFE, :ENVNFE' +
        ', :SEQNFE, '
      ...
      ':HREPNF, '
        ...
        '   :IMPNFE, :NFEPIS, :NFECOF, :FLGATU, :ID_FINUFF, :ID_FINCIF, :' +
        'ID_FINUFE, '
      
        '   :ID_FINCIE, :ID_TRAUFE, :ID_TRACIE, :TRBPIS, :PERPIS, :TRBCOF' +
        ', :PERCOF, '
      
        '   :TOTIT1, :TOTDSR, :TOTFRT, :TOTSEG, :TOTDES, :TOTIP1, :TOTPIS' +
        ', '
      ':TOTCOF, '
      
        '   :BASIC1, :TOTIC1, :BASSU1, :TOTSU1, :TOTGE1, :OB1GER, :OB2GER' +
        ', '
      ':OB3GER, '
      
        '   :OB4GER, :OB5GER, :OB6GER, :OB7GER, :OB8GER, :MODPFA, :ID_EST' +
        'SIP)')
    DeleteSQL.Strings = (
      'delete from FatGer'
      'where'
  ...
  object UpFatArq: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into FatGer'
      '  (CODEMP, DTEGER, NUMGER, ARQNFE, FLGATU)'
      'values'
      '  (:CODEMP, :DTEGER, :NUMGER, :ARQNFE, :FLGATU)')
    DeleteSQL.Strings = (
      'delete from FatGer'
