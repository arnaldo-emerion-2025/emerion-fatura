...
begin
  ...
  if (Trim(fmmanen3_nfe.FatDevNfePis.Value) = '') or
     (Trim(fmmanen3_nfe.FatDevNfeCof.Value) = '') or (fmmanen3_nfe.FatDevId_EstSip.Value = 0) then begin

     with fmmanen3_nfe.quSQL,SQL do begin
     ...
     if fmmanen3_nfe.FatDevId_EstSip.Value > 0 then begin
  ...
  if (Trim(fmmanen3_nfe.FatDevTenTra.Value) <> '') or
     ...
     (Trim(fmmanen3_nfe.FatDevCepTra.Value) <> '') then begin
  ...
  with fmmanen3_nfe.FatDev do begin
       ...
       try
          ...
          if fmmanen3_nfe.FatDev.State = dsBrowse then fmmanen3_nfe.FatDev.Edit;
...
begin
  ...
  if Trim(fmmanen3_nfe.FatDevUfeTra.Value) <> '' then begin

     if fmmanen3_nfe.FatDevId_TraUfe.Value = 0 then begin
     ...
     if fmmanen3_nfe.FatDevId_TraUfe.Value > 0 then begin
        ...
        if Trim(fmmanen3_nfe.FatDevCidTra.Value) <> '' then begin

           if fmmanen3_nfe.FatDevId_TraCie.Value = 0 then begin
  ...
  if Trim(fmmanen3_nfe.FatDevUffCli.Value) <> '' then begin

     if fmmanen3_nfe.FatDevId_FinUff.Value = 0 then begin
     ...
     if fmmanen3_nfe.FatDevId_FinUff.Value > 0 then begin
        ...
        if Trim(fmmanen3_nfe.FatDevCifCli.Value) <> '' then begin

           if fmmanen3_nfe.FatDevId_FinCif.Value = 0 then begin
  ...
  if Trim(fmmanen3_nfe.FatDevUfeCli.Value) <> '' then begin

     if fmmanen3_nfe.FatDevId_FinUfe.Value = 0 then begin
     ...
     if fmmanen3_nfe.FatDevId_FinUfe.Value > 0 then begin
        ...
        if Trim(fmmanen3_nfe.FatDevCidCli.Value) <> '' then begin

           if fmmanen3_nfe.FatDevId_FinCie.Value = 0 then begin
  ...
  if fmmanen3_nfe.FatDevId_TraUfe.Value > 0 then pnId_TraUfe.Caption := IntToStr(fmmanen3_nfe.FatDevId_TraUfe.Value);
  if fmmanen3_nfe.FatDevId_FinUff.Value > 0 then pnId_FinUff.Caption := IntToStr(fmmanen3_nfe.FatDevId_FinUff.Value);
  if fmmanen3_nfe.FatDevId_FinUfe.Value > 0 then pnId_FinUfe.Caption := IntToStr(fmmanen3_nfe.FatDevId_FinUfe.Value);
  ...
  if TrimLeft(TrimRight(fmmanen3_nfe.FatDevCgeCli.Value)) <> '' then begin
  ...
  if TrimLeft(TrimRight(fmmanen3_nfe.FatDevCgcTra.Value)) <> '' then begin
...
begin
  inherited;
  if fmmanen3_nfe.FatDev.State <> dsBrowse then fmmanen3_nfe.FatDev.CancelUpdates;
end;

procedure TfmManNF1_NFE.EdCgeCliEnter(Sender: TObject);
begin
  inherited;
  if fmmanen3_nfe.FatDevCgeCli.EditMask <> '' then fmmanen3_nfe.FatDevCgeCli.EditMask := '';
end;

procedure TfmManNF1_NFE.EdCodTraExit(Sender: TObject);
begin
  inherited;
  if fmmanen3_nfe.FatDevCodTra.Value <> CodTra_Ant then begin

     CodTra_Ant := fmmanen3_nfe.FatDevCodTra.Value;
     
     if fmmanen3_nfe.FatDevCodTra.Value > 0 then begin
...
begin
  inherited;
  if fmmanen3_nfe.FatDevUfeTra.Value <> UfeTra_Ant then begin
...
begin
  inherited;
  if fmmanen3_nfe.FatDevId_TraCie.Value <> Id_TraCie_Ant then begin
...
begin
  inherited;
  if fmmanen3_nfe.FatDevId_FinCif.Value <> Id_FinCif_Ant then begin
...
begin
  inherited;
  if fmmanen3_nfe.FatDevId_FinCie.Value <> Id_FinCie_Ant then begin
...
begin
  inherited;
  if fmmanen3_nfe.FatDevUffCli.Value <> UffCli_Ant then begin
...
begin
  inherited;
  if fmmanen3_nfe.FatDevUfeCli.Value <> UfeCli_Ant then begin
