...
begin
  ...
  if (Trim(fmManNot_NFE.FatPedTenTra.Value) <> '') or
     ...
     (Trim(fmManNot_NFE.FatPedCepTra.Value) <> '') then begin
  ...
  with fmManNot_NFE.FatPed do begin
...
begin
  ...
  if Trim(fmManNot_NFE.FatPedUfeTra.Value) <> '' then begin

     if fmManNot_NFE.FatPedId_TraUfe.Value = 0 then begin

        with fmManNot_NFE.quSQL,SQL do begin
  ...
  if Trim(fmManNot_NFE.FatPedUffCli.Value) <> '' then begin

     if fmManNot_NFE.FatPedId_FinUff.Value = 0 then begin
  ...
  if Trim(fmManNot_NFE.FatPedUfeCli.Value) <> '' then begin

     if fmManNot_NFE.FatPedId_FinUfe.Value = 0 then begin
  ...
  if fmManNot_NFE.FatPedId_TraUfe.Value > 0 then pnId_TraUfe.Caption := IntToStr(fmManNot_NFE.FatPedId_TraUfe.Value);
  if fmManNot_NFE.FatPedId_FinUff.Value > 0 then pnId_FinUff.Caption := IntToStr(fmManNot_NFE.FatPedId_FinUff.Value);
  if fmManNot_NFE.FatPedId_FinUfe.Value > 0 then pnId_FinUfe.Caption := IntToStr(fmManNot_NFE.FatPedId_FinUfe.Value);
  ...
  if fmManNot_NFE.FatPedInfBrt.Value = 0 then fmManNot_NFE.FatPedInfBrt.Value := fmManNot_NFE.FatPedTotBrt.Value;
  if fmManNot_NFE.FatPedInfLiq.Value = 0 then fmManNot_NFE.FatPedInfLiq.Value := fmManNot_NFE.FatPedTotLiq.Value;
  ...
  if Trim(fmManNot_NFE.quSQL.FieldbyName('CodCfo').AsString) <> '' then begin
  
     fmManNot_NFE.FatPedCodCf1.Value := Trim(fmManNot_NFE.quSQL.FieldbyName('CodCfo').AsString);

     if not fmManNot_NFE.quSQL.EOF then begin
        ...
        if Trim(fmManNot_NFE.quSQL.FieldbyName('CodCfo').AsString) <> '' then begin
           ...
           if not fmManNot_NFE.quSQL.EOF then begin
              ...
              if Trim(fmManNot_NFE.quSQL.FieldbyName('CodCfo').AsString) <> '' then begin
                 ...
                 if Trim(fmManNot_NFE.quSQL.FieldbyName('CodCfo').AsString) <> fmManNot_NFE.FatPedCodCf1.Value then begin
  ...
  if fmManNot_NFE.FatPedUfeFat.Value <> 'SP' then begin
     ...
     if fmManNot_NFE.FatPedTotSub.Value > 0 then
        fmManNot_NFE.FatPedObsFat.Value := 'Total de ICMS Substituicao R$ '+
                                       ...
                                       #13+ #10 +
                                       IntToStr(fmManNot_NFE.FatPedNumRes.Value)+
                                       #13+ #10 +
                                       fmManNot_NFE.FatPedObsFat.Value
     else
        fmManNot_NFE.FatPedObsFat.Value := IntToStr(fmManNot_NFE.FatPedNumRes.Value)+
                                       #13+ #10 +
                                       fmManNot_NFE.FatPedObsFat.Value;
  ...
  if TrimLeft(TrimRight(fmManNot_NFE.FatPedCgeCli.Value)) <> '' then begin
  ...
  if TrimLeft(TrimRight(fmManNot_NFE.FatPedCgcTra.Value)) <> '' then begin
...
procedure TfmManNt1_NFE.PaintBoxPaint(Sender: TObject);
begin
...
begin
  inherited;
  if fmManNot_NFE.FatPed.State <> dsBrowse then fmManNot_NFE.FatPed.CancelUpdates;
end;

procedure TfmManNt1_NFE.EdCgeCliEnter(Sender: TObject);
begin
  inherited;
  if fmManNot_NFE.FatPedCgeCli.EditMask <> '' then fmManNot_NFE.FatPedCgeCli.EditMask := '';
end;

procedure TfmManNt1_NFE.EdCodTraExit(Sender: TObject);
begin
  inherited;
  if fmManNot_NFE.FatPedCodTra.Value <> CodTra_Ant then begin

     CodTra_Ant := fmManNot_NFE.FatPedCodTra.Value;
     
     if fmManNot_NFE.FatPedCodTra.Value > 0 then begin
        ...
        with fmManNot_NFE.quSQL,SQL do begin
             ...
             fmManNot_NFE.FatPedNomTra.Value := Trim(FieldbyName('NomTra').AsString);
             fmManNot_NFE.FatPedCgcTra.Value := Trim(FieldbyName('CgcTra').AsString);
             fmManNot_NFE.FatPedInsTra.Value := Trim(FieldbyName('InsTra').AsString);
             fmManNot_NFE.FatPedTenTra.Value := Trim(FieldbyName('TenTra').AsString);
             fmManNot_NFE.FatPedEndTra.Value := Trim(FieldbyName('EndTra').AsString);
             fmManNot_NFE.FatPedRefTra.Value := Trim(FieldbyName('RefTra').AsString);
             fmManNot_NFE.FatPedBaiTra.Value := Trim(FieldbyName('BaiTra').AsString);
             fmManNot_NFE.FatPedCidTra.Value := Trim(FieldbyName('CidTra').AsString);
             fmManNot_NFE.FatPedUfeTra.Value := Trim(FieldbyName('SigUfe').AsString);
             fmManNot_NFE.FatPedCepTra.Value := Trim(FieldbyName('CepTra').AsString);
...
begin
  inherited;
  if fmManNot_NFE.FatPedUfeTra.Value <> UfeTra_Ant then begin
...
begin
  inherited;
  if fmManNot_NFE.FatPedId_TraCie.Value <> Id_TraCie_Ant then begin
...
begin
  inherited;
  if fmManNot_NFE.FatPedId_FinCif.Value <> Id_FinCif_Ant then begin
...
begin
  inherited;
  if fmManNot_NFE.FatPedId_FinCie.Value <> Id_FinCie_Ant then begin
...
begin
  inherited;
  if fmManNot_NFE.FatPedUffCli.Value <> UffCli_Ant then begin
...
begin
  inherited;
  if fmManNot_NFE.FatPedUfeCli.Value <> UfeCli_Ant then begin
