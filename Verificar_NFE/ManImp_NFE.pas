...
begin
  ...
  if fmManNot_NFE.FatPedSitFat.Value = 'Faturado' then fmManNot_NFE.Finalizar := 'S';
...
begin
  if fmManNot_NFE.FatPedNroNfs.Value > 0 then begin
     ...
     if EdNroNfs.Value > qtdnfs then begin
        ...
        if fMsgConf('Número de nota fiscal informado esta fora de sequência. Próximo '+Trim( IntToStr(QtdNfs) )+'. Confirma ?','E') = 'SIM' then
           sContinuar := 'S'
        else
           begin
     ...
     if sContinuar = 'S' then begin
        ...
        if fmManNot_NFE.FatPedFlgNfe.Value = 'Nao' then begin
        ...
        if sContinuar = 'S' then begin
           ...
           if Trim(fmManNot_NFE.FatPedSitFat.Value) = 'Nao Concluido' then begin
              ...
              if fmManNot_NFE.FatPedAtuEst.Value = 'Sim' then sText := sText + #10 + ' . Baixas nos Estoques dos Itens Faturados;       ';

              if fmManNot_NFE.FatPedIntFin.Value = 'Sim' then sText := sText + #10 + ' . Lançamentos dos Titulos no Contas a Receber.   ';
           ...
           if sContinuar = 'S' then begin
              ...
              if fmManNot_NFE.FatPedFlgNfe.Value = 'Nao' then begin
                 ...
                 with quSQL,SQL do begin
                      ...
                      if Trim(CecCli) <> '' then CecCli := copy(CecCli,1,5)+ '-' +copy(CecCli,6,3);

                 end;

                 if fmManNot_NFE.FatPedSitFat.Value = 'Nao Concluido' then begin
                 ...
                 if sContinuar = 'S' then begin
                    ...
                    try
                       ...
                       if Trim( fmManNot_NFE.FatPedNomEnt.Value ) <> '' then begin
                          ...
                          if Trim( fmManNot_NFE.FatPedCepCli.Value ) <> '' then
                             EndEnt2 := EndEnt2 + ' Cep ' + copy(Trim(fmManNot_NFE.FatPedCepCli.Value),1,5)+'-'+copy(Trim(fmManNot_NFE.FatPedCepCli.Value),6,3);
                          ...
                          if Trim( fmManNot_NFE.FatPedCepCli.Value ) <> '' then
                             EndEnt1 := EndEnt1 + ' Cep ' + copy(Trim(fmManNot_NFE.FatPedCepCli.Value),1,5)+'-'+copy(Trim(fmManNot_NFE.FatPedCepCli.Value),6,3);
                       ...
                       while not quSQL.Eof do begin
                             ...
                             Nota01[i] := fNumZeros(IntToStr(fmManNot_NFE.FatPedNroNfs.Value),6) + '/' + FNumZeros(IntToStr(quSQL.FieldbyName('NroPe3').AsInteger),3); {Número}
                             Nota02[i] := 'Comp12';
                       ...
                       Nota01[072] := Trim( fmManNot_NFE.FatPedTenTra.Value ) + ' ' + Trim( fmManNot_NFE.FatPedEndTra.Value ) + ', ' + Trim( fmManNot_NFE.FatPedNumTra.Value ) + ' ' + Trim( fmManNot_NFE.FatPedBaiTra.Value );
                       Nota02[072] := 'Comp12';
                       ...
                       if ( Trim(fmManNot_NFE.FatPedOb1Fat.Value) = '' ) and
                          ...
                          ( Trim(fmManNot_NFE.FatPedOb8Fat.Value) = '' ) then begin
                       ...
                       Nota01[117] := IntToStr(fmManNot_NFE.CodCli); {código do Cliente}
                       Nota02[117] := 'Comp12';

                       Nota01[118] := fNumZeros(IntToStr(fmManNot_NFE.CodVen),3); {código do Vendedor}
                       Nota02[118] := 'Comp12';
                       ...
                       Nota01[126] := fmManNot_NFE.FatPedDesReg.Value; {Observações Sobre Desconto}
                       Nota02[126] := 'Comp20';
...
//                     qtdnfis := (fmManNot_NFE.FatPedNroNfs.Value - fmManNot_NFE.FatPedQtdNfs.Value)+ 1;  {Quantidade de Notas Fiscais Impressas}
                       ...
                       while qtdnfis <= fmManNot_NFE.FatPedQtdNfs.Value do begin
                             ...
                             if qtdnfis = fmManNot_NFE.FatPedQtdNfs.Value then begin
                                                  ...
                                                  if qtitens < 2 then begin
                                                     ...
                                                     if Trim( quSql.FieldbyName('CodGru').AsString ) <> '' then begin
                                                        ...
                                                        if quSql.FieldbyName('SeqNfs').AsInteger = qtdnfis then begin
                                                           ...
                                                           {Produto}
                                                           if Trim(quSql.FieldbyName('CodGru').AsString) <> '888' then begin
                                                                          ...
                                                                          if pos('Sim',Linha) > 0 then begin
                                                                             ...
                                                                             if (Reg <> 52) and (Reg <> 126) and (Reg <> 127) and (Reg <> 128) then begin
                                                                                ...
                                                                                if ( (Reg = 126) or (Reg = 127) ) then begin
                                                                                   ...
                                                                                   if (fmManNot_NFE.FatPedTotDsr.Value > 0) and (SeqNfs = QtiNfs) then begin
                                                     ...
                                                     if (Col > 0) or (Inc > 0) then begin
                                                        ...
                                                        if (reg >= 57) and (reg <= 66) then begin
                                                           ...
                                                           if (Reg = 67) and (qtdnfis < fmManNot_NFE.FatPedQtdNfs.Value) then begin
                                                              ...
                                                              if (Reg >= 68) and (Reg <= 81) and (qtdnfis < fmManNot_NFE.FatPedQtdNfs.Value) then begin
                                                                 ...
                                                                 if (reg >= 187) and (reg <= 194) and (qtdnfis < fmManNot_NFE.FatPedQtdNfs.Value) then begin
                       ...
                       if fMsg('Nota fiscal impressa corretamente','O') then begin
