inherited fmManNot_NFE: TfmManNot_NFE
  ...
  object Panel1: TPanel
    ...
    object EdModFrt: TdxDBColorPickEdit
      Left = 675
      Top = 50
      Width = 110
      Hint = 'Tipo de Frete'
  ...
  object grPe2: ThGrid
    ...
    Selected.Strings = (
      ...
      'CODST1'#9'3'#9'CODST1'
      'CODST2'#9'5'#9'CODST2'
      'VLQPE2'#9'14'#9'VLQPE2'
      'TOTPE2'#9'15'#9'TOTPE2'
      'VPFPE2'#9'10'#9'VPFPE2'
      'CODCFO'#9'10'#9'CODCFO'
      'TRBSUB'#9'3'#9'TRBSUB'
      'ICMSUB'#9'10'#9'ICMSUB'
      'MRGSUB'#9'10'#9'MRGSUB'
      'BASESB'#9'10'#9'BASESB'
      'VPFANT'#9'10'#9'VPFANT'
  ...
  object FatPe2: TwwQuery
    ...
    object FatPe2VPFPE2: TFloatField
      DisplayWidth = 10
      FieldName = 'VPFPE2'
      Origin = 'ISADE.FATPE2.VPFPE2'
    end
    ...
    object FatPe2VPFANT: TFloatField
      DisplayWidth = 10
      FieldName = 'VPFANT'
      Origin = 'ISADE.FATPE2.VPFANT'
    end
