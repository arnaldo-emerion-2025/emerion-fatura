...
begin
  ...
  if (Trim(fmManGr1_NFE.FatGerNfePis.Value) = '') or
     (Trim(fmManGr1_NFE.FatGerNfeCof.Value) = '') or (fmManGr1_NFE.FatGerId_EstSip.Value = 0) then begin

     with fmManGr1_NFE.quSQL,SQL do begin
     ...
     if fmManGr1_NFE.FatGerId_EstSip.Value > 0 then begin
  ...
  if (Trim(fmManGr1_NFE.FatGerTenTra.Value) <> '') or
     ...
     (Trim(fmManGr1_NFE.FatGerCepTra.Value) <> '') then begin
  ...
  with fmManGr1_NFE.FatGer do begin
...
begin
  ...
  if Trim(fmManGr1_NFE.FatGerUfeTra.Value) <> '' then begin

     if fmManGr1_NFE.FatGerId_TraUfe.Value = 0 then begin
  ...
  if Trim(fmManGr1_NFE.FatGerUffCli.Value) <> '' then begin

     if fmManGr1_NFE.FatGerId_FinUff.Value = 0 then begin
  ...
  if Trim(fmManGr1_NFE.FatGerUfeCli.Value) <> '' then begin

     if fmManGr1_NFE.FatGerId_FinUfe.Value = 0 then begin
  ...
  if Trim(fmManGr1_NFE.quSQL.FieldbyName('CodCfo').AsString) <> '' then begin
  
     fmManGr1_NFE.FatGerCodCf1.Value := Trim(fmManGr1_NFE.quSQL.FieldbyName('CodCfo').AsString);

     if not fmManGr1_NFE.quSQL.EOF then begin
        ...
        if Trim(fmManGr1_NFE.quSQL.FieldbyName('CodCfo').AsString) <> '' then begin
           ...
           if not fmManGr1_NFE.quSQL.EOF then begin
              ...
              if Trim(fmManGr1_NFE.quSQL.FieldbyName('CodCfo').AsString) <> '' then begin
                 ...
                 if Trim(fmManGr1_NFE.quSQL.FieldbyName('CodCfo').AsString) <> fmManGr1_NFE.FatGerCodCf1.Value then begin
  ...
  if TrimLeft(TrimRight(fmManGr1_NFE.FatGerCgeCli.Value)) <> '' then begin
  ...
  if TrimLeft(TrimRight(fmManGr1_NFE.FatGerCgcTra.Value)) <> '' then begin
...
begin
  inherited;
  if fmManGr1_NFE.FatGerCodTra.Value <> CodTra_Ant then begin

     CodTra_Ant := fmManGr1_NFE.FatGerCodTra.Value;
     
     if fmManGr1_NFE.FatGerCodTra.Value > 0 then begin
...
begin
  inherited;
  if fmManGr1_NFE.FatGerUfeTra.Value <> UfeTra_Ant then begin
...
begin
  inherited;
  if fmManGr1_NFE.FatGerId_TraCie.Value <> Id_TraCie_Ant then begin
...
begin
  inherited;
  if fmManGr1_NFE.FatGerId_FinCif.Value <> Id_FinCif_Ant then begin
...
begin
  inherited;
  if fmManGr1_NFE.FatGerId_FinCie.Value <> Id_FinCie_Ant then begin
...
begin
  inherited;
  if fmManGr1_NFE.FatGerUffCli.Value <> UffCli_Ant then begin
...
begin
  inherited;
  if fmManGr1_NFE.FatGerUfeCli.Value <> UfeCli_Ant then begin
