inherited fmFatR01: TfmFatR01
  Left = 0
  Caption = 'Relação de Devoluções por Acertos'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grCre: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          item
            ColumnName = 'grCreNUMRES'
            SummaryFormat = 'Qtd ####0'
            SummaryType = cstCount
          end
          item
            ColumnName = 'grCreTOTCRE'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
    ...
    object grCreDTECRE: TdxDBGridDateColumn
      Width = 113
      BandIndex = 0
      RowIndex = 0
      FieldName = 'DTECRE'
    ...
    object grCreTOTCRE: TdxDBGridMaskColumn
      Caption = 'Crédito Disp'
    ...
    object grCreOBSCRE: TdxDBGridMemoColumn
      Width = 223
      BandIndex = 0
      RowIndex = 0
      FieldName = 'OBSCRE'
    ...
    object grCreSITCRE: TdxDBGridColumn
      Width = 86
      BandIndex = 0
      RowIndex = 0
      FieldName = 'SITCRE'
  ...
  object FatCre: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           FatCre.SitCre,'
        ...
        '           TextoOcor(IntStrZeros(FatCre.CodCli,05),'#39'-'#39',FinCli.Ap' +
        'eCli,'#39#39','#39#39','#39#39','#39#39') as NomCli,'
      
        '           TextoOcor(IntStrZeros(FatCre.CodVen,05),'#39'-'#39',FinVen.Ap' +
        'eVen,'#39#39','#39#39','#39#39','#39#39') as NomVen,'
      
        '           TextoOcor(IntStrZeros(FatCre.CodUsu,03),'#39'-'#39',GerUsu.Lo' +
        'gUsu,'#39#39','#39#39','#39#39','#39#39') as LogUsu,'
      '            FatCre.TotCre,'
      '            FatCre.MedCom,'
      ...
      'From FatCre LEFT JOIN PedRes ON (FatCre.CodEmp = PedRes.CodEmp)'
        ...
        '                     LEFT JOIN FinVen ON (FatCre.CodVen = FinVen' +
        '.CodVen)'
      
        '                    LEFT JOIN GerUsu ON (FatCre.CodUsu = GerUsu.' +
        'CodUsu)'
      'Where FatCre.DteCre = :DteCre'
      'Order by DteCre,CodEmp,DteRes,NumRes,SeqCre')
    ...
    object FatCreTOTCRE: TFloatField
      DisplayLabel = 'Crédito Disponibilizado'
      DisplayWidth = 10
      FieldName = 'TOTCRE'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    ...
    object FatCreBASCOM: TFloatField
      DisplayLabel = 'Base de Comissão'
      FieldName = 'BASCOM'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object FatCreTOTCOM: TFloatField
      DisplayLabel = 'Total Comissão'
      FieldName = 'TOTCOM'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Devoluções por Acertos'#13#10#13#10
      BandColor = clWhite
