...
type
  TfmManE12_NFE = class(TForm)
    ...
    FatGerCGCFOR: TStringField;
    FatGerINSFOR: TStringField;
    FatGerCODCF1: TStringField;
    FatGerCODCF2: TStringField;
    FatGerFRTNFS: TStringField;
    ...
    FatGerMARNFS: TStringField;
    FatGerNUMNFS: TStringField;
    FatGerESPNFS: TStringField;
    ...
    FatGerCEPFOR: TStringField;
    FatGerTENFOR: TStringField;
    FatGerENDFOR: TStringField;
    FatGerREFFOR: TStringField;
    FatGerNUMFOR: TStringField;
    FatGerBAIFOR: TStringField;
    FatGerCIDFOR: TStringField;
    FatGerUFEFOR: TStringField;
    FatGerTXFIPI: TStringField;
    FatGerTXFICM: TStringField;
    FatGerOBSNFS: TStringField;
    FatGerSEQITE: TIntegerField;
    FatGerQTINFS: TIntegerField;
    FatGerLINNFS: TIntegerField;
    ...
    FatGerHRCNFS: TStringField;
    FatGerDTCNFS: TDateTimeField;
    FatGerUSCNFS: TIntegerField;
    FatGerOBCNFS: TStringField;
    ...
    FatGerSEQOPE: TStringField;
    FatGerSITNFS: TStringField;
    FatGerFLGNFS: TStringField;
    FatGerFLGATU: TStringField;
    FatGerCODTIP: TIntegerField;
    FatGerDESREG: TStringField;
    FatGerFLGENV: TStringField;
    FatGerFLGSIN: TStringField;
    FatGerOB1NFS: TStringField;
    FatGerOB2NFS: TStringField;
    FatGerOB3NFS: TStringField;
    FatGerOB4NFS: TStringField;
    FatGerOB5NFS: TStringField;
    FatGerOB6NFS: TStringField;
    FatGerOB7NFS: TStringField;
    FatGerOB8NFS: TStringField;
    FatGerFLGIMP: TStringField;
    FatGerNOMENT: TStringField;
    FatGerDTFNFS: TDateTimeField;
    FatGerHRFNFS: TStringField;
    FatGerUSFNFS: TIntegerField;
    FatGerOBFNFS: TStringField;
    FatGerCODTFO: TIntegerField;
    FatGerFLGNFE: TStringField;
    FatGerCEFFOR: TStringField;
    FatGerTEFFOR: TStringField;
    FatGerENFFOR: TStringField;
    FatGerRFFFOR: TStringField;
    FatGerNRFFOR: TStringField;
    FatGerBAFFOR: TStringField;
    FatGerCIFFOR: TStringField;
    FatGerUFFFOR: TStringField;
    ...
    FatGerCGEFOR: TStringField;
    FatGerINEFOR: TStringField;
    FatGerID_ESTSIP: TIntegerField;
    FatGerID_CMPNFS: TIntegerField;
    ...
    FatGerNROPDI: TStringField;
    FatGerDTEPDI: TDateTimeField;
    FatGerLOCPDI: TStringField;
    FatGerUFEPDI: TStringField;
    FatGerDTEADU: TDateTimeField;
    FatGerEXPPDI: TStringField;
    FatGerFLGUSA: TStringField;
    FatGerFLGEMI: TStringField;
    FatGerNFETH: TIntegerField;
    FatGerDTECAN: TDateTimeField;
    FatGerNFETHCANC: TIntegerField;
    FatGerARQNFECANC: TBlobField;
    FatGerHRECAN: TStringField;
    FatGerUSUCAN: TIntegerField;
    FatGerAPEFOR: TStringField;
    FatGerNOMFOR: TStringField;
    FatGerPTRFOR: TStringField;
    FatGerFONFOR: TStringField;
...
procedure TfmManE12_NFE.RLBand1BeforePrint(Sender: TObject; var PrintIt: Boolean);
var
  SeqPar: integer;
begin
  ...
  ppCgcCli.Caption := fFormatCGCCPF(FatGerCGCFOR.Value);

  if Trim(FatGerCgefor.Value) <> '' then
    ppCgeCli.Caption := fFormatCGCCPF(FatGerCgefor.Value)
  else
    ppCgeCli.Caption := fFormatCGCCPF(FatGerCgcfor.Value);

  if Trim(FatGerInefor.Value) <> '' then
    ppIneCli.Caption := Trim(FatGerInefor.Value)
  else
    ppIneCli.Caption := Trim(FatGerInsfor.Value);

  if Trim(FatGerPtrfor.Value) <> '' then
    ppFonCli.Caption := '(' + Trim(FatGerPtrfor.Value) + ') ' + Trim(FatGerFonfor.Value)
  else
    ppFonCli.Caption := Trim(FatGerFonfor.Value);

  ppCgcTra.Caption := fFormatCGCCPF(FatGerCgcTra.Value);

  if Trim(FatGerTeffor.Value) <> '' then
    ppEndCli.Caption := Trim(FatGerTeffor.Value) + ' ' + Trim(FatGerEnffor.Value)
  else
    ppEndCli.Caption := Trim(FatGerEnffor.Value);

  if Trim(FatGerNrffor.Value) <> '' then
    ppEndCli.Caption := ppEndCli.Caption + ', ' + Trim(FatGerNrffor.Value);

  if Trim(FatGerRfffor.Value) <> '' then
    ppEndCli.Caption := ppEndCli.Caption + ' ' + Trim(FatGerRfffor.Value);

  if Trim(FatGerTenfor.Value) <> '' then
    ppEntCli.Caption := Trim(FatGerTenfor.Value) + ' ' + Trim(FatGerEndfor.Value)
  else
    ppEntCli.Caption := Trim(FatGerEndfor.Value);

  if Trim(FatGerNumfor.Value) <> '' then
    ppEntCli.Caption := ppEntCli.Caption + ', ' + Trim(FatGerNumfor.Value);

  if Trim(FatGerReffor.Value) <> '' then
    ppEntCli.Caption := ppEntCli.Caption + ' ' + Trim(FatGerReffor.Value);
  ...
  begin
    ...
    {     with quSQL,SQL do begin
              ...
              Text := ' Select FatGe3.NroGe3,'+
                      ...
                      '   and FatGe3.DteGer = '+ QuotedStr(fDateToSQL(FatGerDTENFS.Value)) +
                      '   and FatGe3.NumGer = '+ QuotedStr(IntToStr(FatGerNUMNFS.asinteger)) ;
              Open;
              First;
...
procedure TfmManE12_NFE.RLDetailGrid1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfmManE12_NFE.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  with quSQL, SQL do
  begin

    Close;
    Text := ' Delete From FatNfe Where FatNfe.Id_CMPNFS = ' + QuotedStr(IntToStr(FatGerID_CMPNFS.Value));
    ExecSQL;

  end;
end;

procedure TfmManE12_NFE.RLPreviewSetup1Send(Sender: TObject);
begin
  TFormSendMailOptions.CreateShowAndFree(TRLPreviewForm(Sender).Preview.Pages);
end;

procedure TfmManE12_NFE.RLReport1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  IncPag := 1;
end;

procedure TfmManE12_NFE.RLReport1PageStarting(Sender: TObject);
begin
  IncPag := IncPag + 1;
end;
