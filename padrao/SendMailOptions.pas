...
//  if Trim(GEmail) <> '' then EditDestinatarios.Text := GEmail;

//  if Trim(GAssunto) <> '' then EditAssunto.Text := GAssunto;

//  if Trim(GEmail) = '' then
//     EditDestinatarios.SetFocus
//  else
