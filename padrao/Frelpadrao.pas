...
{*************************************************************************
* Rotina: gera��o das colunas do relat�rio em fun��o do DataSet vinculado
*************************************************************************}
    ...
    for i := 0 to FieldCount - 1 do begin
      ...
      if Fields[i].Visible then begin
        ...
        with aTitulo[i] do begin
          ...
          // Comprimento em fun��o do fonte usado
        ...
        // Convers�o da largura do campo para cent�metros
...
begin
  ...
  with Self do
    ...
    for i := 0 to ComponentCount - 1 do begin
      ...
      { Ativa��o autom�tica dos componentes wwQuery: somente com Tag = 0 }
      if (Components[i] is TwwQuery) then
        with TwwQuery(Components[i]) do
          if (Tag = 0) then begin
            ...
            { Verifica se existe par�metro definido para sele��o por c�digo da
              empresa. Se o mesmo estiver definido, o sistema assume a
              empresa ativa para sele��o dos dados.
            }
