inherited fmPedR15: TfmPedR15
  ...
  object grR15: TdxDBGrid
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR15ReloadGroupList
    ...
    object DTEFAT: TdxDBGridDateColumn
      Caption = 'Dt Fat.'
      Width = 78
      BandIndex = 0
      RowIndex = 0
    ...
    object NRONFS: TdxDBGridMaskColumn
      Alignment = taLeftJustify
      Caption = 'NF'
      Width = 75
      BandIndex = 0
    ...
    object TOTBRT: TdxDBGridMaskColumn
      Caption = 'Total Bruto'
    ...
    object TOTLIQ: TdxDBGridMaskColumn
      Caption = 'Total Liq'
      HeaderAlignment = taRightJustify
      Width = 85
      BandIndex = 0
    ...
    object DSCPER: TdxDBGridMaskColumn
      Caption = 'Desc Per'
      HeaderAlignment = taRightJustify
      Width = 81
      BandIndex = 0
    ...
    object DSCPRT: TdxDBGridMaskColumn
      Caption = 'Desc Prat'
      HeaderAlignment = taRightJustify
      Width = 81
      BandIndex = 0
    ...
    object DIFDSC: TdxDBGridMaskColumn
      Caption = '% Dif Desc'
      HeaderAlignment = taRightJustify
      Width = 91
      BandIndex = 0
    ...
    object MARPRE: TdxDBGridMaskColumn
      Caption = 'Mk - Brt'
      HeaderAlignment = taRightJustify
      Width = 74
      BandIndex = 0
    ...
    object MARPED: TdxDBGridMaskColumn
      Caption = 'Mk - P'
      HeaderAlignment = taRightJustify
      Width = 76
      BandIndex = 0
    ...
    object LUCROP: TdxDBGridMaskColumn
      Caption = 'Lucro Bruto'
      HeaderAlignment = taRightJustify
      Width = 100
      BandIndex = 0
    ...
    object LUCROL: TdxDBGridMaskColumn
      Caption = 'Lucro Liq'
      HeaderAlignment = taRightJustify
      Width = 88
      BandIndex = 0
    ...
    object TOTNAT: TdxDBGridMaskColumn
  ...
  object PedR15: TwwQuery
    ...
    SQL.Strings = (
      ...
      '            TotPer,'
        ...
        '            TextoOcor(IntStrZeros(CodCli,5),'#39'-'#39',Fincli.ApeCli,'#39#39 +
        ','#39#39','#39#39','#39#39') as Cliente,'
      
        '            TextoOcor(IntStrZeros(CodVen,3),'#39'-'#39',FinVen.ApeVen,'#39#39 +
        ','#39#39','#39#39','#39#39') as Vendedor'
      'From PedR15 LEFT JOIN FinVen ON (PedR15.CodVen = FinVen.CodVen)'
      
        '                       LEFT JOIN FinCli ON (PedR15.CodCli = FinC' +
        'li.CodCli)'
    ...
    object PedR15DTERES: TDateTimeField
      FieldName = 'DTERES'
    end
    object PedR15NRONFS: TIntegerField
      FieldName = 'NRONFS'
    end
    object PedR15DTEFAT: TDateTimeField
      FieldName = 'DTEFAT'
    end
    object PedR15TOTBRT: TFloatField
      FieldName = 'TOTBRT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15TOTLIQ: TFloatField
      FieldName = 'TOTLIQ'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15DSCPER: TFloatField
      FieldName = 'DSCPER'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15DSCPRT: TFloatField
      FieldName = 'DSCPRT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15DIFDSC: TFloatField
      FieldName = 'DIFDSC'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15MARPRE: TFloatField
      FieldName = 'MARPRE'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15MARPED: TFloatField
      FieldName = 'MARPED'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15LUCROL: TFloatField
      FieldName = 'LUCROL'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15LUCROP: TFloatField
      FieldName = 'LUCROP'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15TOTNAT: TFloatField
      FieldName = 'TOTNAT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15CLIENTE: TStringField
      FieldName = 'CLIENTE'
      FixedChar = True
      Size = 100
    end
    object PedR15VENDEDOR: TStringField
      FieldName = 'VENDEDOR'
      FixedChar = True
      Size = 100
    end
    object PedR15CSTPRT: TFloatField
      DisplayLabel = 'Ct - PED'
      FieldName = 'CSTPRT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15CSTPFI: TFloatField
      DisplayLabel = 'Ct - UC'
      FieldName = 'CSTPFI'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15CSTVME: TFloatField
      DisplayLabel = 'Ct - ME'
      FieldName = 'CSTVME'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15TOTPER: TFloatField
      DisplayLabel = 'Bruto + Desc'
      FieldName = 'TOTPER'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR15ID_PEDRES: TIntegerField
      Alignment = taLeftJustify
      FieldName = 'ID_PEDRES'
    end
  end
  object DsR15: TwwDataSource
    DataSet = PedR15
    Left = 31
    Top = 358
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      Active = True
      Component = grR15
      DateTime = 39966.6256841088
      DesignerHelpContext = 0
      PrinterPage.DMPaper = 9
      PrinterPage.Footer = 6350
      PrinterPage.Header = 6700
      ...
      ReportTitle.Text = #13#10'Analise de pedidos realizados no periodo'#13#10#13#10
      BandColor = clWhite
