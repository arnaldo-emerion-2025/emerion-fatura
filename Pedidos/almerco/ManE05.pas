...
procedure TfmManE05.RLBand06BeforePrint(Sender: TObject; var PrintIt: Boolean);
begin
...
procedure TfmManE05.RLBand3BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
...
procedure TfmManE05.RLReport1BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
  ...
  if PedResIntFin.Value = 'Sim' then begin
     ...
     if PedParImpFin.Value = 'Sim' then begin

        RLBand10.Visible := True;
        RLBand11.Visible := True;
...
procedure TfmManE05.RLBand10BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
var
  QtdReg : integer;
begin
...
procedure TfmManE05.RLBand11BeforePrint(Sender: TObject;
  var PrintIt: Boolean);
begin
