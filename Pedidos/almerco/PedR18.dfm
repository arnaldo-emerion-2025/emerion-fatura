inherited fmPedR18: TfmPedR18
  ...
  object grR18: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          item
            ColumnName = 'grR18TOTBRT'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18TOTPER'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18TOTLIQ'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18CSTPRT'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18CSTPFI'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18CSTVME'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18DSCPER'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18DSCPRT'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18LUCROP'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18LUCROL'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18TOTNAT'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18PRTFAT'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR18PRTCST'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end>
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR18ReloadGroupList
    object grR18MARCA: TdxDBGridColumn
      Width = 257
      BandIndex = 0
      RowIndex = 0
      FieldName = 'MARCA'
    end
    object grR18TOTBRT: TdxDBGridMaskColumn
      Caption = 'Total Bruto'
    ...
    object grR18TOTPER: TdxDBGridColumn
      Caption = 'Bruto - Desc'
      HeaderAlignment = taRightJustify
      Width = 97
      BandIndex = 0
    ...
    object grR18TOTLIQ: TdxDBGridMaskColumn
      Caption = 'Total Liq'
      HeaderAlignment = taRightJustify
      Width = 81
      BandIndex = 0
    ...
    object grR18CSTPRT: TdxDBGridColumn
      HeaderAlignment = taRightJustify
      Width = 72
      BandIndex = 0
      RowIndex = 0
    ...
    object grR18CSTPFI: TdxDBGridColumn
      HeaderAlignment = taRightJustify
      Width = 68
      BandIndex = 0
      RowIndex = 0
    ...
    object grR18CSTVME: TdxDBGridColumn
      HeaderAlignment = taRightJustify
      Width = 70
      BandIndex = 0
      RowIndex = 0
    ...
    object grR18DSCPER: TdxDBGridMaskColumn
      Caption = 'Desc Per'
      HeaderAlignment = taRightJustify
      Width = 75
      BandIndex = 0
    ...
    object grR18DSCPRT: TdxDBGridMaskColumn
      Caption = 'Desc Prat'
      HeaderAlignment = taRightJustify
      Width = 81
      BandIndex = 0
    ...
    object grR18DIFDSC: TdxDBGridMaskColumn
      Caption = '% Dif Desc'
      HeaderAlignment = taRightJustify
      Width = 85
      BandIndex = 0
    ...
    object grR18MARPRE: TdxDBGridMaskColumn
      Caption = 'Mk - Brt'
      HeaderAlignment = taRightJustify
      Width = 69
      BandIndex = 0
    ...
    object grR18MARPED: TdxDBGridMaskColumn
      Caption = 'Mk - P'
      HeaderAlignment = taRightJustify
      Width = 67
      BandIndex = 0
    ...
    object grR18LUCROP: TdxDBGridMaskColumn
      Caption = 'Lucro Bruto'
      HeaderAlignment = taRightJustify
      Width = 97
      BandIndex = 0
    ...
    object grR18LUCROL: TdxDBGridMaskColumn
      Caption = 'Lucro Liq'
      HeaderAlignment = taRightJustify
      Width = 91
      BandIndex = 0
    ...
    object grR18TOTNAT: TdxDBGridMaskColumn
    ...
    object grR18PRTFAT: TdxDBGridColumn
      Caption = '% Prt Liq'
      HeaderAlignment = taRightJustify
      Width = 80
      BandIndex = 0
    ...
    object grR18PRTCST: TdxDBGridColumn
      Caption = '% Prt Cst'
      HeaderAlignment = taRightJustify
      Width = 85
      BandIndex = 0
  ...
  object PedR18: TwwQuery
    ...
    object PedR18TOTBRT: TFloatField
      FieldName = 'TOTBRT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18TOTLIQ: TFloatField
      FieldName = 'TOTLIQ'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18DSCPER: TFloatField
      FieldName = 'DSCPER'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18DSCPRT: TFloatField
      FieldName = 'DSCPRT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18DIFDSC: TFloatField
      FieldName = 'DIFDSC'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18MARPRE: TFloatField
      FieldName = 'MARPRE'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18MARPED: TFloatField
      FieldName = 'MARPED'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18LUCROL: TFloatField
      FieldName = 'LUCROL'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18LUCROP: TFloatField
      FieldName = 'LUCROP'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18TOTNAT: TFloatField
      FieldName = 'TOTNAT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18CSTPRT: TFloatField
      DisplayLabel = 'Ct - PED'
      FieldName = 'CSTPRT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18CSTPFI: TFloatField
      DisplayLabel = 'Ct - UC'
      FieldName = 'CSTPFI'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18CSTVME: TFloatField
      DisplayLabel = 'Ct - ME'
      FieldName = 'CSTVME'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18TOTPER: TFloatField
      DisplayLabel = 'Bruto + Desc'
      FieldName = 'TOTPER'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18PRTFAT: TFloatField
      FieldName = 'PRTFAT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18PRTCST: TFloatField
      FieldName = 'PRTCST'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR18MARCA: TStringField
      DisplayLabel = 'Marca'
      FieldName = 'MARCA'
      FixedChar = True
      Size = 40
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Curva ABC por marca de produtos'#13#10
      BandColor = clWhite
