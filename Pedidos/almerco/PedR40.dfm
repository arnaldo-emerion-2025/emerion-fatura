inherited fmPedR40: TfmPedR40
  ...
  object grR17: TdxDBGrid
    ...
    object grR17CODCFO: TdxDBGridColumn
      Caption = 'CFOP'
      Sorted = csUp
      Visible = False
      BandIndex = 0
    ...
    object grR17PRODEP: TdxDBGridColumn
      Sorted = csUp
      Visible = False
      BandIndex = 0
      RowIndex = 0
  ...
  object PedR17: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           PedR17.PrtCst,'
        ...
        '           TextoOcor(IntStrZeros(PedR17.CodTip,5),'#39'-'#39',EstTip.Nom' +
        'Tip,'#39#39','#39#39','#39#39','#39#39') as Tipo'
      'From PedR17 LEFT JOIN EstTip ON (PedR17.CodTip = EstTip.CodTip)'
      'Where PedR17.SeqArq = :SeqArq'
      'Order by PedR17.CodTip'
      ''
      ''
      ''
      ''
    ...
    object PedR17CODCFO: TStringField
      FieldName = 'CODCFO'
      Size = 10
    end
    object PedR17PRODEP: TStringField
      FieldName = 'PRODEP'
      Size = 18
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Curva ABC por CFOP e tipo de produtos'#13#10#13#10
      BandColor = clWhite
