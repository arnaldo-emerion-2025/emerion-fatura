inherited fmPedR32: TfmPedR32
  ...
  object grMv2: TdxDBGrid
    ...
    ShowRowFooter = True
    OnReloadGroupList = grMv2ReloadGroupList
    object MESANO: TdxDBGridColumn
      Caption = 'Mes/Ano'
      Sorted = csUp
      Visible = False
      Width = 1242
  ...
  object PedMv2: TwwQuery
    ...
    SQL.Strings = (
        ...
        'Select TextoOcor(IntStrZeros(PedMve.NroMes,2),'#39'-'#39',PedMve.MesMve,' +
        #39'/'#39',PedMve.AnoMve,'#39#39','#39#39') as MesAno,'
      
        '           TextoOcor(IntStrZeros(PedMv2.CodVen,5),'#39'-'#39',FinVen.Ape' +
        'Ven,'#39#39','#39#39','#39#39','#39#39') as Vendedor,'
      '           PedMv2.TotMv2'
      'From PedMv2,PedMve,FinVen'
      'Where PedMv2.Id_PedMve = PedMve.Id_PedMve '
      '    and PedMv2.CodVen = FinVen.CodVen'
      '    and PedMve.AnoMve = :AnoMve')
    ...
    object PedMv2MESANO: TStringField
      FieldName = 'MESANO'
      FixedChar = True
      Size = 100
    end
    ...
    object PedMv2VENDEDOR: TStringField
      FieldName = 'VENDEDOR'
      FixedChar = True
      Size = 100
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de metas definidas para os vendedores'#13#10#13#10
      BandColor = clWhite
