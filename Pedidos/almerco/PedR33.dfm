inherited fmPedR33: TfmPedR33
  Left = 0
  Caption = 'Relação de pedidos aguardando consulta liberados no periodo'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object EdPsqDteCon1: TdxColorDateEdit
    Left = 194
    Top = 106
    Width = 87
    Color = 16577773
  ...
  object EdPsqDteCon2: TdxColorDateEdit
    Left = 306
    Top = 106
    Width = 87
    Color = 16577773
  ...
  object grCon: TdxDBGrid
    ...
    ShowRowFooter = True
    OnReloadGroupList = grConReloadGroupList
    object DTECON: TdxDBGridDateColumn
      Caption = 'Liberado em'
      Sorted = csUp
      Visible = False
      Width = 145
    ...
    object HRECON: TdxDBGridMaskColumn
      Caption = 'Liberado as'
      Width = 108
      BandIndex = 0
      RowIndex = 0
    ...
    object OB1CON: TdxDBGridMemoColumn
      Caption = 'Observações'
      Width = 522
      BandIndex = 0
      RowIndex = 0
  ...
  object PedCon: TwwQuery
    CachedUpdates = True
    DatabaseName = 'ISade'
    SQL.Strings = (
      'Select PedCon.Id_PedRes,'
      '           PedCon.DteCon,'
      '           PedCon.HreCon,'
      '           PedCon.Ob1Con,'
      '           PedRes.DteRes,'
      ...
      '           GerUsu.LogUsu,'
        ...
        'From PedCon LEFT JOIN PedRes ON (PedCon.Id_PedRes = PedRes.Id_Pe' +
        'dRes)'
        ...
        '                    LEFT JOIN GerUsu ON (PedCon.CodUsu = GerUsu.' +
        'CodUsu)'
      'Where PedCon.DteCon = :DteCon'
      'Order by PedCon.DteCon,PedCon.Id_PedRes')
    ...
    object PedConDTERES: TDateTimeField
      FieldName = 'DTERES'
      EditMask = '!99/99/9999;1;_'
    end
    object PedConLOGUSU: TStringField
      FieldName = 'LOGUSU'
      FixedChar = True
      Size = 15
    end
    object PedConCLIENTE: TStringField
      FieldName = 'CLIENTE'
      FixedChar = True
      Size = 100
    end
    object PedConVENDEDOR: TStringField
      FieldName = 'VENDEDOR'
      FixedChar = True
      Size = 100
    end
    object PedConTOTRES: TFloatField
      FieldName = 'TOTRES'
      DisplayFormat = '###,###,##0.00'
    end
    object PedConTOTIPI: TFloatField
      FieldName = 'TOTIPI'
      DisplayFormat = '###,###,##0.00'
    end
    object PedConTOTGER: TFloatField
      FieldName = 'TOTGER'
      DisplayFormat = '###,###,##0.00'
    end
    object PedConID_PEDRES: TIntegerField
      FieldName = 'ID_PEDRES'
    end
    object PedConDTECON: TDateTimeField
      FieldName = 'DTECON'
    end
    object PedConHRECON: TStringField
      FieldName = 'HRECON'
      FixedChar = True
      Size = 8
    end
    object PedConOB1CON: TStringField
      FieldName = 'OB1CON'
      Size = 80
    end
  end
  object DsPedCon: TwwDataSource
    DataSet = PedCon
    Left = 32
    Top = 358
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = 
        #13#10'Relação de pedidos aguardando consulta liberados no periodo'#13#10#13 +
        #10
      BandColor = clWhite
