inherited fmPedR20: TfmPedR20
  ...
  object grR17: TdxDBGrid
    ...
    object grR17ID_PEDRES: TdxDBGridMaskColumn
      Caption = 'No. Pedido'
      Width = 99
      BandIndex = 0
      RowIndex = 0
    ...
    object grR17QTPRE2: TdxDBGridMaskColumn
      Caption = 'Qtde. Ped'
  ...
  object PedR17: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           Round(PedRe2.VlqRe2 - PedRe2.VdrRe2,4) as VlqLb2,'
        ...
        '           Round(PedLb2.SldLb2 * (PedRe2.VlqRe2 - PedRe2.VdrRe2)' +
        ',4) as TotLb2,'
      ...
      '     and PedRes.ModPfa = '#39'Vendas'#39
      
        '     and ( ( PedLib.SitLib = '#39'Faturado'#39'  ) or ( PedLib.SitLib = ' +
        #39'Devolvido'#39' and not MonthOfYear(PedLib.DteFat) = MonthOfYear(Ped' +
        'Lib.DteDev) ) )'
      '     and PedLb2.SldLb2 > 0')
    ...
    object PedR17ID_PEDRES: TIntegerField
