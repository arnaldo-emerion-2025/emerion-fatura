inherited fmPedR26: TfmPedR26
  Left = 0
  Caption = 'Atendentes (Fechamento de comissões - Sintetico)'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object Label2: TLabel
    ...
    Width = 142
    Height = 13
    Caption = 'Atendentes selecionados'
    Color = clBtnFace
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      'Select PedR10.*,'
        ...
        '           TextoOcor(IntStrZeros(PedR10.CodVen,3),'#39'-'#39',FinAtd.Ape' +
        'Atd,'#39#39','#39#39','#39#39','#39#39') as Vendedor'
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Atendentes (Fechamento de comissões - Sintético)'#13#10#13#10
      BandColor = clWhite
  ...
  object PedPar: TwwQuery
    ...
    DatabaseName = 'ISade'
    SQL.Strings = (
      'Select PedPar.TipAtd From PedPar')
    UniDirectional = True
    ValidateWithMask = True
    Left = 63
    Top = 374
