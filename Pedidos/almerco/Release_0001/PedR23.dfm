inherited fmPedR23: TfmPedR23
  ...
  object grR23: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          item
            ColumnName = 'grR23TOTNAT'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end>
        Name = 'grR23SummaryGroup1'
      end>
    SummarySeparator = ', '
    BorderStyle = bsNone
    Color = clInfoBk
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR23ReloadGroupList
    object grR23CODITE: TdxDBGridMaskColumn
      Caption = 'Item'
      Width = 131
      BandIndex = 0
      RowIndex = 0
    ...
    object grR23DSCPRO: TdxDBGridMaskColumn
    ...
    object grR23QTDNAT: TdxDBGridColumn
      Caption = 'Qtde Não Atendida'
    ...
    object grR23TOTNAT: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = 'Total Não Atendido'
      HeaderAlignment = taRightJustify
      Width = 152
      BandIndex = 0
      RowIndex = 0
  ...
  object PedR23: TwwQuery
    CachedUpdates = True
    DatabaseName = 'ISade'
    SQL.Strings = (
      'Select PedR23.QtdNat,'
      '           PedR23.TotNat,'
      '           EstPro.DscPro,'
      
        '           PedR23.CodClp || _UNICODE_FSS '#39'-'#39' || PedR23.CodGru ||' +
        ' _UNICODE_FSS '#39'.'#39' || PedR23.CodSub || _UNICODE_FSS '#39'.'#39' || PedR23' +
        '.CodPro as CodIte'
      'From PedR23,EstPro'
    ...
    object PedR23QTDNAT: TFloatField
      FieldName = 'QTDNAT'
      DisplayFormat = '###,###,##0'
      Precision = 4
    end
    object PedR23TOTNAT: TFloatField
      FieldName = 'TOTNAT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedR23DSCPRO: TStringField
      FieldName = 'DSCPRO'
      FixedChar = True
      Size = 70
    end
    object PedR23CODITE: TStringField
      FieldName = 'CODITE'
      Size = 16
    end
  end
  object DsR23: TwwDataSource
    DataSet = PedR23
    Left = 31
    Top = 374
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Curva ABC de itens não atendidos'#13#10
      BandColor = clWhite
