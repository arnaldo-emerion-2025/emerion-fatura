inherited fmManRes: TfmManRes
  ...
  object EdPsqSitRes: TdxColorPickEdit
    ...
    Items.Strings = (
      ...
      'Aguardando informacoes de transporte'
  ...
  object grRes: ThGrid
    ...
    Height = 99
    Selected.Strings = (
      'ID_PEDRES'#9'10'#9'Pedido'#9'F'
      'CODVEN'#9'10'#9'Vendedor'#9'F'
      'CODATD'#9'7'#9'Atend.'#9'F'
  ...
  object UpRes: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into PedRes'
      '  (ID_PEDRES, DTERES, HRERES, DTFRES, CODTIP, CODCLI, CODVEN, '
      'CODATD, CODPFA, '
      
        '   CODEAN, TOTRES, TOTREN, TOTGER, FATGER, DEVGER, SLDGER, FLGIM' +
        'P, '
      'FLGOCO, '
      '   FLGREJ, FLGEST, FLGATU, QTIRE4, SITRES)'
      'values'
      
        '  (:ID_PEDRES, :DTERES, :HRERES, :DTFRES, :CODTIP, :CODCLI, :COD' +
        'VEN, '
      ':CODATD, '
      
        '   :CODPFA, :CODEAN, :TOTRES, :TOTREN, :TOTGER, :FATGER, :DEVGER' +
        ', '
      ':SLDGER, '
      
        '   :FLGIMP, :FLGOCO, :FLGREJ, :FLGEST, :FLGATU, :QTIRE4, :SITRES' +
        ')')
    DeleteSQL.Strings = (
      'delete from PedRes'
      'where'
