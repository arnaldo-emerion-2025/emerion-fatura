...
begin
  inherited;
  if Trim( fmPedR16.PedResDesRe2.Value ) <> '' then
     ppDesLb2.Caption := fmPedR16.PedResCodGru.Value+ '.' +fmPedR16.PedResCodSub.Value+ '.' +fmPedR16.PedResCodPro.Value+ ' - ' +fmPedR16.PedResDesRe2.Value;
end;
...
begin
  inherited;
  ppNumRes.Caption := IntToStr(fmPedR16.PedResId_PedRes.Value);
end;
