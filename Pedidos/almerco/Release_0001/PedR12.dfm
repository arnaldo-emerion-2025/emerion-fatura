inherited fmPedR12: TfmPedR12
  ...
  object Label17: TLabel
    ...
    Width = 191
    Height = 13
    Caption = 'Recebimentos realizados no periodo de:'
  ...
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           PedR12.TotCom,'
        ...
        '           TextoOcor(IntStrZeros(PedR12.CodCli,05),'#39'-'#39',FinCli.No' +
        'mCli,'#39#39','#39#39','#39#39','#39#39') as Cliente'
      'From PedR12 LEFT JOIN FinCli ON (PedR12.CodCli = FinCli.CodCli)'
      'Where PedR12.SeqArq = :SeqArq'
    ...
    object PedResNUMCRP: TIntegerField
      FieldName = 'NUMCRP'
    end
    object PedResQTPCRE: TIntegerField
      FieldName = 'QTPCRE'
    end
    ...
    object PedResDTEREC: TDateTimeField
      FieldName = 'DTEREC'
    end
  end
