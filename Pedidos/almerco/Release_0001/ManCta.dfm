inherited fmManCta: TfmManCta
  ...
  object EdPsqId_PedCta: TdxColorEdit
    Left = 139
    Top = 12
    Width = 87
    Color = 16577773
    ...
    Style.Shadow = True
    TabOrder = 0
    OnExit = EdPsqId_PedCtaExit
    OnKeyPress = EdPsqId_PedCtaKeyPress
  ...
  object grCta: ThGrid
    ...
    Height = 105
    Selected.Strings = (
      'ID_PEDCTA'#9'10'#9'No. Cotação   '#9'F'
      'APEVEN'#9'14'#9'Vendedor'#9'F'
      'NOMCLI'#9'29'#9'Cliente'#9'F'
      'CODPFA'#9'21'#9'Padrão de Faturamento'#9'F'
      'TOTITE'#9'10'#9'        Total Itens'#9'F'
      'TOTGER'#9'10'#9'        Total Cotacao'#9'F')
  ...
  object grCt2: ThGrid
    ...
    Selected.Strings = (
      'CODITE'#9'16'#9'Item'
      'DESCT2'#9'39'#9' '
      'QTPCT2'#9'10'#9'       Quantidade'
      'VLQCT2'#9'10'#9'    Valor Unitário'
      'ICMCT2'#9'4'#9'    ICMS'
      'TOTCT2'#9'10'#9'         Total do Item')
    IniAttributes.Delimiter = ';;'
    TitleColor = clBtnFace
    FixedCols = 0
    ShowHorzScrollBar = True
  ...
  object EdPsqSitCta: TdxColorPickEdit
    Left = 568
    Top = 12
    Width = 216
    Color = 16577773
  ...
  object UpCta: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into PedCta'
        ...
        '  (ID_PEDCTA, DTECTA, HRECTA, CODPFA, CODCLI, NOMCLI, CODVEN, QT' +
        'ICT4, '
      'TOTITE, '
      '   TOTGER, TOTREN, ID_PEDRES, ID_PEDGER, FLGGER, PEDCLI, SITCTA)'
      'values'
      
        '  (:ID_PEDCTA, :DTECTA, :HRECTA, :CODPFA, :CODCLI, :NOMCLI, :COD' +
        'VEN, '
      ':QTICT4, '
      
        '   :TOTITE, :TOTGER, :TOTREN, :ID_PEDRES, :ID_PEDGER, :FLGGER, :' +
        'PEDCLI, '
      '   :SITCTA)')
    DeleteSQL.Strings = (
      'delete from PedCta'
