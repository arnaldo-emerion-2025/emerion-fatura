inherited fmPedR37: TfmPedR37
  ...
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      'Select PedR25.*,'
        ...
        '           TextoOcor(IntStrZeros(PedR25.CodVen,5),'#39'-'#39',FinVen.Ape' +
        'Ven,'#39'('#39',FinTve.NomTve,'#39')'#39','#39#39') as Vendedor'
      'From PedR25 LEFT JOIN FinVen ON (PedR25.CodVen = FinVen.CodVen)'
      'Where PedR25.SeqArq = :SeqArq'
      'Order by PedR25.CodVen')
    ...
    object PedResTOTMET: TFloatField
      FieldName = 'TOTMET'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResPRTMET: TFloatField
      FieldName = 'PRTMET'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResTOTACU: TFloatField
      FieldName = 'TOTACU'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResFLGOPE: TStringField
      FieldName = 'FLGOPE'
      FixedChar = True
      Size = 3
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Resumo diário por vendedor'#13#10#13#10
      BandColor = clWhite
