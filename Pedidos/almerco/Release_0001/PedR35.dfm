inherited fmPedR35: TfmPedR35
  ...
  object EdPsqMes: TdxColorPickEdit
    Left = 163
    Top = 108
    Width = 96
    Color = 16577773
  ...
  object PedRes: TwwQuery
    ...
    object PedResMETM01: TFloatField
      FieldName = 'METM01'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResTOTM01: TFloatField
      FieldName = 'TOTM01'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResPRTM01: TFloatField
      FieldName = 'PRTM01'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResMETM02: TFloatField
      FieldName = 'METM02'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResTOTM02: TFloatField
      FieldName = 'TOTM02'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResPRTM02: TFloatField
      FieldName = 'PRTM02'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResMETM03: TFloatField
      FieldName = 'METM03'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResTOTM03: TFloatField
      FieldName = 'TOTM03'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResPRTM03: TFloatField
      FieldName = 'PRTM03'
      DisplayFormat = '###,###,##0.00'
    end
    ...
    object PedResTOTV01: TFloatField
      FieldName = 'TOTV01'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResTOTV02: TFloatField
      FieldName = 'TOTV02'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResTOTV03: TFloatField
      FieldName = 'TOTV03'
      DisplayFormat = '###,###,##0.00'
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de objetivos por vendedor - Trimestral'#13#10#13#10
      BandColor = clWhite
