inherited fmPedR16: TfmPedR16
  ...
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      ...
      '     and PedRes.DteRes >= :DteRes1'
      '     and PedRes.DteRes <= :DteRes2'
      '     and PedRes.AtuEst = '#39'Sim'#39
      '     and PedLb2.SldLb2 > 0'
      
        '     and ( PedLib.SitLib = '#39'Faturado'#39' or PedLib.SitLib = '#39'Parcia' +
        'lmente Faturado'#39')'
      'Order by PedRes.CodCli,PedRes.Id_PedRes')
    ...
    object PedResDESRE2: TStringField
      FieldName = 'DESRE2'
      Size = 70
    end
