inherited fmPedR05: TfmPedR05
  ...
  object bPsqGru: TSpeedButton
    ...
    Width = 23
    Height = 21
    Hint = 'Pesquisar Grupos de Clientes Existentes'
    Flat = True
    Glyph.Data = {
      36030000424D3603000000000000360000002800000010000000100000000100
      18000000000000030000C40E0000C40E00000000000000000000C0CFD0C0CFD0
  ...
  object Label12: TLabel
    ...
    Width = 111
    Height = 13
    Caption = 'Tipo de pedido emitido:'
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -11
    Font.Name = 'Tahoma'
  ...
  object grRes: TdxDBGrid
    ...
    object grResCODCLI: TdxDBGridMaskColumn
      Width = 71
      BandIndex = 0
      RowIndex = 0
      FieldName = 'CODCLI'
    ...
    object grResMARKUP: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 95
      BandIndex = 0
      RowIndex = 0
  ...
  object PedRes: TwwQuery
    ...
    object PedResSEQARQ: TStringField
      FieldName = 'SEQARQ'
      Origin = 'ISADE.PEDR05.SEQARQ'
      FixedChar = True
      Size = 22
    end
    object PedResTOTCST: TFloatField
      FieldName = 'TOTCST'
      Origin = 'ISADE.PEDR05.TOTCST'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Comercial - Curva ABC de Clientes'#13#10#13#10
      BandColor = clWhite
