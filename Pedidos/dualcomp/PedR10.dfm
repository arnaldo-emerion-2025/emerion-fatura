inherited fmPedR10: TfmPedR10
  ...
  object grRes: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          ...
          item
            ColumnName = 'grResTOTCFA'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grResTOTDEV'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grResTOTCRE'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grResTOTDEB'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grResFATLIQ'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grResTOTLIQ'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end>
    ...
    object grResVENDEDOR: TdxDBGridMaskColumn
      Width = 147
      BandIndex = 0
      RowIndex = 0
      FieldName = 'VENDEDOR'
    ...
    object grResTOTCAN: TdxDBGridMaskColumn
      Caption = 'Tot Ped Canc'
      HeaderAlignment = taRightJustify
      Width = 96
      BandIndex = 0
      RowIndex = 0
    ...
    object grResTOTFAT: TdxDBGridMaskColumn
      Caption = 'Total Fat'
      HeaderAlignment = taRightJustify
      Width = 82
      BandIndex = 0
    ...
    object grResTOTCFA: TdxDBGridColumn
      Caption = 'Tot Fat Canc'
      HeaderAlignment = taRightJustify
      Width = 95
      BandIndex = 0
      RowIndex = 0
    ...
    object grResTOTDEV: TdxDBGridMaskColumn
      Caption = 'Total Dev'
      HeaderAlignment = taRightJustify
      Width = 83
      BandIndex = 0
    ...
    object grResTOTCRE: TdxDBGridMaskColumn
      Caption = 'Créditos'
      HeaderAlignment = taRightJustify
      Width = 82
      BandIndex = 0
    ...
    object grResTOTDEB: TdxDBGridColumn
      Caption = 'Debitos'
      HeaderAlignment = taRightJustify
      Width = 73
      BandIndex = 0
    ...
    object grResFATLIQ: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = 'Tot Fat Liquido'
      HeaderAlignment = taRightJustify
      Width = 112
      BandIndex = 0
      RowIndex = 0
    ...
    object grResTOTLIQ: TdxDBGridColumn
    ...
    object grResQTDATI: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      BandIndex = 0
      RowIndex = 0
      FieldName = 'QTDATI'
  ...
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           Sum(TotFat - (TotCfa + TotDev)) as FatLiq,'
      '           Round(Sum(TotCre) - Sum(TotDeb),2) as TotLiq,'
      
        '           TextoOcor(IntStrZeros(CodVen,3),'#39'-'#39',ApeVen,'#39#39','#39#39','#39#39','#39 +
        #39') as Vendedor'
      'From PedR10'
      'Where SeqArq = :SeqArq'
      
        'Group by TextoOcor(IntStrZeros(CodVen,3),'#39'-'#39',ApeVen,'#39#39','#39#39','#39#39','#39#39')' +
        ' ')
    ...
    object PedResTOTPED: TFloatField
      ...
      FieldName = 'TOTPED'
      Origin = 'ISADE.PEDR10.TOTPED'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResQTDPED: TIntegerField
      DisplayLabel = 'Qtd Pedidos'
      FieldName = 'QTDPED'
      Origin = 'ISADE.PEDR10.QTDPED'
      DisplayFormat = '####0'
    end
    object PedResTOTFAT: TFloatField
      DisplayLabel = 'Total Faturado'
      FieldName = 'TOTFAT'
      Origin = 'ISADE.PEDR10.TOTFAT'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResTOTCAN: TFloatField
      DisplayLabel = 'Total Cancelado'
      FieldName = 'TOTCAN'
      Origin = 'ISADE.PEDR10.TOTCAN'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResTOTDEV: TFloatField
      DisplayLabel = 'Total Devolvido'
      FieldName = 'TOTDEV'
      Origin = 'ISADE.PEDR10.TOTDEV'
      DisplayFormat = '###,###,##0.00'
    end
    object PedResQTDCLI: TIntegerField
      DisplayLabel = 'Qtd. Clientes'
      FieldName = 'QTDCLI'
      Origin = 'ISADE.PEDR10.QTDCLI'
      DisplayFormat = '####0'
    end
    object PedResQTDATI: TIntegerField
      DisplayLabel = 'Ativos'
      FieldName = 'QTDATI'
      Origin = 'ISADE.PEDR10.QTDATI'
      DisplayFormat = '####0'
    end
    ...
    object PedResTOTCRE: TFloatField
      DisplayLabel = 'Total Comissão'
      FieldName = 'TOTCRE'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedResTOTDEB: TFloatField
      DisplayLabel = 'Total Debitos'
      FieldName = 'TOTDEB'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object PedResTOTCFA: TFloatField
      DisplayLabel = 'Total Cancelado'
      FieldName = 'TOTCFA'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    ...
    object PedResFATLIQ: TFloatField
      FieldName = 'FATLIQ'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
