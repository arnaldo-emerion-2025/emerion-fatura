inherited fmPedR14: TfmPedR14
  ...
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      'Select PedR14.*,'
        ...
        '           TextoOcor(IntStrZeros(CodVen,03),'#39' - '#39',ApeVen,'#39#39','#39#39','#39 +
        #39','#39#39') as Vendedor,'
      
        '           TextoOcor(IntStrZeros(CodCli,05),'#39' - '#39',ApeCli,'#39#39','#39#39','#39 +
        #39','#39#39') as Cliente'
      'From PedR14'
      'Where SeqArq = :SeqArq')
    ...
    object PedResNRONFS: TIntegerField
      FieldName = 'NRONFS'
    end
    object PedResNFSDEV: TIntegerField
      FieldName = 'NFSDEV'
    end
    object PedResDTEFAT: TDateTimeField
      FieldName = 'DTEFAT'
    end
    object PedResDTEDEV: TDateTimeField
      FieldName = 'DTEDEV'
    end
    ...
    object PedResOPELIB: TStringField
      FieldName = 'OPELIB'
      FixedChar = True
      Size = 45
    end
    ...
    object PedResNFSCLI: TStringField
      FieldName = 'NFSCLI'
      FixedChar = True
    end
  end
  ...
  object ppReport: TppReport
    ...
    Template.FileName = 'C:\_WGSYS\Emerion\Pedidos\DualComp\Relatorios\PedR14.rtm'
    Units = utMillimeters
    UserName = 'Report'
    DeviceType = 'Screen'
    Left = 304
    ...
    object ppHeaderBand: TppHeaderBand
      BeforePrint = ppHeaderBandBeforePrint
      ...
      object ppLabel20: TppLabel
        UserName = 'QrTitulo1'
        Caption = 'Comercial - Devoluções e Cancelamentos Realizados no Periodo'
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Name = 'Tahoma'
        Font.Size = 10
    ...
    object ppGroup1: TppGroup
      ...
      object ppGroupHeaderBand: TppGroupHeaderBand
        mmBottomOffset = 0
        mmHeight = 17992
        mmPrintPosition = 0
