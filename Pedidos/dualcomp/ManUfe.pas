...
begin
  ...
  if (EstSub.Params[0].AsString <> GerProCodGru.Value) or (EstSub.Params[1].AsString <> GerProCodClp.Value) then begin
...
begin
  ...
  if not nvUfe.Salvar then begin
     ...
     if GerUfeSigUfe.Value <> GerIcmSigUfe.Value then begin
