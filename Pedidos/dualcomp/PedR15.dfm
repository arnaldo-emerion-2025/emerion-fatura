inherited fmPedR15: TfmPedR15
  ...
  object grR15: TdxDBGrid
    ...
    object NUMRES: TdxDBGridMaskColumn
  ...
  object PedR15: TwwQuery
    ...
    SQL.Strings = (
      ...
      '            TotPer,'
        ...
        '            TextoOcor(IntStrZeros(CodCli,5),'#39'-'#39',ApeCli,'#39#39','#39#39','#39#39',' +
        #39#39') as Cliente,'
      
        '            TextoOcor(IntStrZeros(CodVen,3),'#39'-'#39',ApeVen,'#39#39','#39#39','#39#39',' +
        #39#39') as Vendedor'
      'From PedR15'
      'Where SeqArq = :SeqArq'
      'Order by NumRes'
    ...
    object PedR15CODEMP: TIntegerField
      FieldName = 'CODEMP'
    end
    object PedR15DTERES: TDateTimeField
      FieldName = 'DTERES'
    end
    object PedR15NUMRES: TIntegerField
      FieldName = 'NUMRES'
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Comercial - Analise de Pedidos Realizados no Periodo'#13#10#13#10
      BandColor = clWhite
