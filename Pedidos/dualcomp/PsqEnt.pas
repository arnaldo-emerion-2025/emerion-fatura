...
procedure TfmPsqEnt.FormShow(Sender: TObject);
begin
  inherited;
  
  FinTra.Close;
  FinTra.Params[0].AsInteger := fmPsqFat.FatPedTraSda.Value;
  FinTra.Open;

  ExpVei.Close;
  ExpVei.Params[0].AsInteger := fmPsqFat.FatPedCodVei.Value;
  ExpVei.Open;

  GerUsu.Close;
  GerUsu.Params[0].AsInteger := fmPsqFat.FatPedUsuAtu.Value;
  GerUsu.Open;
