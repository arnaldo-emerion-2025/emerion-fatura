...
type
  ...
  TfmPedR09 = class(TfmPadrao)
    ...
    grResQTDPRO: TdxDBGridColumn;
    grResSLDPRO: TdxDBGridColumn;
    Label20: TLabel;
    Label22: TLabel;
    Label14: TLabel;
    Label15: TLabel;
    ...
    PedResQTDPRO: TFloatField;
    PedResSLDPRO: TFloatField;
...
procedure TfmPedR09.Save(ADefaultExt, AFilter, AFileName: String; AMethod: TSaveMethod);
begin
...
procedure TfmPedR09.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.bPesquisaClick(Sender: TObject);
begin
  ...
  with quSQL,SQL do begin
       ...
       Close;
       Text := ' Delete From PedR08 Where PedR08.SeqArq = '+ QuotedStr(SeqArq);
       ExecSQL;
  ...
  with quSQL,SQL do begin
       ...
       Close;
       Text := ' Insert Into PedR08(SeqArq,CodEmp,CodClp,CodGru,CodSub,CodPro,QtdPed)'+
               ' Select '''+ SeqArq +''','+
               '        PedRes.CodEmp,'+
               '        PedRe2.CodClp,'+
               '        PedRe2.CodGru,'+
  ...
  with PedRes,SQL do begin
       ...
       Text := ' Select PedR08.*,'+
               '        EstPro.DscPro,'+
               '        PedR08.CodClp || _UNICODE_FSS '+ QuotedStr('-') +' || PedR08.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || PedR08.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || PedR08.CodPro as CodIte'+
               ' From PedR08,EstPro'+
               ' Where PedR08.CodClp = EstPro.CodClp'+
               '   and PedR08.CodGru = EstPro.CodGru'+
               '   and PedR08.CodSub = EstPro.CodSub'+
               '   and PedR08.CodPro = EstPro.CodPro'+
               '   and PedR08.SeqArq = '+ QuotedStr(SeqArq);
...
procedure TfmPedR09.FormShow(Sender: TObject);
begin
  inherited;
  EdCodEmp.SetFocus;
end;

procedure TfmPedR09.PaintBoxPaint(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.bImprimirClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.grResReloadGroupList(Sender: TObject);
begin
  inherited;
  (Sender as TdxDBGrid).FullExpand;
end;

procedure TfmPedR09.HTMLClick(Sender: TObject);
begin
  inherited;
  Save('htm', 'HTML File (*.htm; *.html)|*.htm', 'Relação de Itens Aguardando Separação de Estoque.htm', grRes.SaveToHTML);
end;

procedure TfmPedR09.ExcelClick(Sender: TObject);
begin
  inherited;
  Save('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', 'Relação de Itens Aguardando Separação de Estoque.xls', grRes.SaveToXLS);
end;

procedure TfmPedR09.XMLClick(Sender: TObject);
begin
  inherited;
  Save('xml', 'XML File (*.xml)|*.xml', 'Relação de Itens Aguardando Separação de Estoque.xml', grRes.SaveToXML);
end;

procedure TfmPedR09.BbPsqEmpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodEmpExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodEmpKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if not ( key in [ '0'..'9' ] ) then key := #0;
end;

procedure TfmPedR09.BbPsqClpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodClpExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.BbPsqGruClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodGruExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.BbPsqSubClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodSubExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.BbPsqProClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodProExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.BbPsqCliClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodCliExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.BbPsqVenClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodVenExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.bPsqCatClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodCatExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.bPsqTipClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodTipExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.bPsqMrcClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.EdCodMrcExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR09.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfmPedR09.FormDestroy(Sender: TObject);
begin
  inherited;
  fmPedR09 := nil;
end;

procedure TfmPedR09.Colunas1Click(Sender: TObject);
begin
  inherited;
  ...
  try
     ...
     fmManCol.Synchronize(fmPedR09.grRes);
