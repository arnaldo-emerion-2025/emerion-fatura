...
procedure TfmPedR08.Save(ADefaultExt, AFilter, AFileName: String; AMethod: TSaveMethod);
begin
...
procedure TfmPedR08.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.bPesquisaClick(Sender: TObject);
begin
  ...
  sFiltro := ' Where not PedRes.SitRes = '+ QuotedStr('Nao Concluido') +' and not PedRes.SitRes = '+ QuotedStr('Faturado') +' and not PedRes.SitRes = '+ QuotedStr('Faturado com Saldo nao Atendido');
  ...
  with quSQL,SQL do begin
       ...
       Close;
       Text := ' Delete From PedR08 Where SeqArq = '+ QuotedStr(SeqArq);
       ExecSQL;
  ...
  with quSQL,SQL do begin
       ...
       Text := ' Insert Into PedR08(SeqArq,CodEmp,CodClp,CodGru,CodSub,CodPro,QtdPed)'+
               ...
               '        PedRe2.CodSub,'+
               '        PedRe2.CodPro,'+
               '        Round(Sum(PedRe2.QtpRe2),4) as QtdPro'+
               ' From PedRe2 LEFT JOIN PedRes ON (PedRe2.CodEmp = PedRes.CodEmp)'+
               '                             AND (PedRe2.DteRes = PedRes.DteRes)'+
               '                             AND (PedRe2.NumRes = PedRes.NumRes)'+ sFiltro +
               ' Group by PedRe2.CodEmp,PedRe2.CodClp,PedRe2.CodGru,PedRe2.CodSub,PedRe2.CodPro';
       ExecSQL;
  ...
  with PedRes,SQL do begin
       ...
       Text := ' Select PedR08.*,'+
               ...
               ' Where PedR08.SeqArq = '+ QuotedStr(SeqArq);
...
procedure TfmPedR08.FormShow(Sender: TObject);
begin
  inherited;
  EdCodEmp.SetFocus;
end;

procedure TfmPedR08.PaintBoxPaint(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.bImprimirClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.grResReloadGroupList(Sender: TObject);
begin
  inherited;
  (Sender as TdxDBGrid).FullExpand;
end;

procedure TfmPedR08.HTMLClick(Sender: TObject);
begin
  inherited;
  Save('htm', 'HTML File (*.htm; *.html)|*.htm', 'Base para Compras.htm', grRes.SaveToHTML);
end;

procedure TfmPedR08.ExcelClick(Sender: TObject);
begin
  inherited;
  Save('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', 'Base para Compras.xls', grRes.SaveToXLS);
end;

procedure TfmPedR08.XMLClick(Sender: TObject);
begin
  inherited;
  Save('xml', 'XML File (*.xml)|*.xml', 'Base para Compras.xml', grRes.SaveToXML);
end;

procedure TfmPedR08.BbPsqEmpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodEmpExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodEmpKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if not ( key in [ '0'..'9' ] ) then key := #0;
end;

procedure TfmPedR08.BbPsqClpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodClpExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.BbPsqGruClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodGruExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.BbPsqSubClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodSubExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.BbPsqProClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodProExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.BbPsqCliClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodCliExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.BbPsqVenClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodVenExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.bPsqCatClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodCatExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.bPsqTipClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodTipExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.bPsqMrcClick(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.EdCodMrcExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPedR08.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfmPedR08.FormDestroy(Sender: TObject);
begin
  inherited;
  fmPedR08 := nil;
end;
