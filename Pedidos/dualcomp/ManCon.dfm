inherited fmManCon: TfmManCon
  ...
  object bVencimento: TSpeedButton
    ...
    Caption = 'F2-Vencimentos do Pedido'
    Flat = True
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -12
  ...
  object PedRes: TwwQuery
    ...
    SQL.Strings = (
      ...
      'Where PedRes.SitRes = '#39'Aguardando Consultas de Cadastro'#39
  ...
  object UpRes: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into PedRes'
      '(CODEMP, DTERES, NUMRES, CODVEN, CODCLI, CODPFA, TOTGER, SITRES)'
      'values'
      '(:CODEMP, :DTERES, :NUMRES, :CODVEN, :CODCLI, :CODPFA, :TOTGER, '
      ':SITRES)')
    DeleteSQL.Strings = (
      'delete from PedRes'
      'where'
