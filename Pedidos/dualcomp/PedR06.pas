...
begin
  ...
  if Trim( EdCodEmp.Text ) <> '' then sFiltro := sFiltro + ' and PedLb2.CodEit = '+ QuotedStr(EdCodEmp.Text);
  ...
  with quSQL,SQL do begin
       ...
       Text := ' Insert Into PedR06'+
               ...
               '        PedLb2.CodPro,'+
               '        PedLb2.CodTam,'+
               '        PedLb2.CodCor,'+ QuotedStr(' ') +','+
               '        Round(Sum(PedLb2.UltQts),4) as QtdPed,'+
               '        Round(Sum(PedLb2.TotLb2 - (PedLb2.TotDsr + PedLb2.TotIpc)),2) as TotLb2,'+
               '        Round(Sum(PedLb2.TotCst),4) as TotCst,'+ QuotedStr('0') +','+
               '        Count(*) as QtdReg'+
       ...
       if Trim( EdCodCat.Text ) <> '' then Text := Text + ' and PedLb2.CodCat = '+ QuotedStr(EdCodCat.Text);
       if Trim( EdCodTip.Text ) <> '' then Text := Text + ' and PedLb2.CodTip = '+ QuotedStr(EdCodTip.Text);
       if Trim( EdCodMrc.Text ) <> '' then Text := Text + ' and PedLb2.CodMrc = '+ QuotedStr(EdCodMrc.Text);
