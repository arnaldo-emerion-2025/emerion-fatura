inherited fmFatR15: TfmFatR15
  Left = 376
  Top = 51
  Caption = 'Relação de Notas Fiscais Emitidas (Global)'
  ClientHeight = 510
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object Label28: TLabel
    ...
    Width = 108
    Height = 13
    Caption = 'Emitidas no Periodo de'
  ...
  object grR16: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          item
            ColumnName = 'grR16TOTFAT'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR16TOTGER'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR16TOTICM'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR16TOTIPI'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR16TOTPIS'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grR16TOTCOF'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end>
    ...
    ShowRowFooter = True
    OnReloadGroupList = grR16ReloadGroupList
    object grR16NRONFS: TdxDBGridMaskColumn
      Caption = 'Nota Fiscal'
      Width = 90
      BandIndex = 0
      RowIndex = 0
    ...
    object grR16MODPFA: TdxDBGridColumn
      Caption = 'Tipo'
      Width = 127
      BandIndex = 0
      RowIndex = 0
    ...
    object grR16DTEFAT: TdxDBGridColumn
      Caption = 'Emissão'
      MinWidth = 10
      Width = 82
      BandIndex = 0
    ...
    object grR16DTENFE: TdxDBGridColumn
      Caption = 'Dte. Transmissao'
      BandIndex = 0
      RowIndex = 0
      FieldName = 'DTENFE'
    end
    object grR16APECLI: TdxDBGridMaskColumn
      Caption = 'Emitida Para'
      Width = 194
      BandIndex = 0
      RowIndex = 0
      FieldName = 'APECLI'
    end
    object grR16TOTFAT: TdxDBGridColumn
      Caption = 'Total Itens'
    ...
    object grR16TOTGER: TdxDBGridMaskColumn
    ...
    object grR16TOTICM: TdxDBGridMaskColumn
      Caption = 'Total ICMS'
      HeaderAlignment = taRightJustify
      Width = 96
      BandIndex = 0
    ...
    object grR16TOTIPI: TdxDBGridMaskColumn
      Caption = 'Total IPI'
      HeaderAlignment = taRightJustify
      Width = 89
      BandIndex = 0
    ...
    object grR16TOTPIS: TdxDBGridMaskColumn
      Caption = 'Total PIS'
      HeaderAlignment = taRightJustify
      Width = 87
      BandIndex = 0
    ...
    object grR16TOTCOF: TdxDBGridMaskColumn
  ...
  object EdPsqTipOpe: TdxColorPickEdit
    Left = 668
    Top = 12
    Width = 115
    Color = 16577773
  ...
  object ckCanceladas: TCheckBox
    ...
    ParentColor = False
    TabOrder = 12
    OnClick = ckCanceladasClick
  end
  object ckDataCan: TCheckBox
    Left = 192
    Top = 152
    Width = 185
    Height = 17
    Caption = 'Filtrar por data de Cancelamento'
    Enabled = False
    TabOrder = 11
    OnClick = ckDataCanClick
  end
  object EdPsqDteNf1: TdxColorDateEdit
    Left = 143
    Top = 128
    Width = 87
    Color = 16577773
  ...
  object EdPsqDteNf2: TdxColorDateEdit
    Left = 254
    Top = 128
    Width = 87
    Color = 16577773
  ...
  object FatR16: TwwQuery
    CachedUpdates = True
    DatabaseName = 'ISade'
    SQL.Strings = (
      'Select * From FatR16'
      'Where FatR16.SeqArq = :SeqArq'
      'Order by FatR16.NroNfs')
    ...
    object FatR16SEQARQ: TStringField
      FieldName = 'SEQARQ'
      FixedChar = True
      Size = 22
    end
    object FatR16NRONFS: TIntegerField
      Alignment = taLeftJustify
      FieldName = 'NRONFS'
    end
    object FatR16APECLI: TStringField
      FieldName = 'APECLI'
      FixedChar = True
      Size = 100
    end
    object FatR16TOTFAT: TFloatField
      FieldName = 'TOTFAT'
      DisplayFormat = '###,###,##0.00'
    end
    object FatR16TOTGER: TFloatField
      FieldName = 'TOTGER'
      DisplayFormat = '###,###,##0.00'
    end
    object FatR16TOTICM: TFloatField
      FieldName = 'TOTICM'
      DisplayFormat = '###,###,##0.00'
    end
    object FatR16TOTIPI: TFloatField
      FieldName = 'TOTIPI'
      DisplayFormat = '###,###,##0.00'
    end
    object FatR16TOTPIS: TFloatField
      FieldName = 'TOTPIS'
      DisplayFormat = '###,###,##0.00'
    end
    object FatR16TOTCOF: TFloatField
      FieldName = 'TOTCOF'
      DisplayFormat = '###,###,##0.00'
    end
    object FatR16MODPFA: TStringField
      FieldName = 'MODPFA'
      FixedChar = True
    end
    object FatR16DTEFAT: TDateTimeField
      FieldName = 'DTEFAT'
      EditMask = '!99/99/9999;1;_'
    end
    object FatR16CODUSU: TIntegerField
      FieldName = 'CODUSU'
    end
    object FatR16DTENFE: TDateTimeField
      DisplayLabel = 'Dte Transmissao'
      FieldName = 'DTENFE'
      Origin = 'ISADE.FATR16.DTENFE'
    end
  end
  object DsR16: TwwDataSource
    DataSet = FatR16
    Left = 30
    Top = 328
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Notas Fiscais Emitidas (Global)'#13#10#13#10
      BandColor = clWhite
