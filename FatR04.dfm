inherited fmFatR04: TfmFatR04
  Left = 0
  Caption = 'Resumo de Outros Tipos de Notas Emitidas (Sintetico)'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grGer: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          ...
          item
            ColumnName = 'grGerTOTPIS'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grGerTOTCOF'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end>
    ...
    object grGerDTEFAT: TdxDBGridColumn
      Caption = 'Emissão'
      MinWidth = 10
      Width = 80
      BandIndex = 0
    ...
    object grGerTOTFAT: TdxDBGridColumn
    ...
    object grGerTOTPIS: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 88
      BandIndex = 0
      RowIndex = 0
    ...
    object grGerTOTCOF: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 95
      BandIndex = 0
      RowIndex = 0
  ...
  object FatGer: TwwQuery
    ...
    SQL.Strings = (
        ...
        'Select NroNfs,ApeCli,CodVen,TotIt1 as TotFat,TotGe1 as TotGer,To' +
        'tIc1 as TotIcm,TotIp1 as TotIpi,TotPis,Totcof,DteGer as DteFat'
      'From FatGer INNER JOIN FinCli ON (FatGer.CodCli = FinCli.CodCli)'
      
        '                     LEFT JOIN EstPfa ON (FatGer.CodPfa = EstPfa' +
        '.CodPfa)'
    ...
    object FatGerTOTFAT: TFloatField
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Resumo de Outros Tipos de Notas Emitidas (Sintetico)'#13#10#13#10
      BandColor = clWhite
