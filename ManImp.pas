...
begin
  ...
  if fmManNot.FatPedSitFat.Value = 'Faturado' then
...
var
  ...
  NomCli, CgcCli, InsCli, TefCli, CefCli, EnfCli, NrfCli, BafCli, CifCli, UffCli, RffCli, RfCCli, GImpRef: string;
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        if fmManNot.FatPedSitFat.Value = 'Nao Concluido' then
        begin
        ...
        begin
          ...
          begin
            ...
            CgcCli := Trim(FieldbyName('CgcCli').AsString);
            InsCli := Trim(FieldbyName('InsCli').AsString);
            TefCli := Trim(FieldbyName('TefCli').AsString);
            TecCli := Trim(FieldbyName('TecCli').AsString);
            EnfCli := Trim(FieldbyName('EnfCli').AsString);
            RffCli := Trim(FieldbyName('RffCli').AsString);
            EncCli := Trim(FieldbyName('EncCli').AsString);
            RfcCli := Trim(FieldbyName('RfcCli').AsString);
            NrfCli := Trim(FieldbyName('NrfCli').AsString);
            NrcCli := Trim(FieldbyName('NrcCli').AsString);
            BafCli := Trim(FieldbyName('BafCli').AsString);
            BacCli := Trim(FieldbyName('BacCli').AsString);
            CifCli := Trim(FieldbyName('CifCli').AsString);
            CicCli := Trim(FieldbyName('CicCli').AsString);
            UffCli := Trim(FieldbyName('UffCli').AsString);
            UfcCli := Trim(FieldbyName('UfcCli').AsString);
            CefCli := Trim(FieldbyName('CefCli').AsString);
          ...
          begin
            ...
            begin
              ...
              if fmManNot.FatPedAtuEst.Value = 'Sim' then
                sText := sText + #10 + ' . Baixas nos Estoques dos Itens Faturados;       ';

              if fmManNot.FatPedIntFin.Value = 'Sim' then
            ...
            begin
              ...
              try
                ...
                if Trim(fmManNot.FatPedNomEnt.Value) <> '' then
                begin

                  EndEnt1 := Trim(fmManNot.FatPedNomEnt.Value);

                  EndEnt1 := EndEnt1 + ' C.N.P.J :' + copy(fmManNot.FatPedCgeCli.Value, 01, 2) + '.' + copy(fmManNot.FatPedCgeCli.Value, 3, 3) + '.' +
                    copy(fmManNot.FatPedCgeCli.Value, 06, 3) + '/' + copy(fmManNot.FatPedCgeCli.Value, 9, 4) + '-' +
                    copy(fmManNot.FatPedCgeCli.Value, 13, 2);

                  if Trim(fmManNot.FatPedTenCli.Value) <> '' then
                    EndEnt2 := Trim(fmManNot.FatPedTenCli.Value) + ' ' + Trim(fmManNot.FatPedEndCli.Value)
                  else
                    EndEnt2 := Trim(fmManNot.FatPedEndCli.Value);

                  if Trim(fmManNot.FatPedNumCli.Value) <> '' then
                    EndEnt2 := EndEnt2 + ', ' + Trim(fmManNot.FatPedNumCli.Value);

                  if Trim(fmManNot.FatPedRefCli.Value) <> '' then
                    EndEnt2 := EndEnt2 + ' ' + Trim(fmManNot.FatPedRefCli.Value);

                  if Trim(fmManNot.FatPedBaiCli.Value) <> '' then
                    EndEnt2 := EndEnt2 + ' ' + Trim(fmManNot.FatPedBaiCli.Value);

                  if Trim(fmManNot.FatPedCidCli.Value) <> '' then
                    EndEnt2 := EndEnt2 + ' - ' + Trim(fmManNot.FatPedCidCli.Value);

                  if Trim(fmManNot.FatPedUfeCli.Value) <> '' then
                    EndEnt2 := EndEnt2 + ' - ' + Trim(fmManNot.FatPedUfeCli.Value);

                  if Trim(fmManNot.FatPedCepCli.Value) <> '' then
                    EndEnt2 := EndEnt2 + ' Cep ' + copy(Trim(fmManNot.FatPedCepCli.Value), 1, 5) + '-' + copy(Trim(fmManNot.FatPedCepCli.Value), 6, 3);
                ...
                begin
                  ...
                  if Trim(fmManNot.FatPedTenCli.Value) <> '' then
                    EndEnt1 := Trim(fmManNot.FatPedTenCli.Value) + ' ' + Trim(fmManNot.FatPedEndCli.Value)
                  else
                    EndEnt1 := Trim(fmManNot.FatPedEndCli.Value);

                  if Trim(fmManNot.FatPedNumCli.Value) <> '' then
                    EndEnt1 := EndEnt1 + ', ' + Trim(fmManNot.FatPedNumCli.Value);

                  if Trim(fmManNot.FatPedRefCli.Value) <> '' then
                    EndEnt1 := EndEnt1 + ' ' + Trim(fmManNot.FatPedRefCli.Value);

                  if Trim(fmManNot.FatPedBaiCli.Value) <> '' then
                    EndEnt1 := EndEnt1 + ' ' + Trim(fmManNot.FatPedBaiCli.Value);

                  if Trim(fmManNot.FatPedCidCli.Value) <> '' then
                    EndEnt1 := EndEnt1 + ' - ' + Trim(fmManNot.FatPedCidCli.Value);

                  if Trim(fmManNot.FatPedUfeCli.Value) <> '' then
                    EndEnt1 := EndEnt1 + ' - ' + Trim(fmManNot.FatPedUfeCli.Value);

                  if Trim(fmManNot.FatPedCepCli.Value) <> '' then
                    EndEnt1 := EndEnt1 + ' Cep ' + copy(Trim(fmManNot.FatPedCepCli.Value), 1, 5) + '-' + copy(Trim(fmManNot.FatPedCepCli.Value), 6, 3);

                  EndEnt2 := 'C.N.P.J.:' + copy(fmManNot.FatPedCgeCli.Value, 01, 2) + '.' + copy(fmManNot.FatPedCgeCli.Value, 3, 3) + '.' +
                    copy(fmManNot.FatPedCgeCli.Value, 06, 3) + '/' + copy(fmManNot.FatPedCgeCli.Value, 9, 4) + '-' +
                    copy(fmManNot.FatPedCgeCli.Value, 13, 2);
                ...
                Nota01[004] := Trim(fmManNot.FatPedDesNat.Value); {NatOper}
                Nota02[004] := 'Comp12';
                ...
                Nota01[007] := Trim(fmManNot.FatPedInsSub.Value); {InscEstSubTrib}
                Nota02[007] := 'Comp12';
                ...
                begin
                  ...
                  Nota01[i] := fNumZeros(IntToStr(fmManNot.FatPedNroNfs.Value), 6) + '/' + FNumZeros(IntToStr(quSQL.FieldbyName('NroPe3').AsInteger), 3);
                    {Número}
                  Nota02[i] := 'Comp12';
                ...
                if fmManNot.FatPedTotIss.Value > 0 then
                  Nota01[185] := Prestring(FormatFloat('###,###,##0.00', fmManNot.FatPedTotIss.Value), 14)
                else
                  Nota01[185] := ' ';

                Nota02[185] := 'Comp12';

                if fmManNot.FatPedTotSer.Value > 0 then
                  Nota01[186] := Prestring(FormatFloat('###,###,##0.00', fmManNot.FatPedTotSer.Value), 14)
                else
                  Nota01[186] := ' ';
                ...
                Nota01[072] := Trim(fmManNot.FatPedTenTra.Value) + ' ' + Trim(fmManNot.FatPedEndTra.Value) + ', ' + Trim(fmManNot.FatPedNumTra.Value) + ' ' +
                  Trim(fmManNot.FatPedBaiTra.Value);
                Nota02[072] := 'Comp12';
                ...
                if (Trim(fmManNot.FatPedOb1Fat.Value) = '') and
                  (Trim(fmManNot.FatPedOb2Fat.Value) = '') and
                  (Trim(fmManNot.FatPedOb3Fat.Value) = '') and
                  (Trim(fmManNot.FatPedOb4Fat.Value) = '') and
                  (Trim(fmManNot.FatPedOb5Fat.Value) = '') and
                  (Trim(fmManNot.FatPedOb6Fat.Value) = '') and
                  (Trim(fmManNot.FatPedOb7Fat.Value) = '') and
                  (Trim(fmManNot.FatPedOb8Fat.Value) = '') then
                begin

                  Nota01[187] := copy(fmManNot.FatPedObsFat.Value, 001, 070); {Obs1}
                  Nota02[187] := 'Comp20';

                  Nota01[188] := copy(fmManNot.FatPedObsFat.Value, 071, 070); {Obs2}
                  Nota02[188] := 'Comp20';

                  Nota01[189] := copy(fmManNot.FatPedObsFat.Value, 141, 070); {Obs3}
                  Nota02[189] := 'Comp20';

                  Nota01[190] := copy(fmManNot.FatPedObsFat.Value, 211, 070); {Obs4}
                  Nota02[190] := 'Comp20';

                  Nota01[191] := copy(fmManNot.FatPedObsFat.Value, 281, 070); {Obs5}
                  Nota02[191] := 'Comp20';

                  Nota01[192] := copy(fmManNot.FatPedObsFat.Value, 351, 070); {Obs6}
                  Nota02[192] := 'Comp20';
                ...
                begin
                  ...
                  Nota01[187] := fmManNot.FatPedOb1Fat.Value; {Obs1}
                  Nota02[187] := 'Comp20';

                  Nota01[188] := fmManNot.FatPedOb2Fat.Value; {Obs2}
                  Nota02[188] := 'Comp20';

                  Nota01[189] := fmManNot.FatPedOb3Fat.Value; {Obs3}
                  Nota02[189] := 'Comp20';

                  Nota01[190] := fmManNot.FatPedOb4Fat.Value; {Obs4}
                  Nota02[190] := 'Comp20';

                  Nota01[191] := fmManNot.FatPedOb5Fat.Value; {Obs5}
                  Nota02[191] := 'Comp20';

                  Nota01[192] := fmManNot.FatPedOb6Fat.Value; {Obs6}
                  Nota02[192] := 'Comp20';

                  Nota01[193] := fmManNot.FatPedOb7Fat.Value; {Obs7}
                  Nota02[193] := 'Comp20';

                  Nota01[194] := fmManNot.FatPedOb8Fat.Value; {Obs8}
                  Nota02[194] := 'Comp20';
                ...
                while qtdnfis <= fmManNot.FatPedQtdNfs.Value do
                begin
                  ...
                  if qtdnfis = fmManNot.FatPedQtdNfs.Value then
                  begin
                    ...
                    Nota01[061] := Prestring(FormatFloat('###,###,##0.00', fmManNot.FatPedTotFat.Value), 14); {TotalProds}
                    Nota02[061] := 'Comp12';
                        ...
                        begin
                          ...
                          begin
                            ...
                            begin
                              ...
                              rdprint1.impf(Lin, Col, fNumZeros(IntToStr(fmManNot.FatPedNroNfs.Value), 6), [EXPANDIDO, negrito]);
                                            ...
                                            begin
                                              ...
                                              begin
                                                ...
                                                begin
                                                  ...
                                                  if (fmManNot.FatPedTotDsr.Value > 0) and (SeqNfs = QtiNfs) then
                                                  begin
                              ...
                              begin
                                ...
                                begin
                                  ...
                                  begin
                                    ...
                                    if (Reg = 67) and (qtdnfis < fmManNot.FatPedQtdNfs.Value) then
                                    begin
                                    ...
                                    begin
                                      ...
                                      if (Reg >= 68) and (Reg <= 81) and (qtdnfis < fmManNot.FatPedQtdNfs.Value) then
                                      begin
                                      ...
                                      begin
                                        ...
                                        if (reg >= 187) and (reg <= 194) and (qtdnfis < fmManNot.FatPedQtdNfs.Value) then
                                        begin
                ...
                begin
                  ...
                  fmManNot.FatPedFlgAtu.Value := 'F';

                  fmManNot.FatPedFlgImp.Value := 'Sim';

                  fmManNot.FatPedDATA_IMPRESSAO.AsDateTime := now();
