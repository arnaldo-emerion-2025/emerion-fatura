...
type
  ...
  public
    ...
    valFrt, valSeg, valOut, valDesc: boolean; //Vari�vei para Ratear
  ...
  begin
    ...
    begin
      ...
      SQLBUS.SQL.Text :=
        ' UPDATE FATPE2 '
        + ' SET '
        + ' OBSPE2 =  ' + QuotedStr(CDSPRODDESC2.AsString) + ',' + _BR //STICMS -- Mist�rio
...
//|||||||||||||||||||||||||||||||||||||||||||||||||||||//
//Rateia frete, seguro e outras despesas entre os �tens//
//|||||||||||||||||||||||||||||||||||||||||||||||||||||//
...
begin
  ...
  begin
    ...
    begin
      ...
      begin
        ///////////////////////////////////////////////////////////////////////////
        // o �ltimo �tem ficar� como restante do frete, seguro e outras despesas //
        // Esse procedimento � feito devido ao arredondamento do frete por �tem  //
        //que � s� com duas casas decimais                                       //
        ///////////////////////////////////////////////////////////////////////////
        if (valfrt) then
...
begin
  ...
  begin
    ShowMessage(CDSPRODCODCLP.AsString + '.' + CDSPRODCODGRU.AsString + '.' + CDSPRODCODSUB.AsString + '.' + CDSPRODCODPRO.AsString + ' - Origem : ' +
      QuotedStr(CDSPRODORIG.AsString) + ' - Obrigat�rio informar origem do produto.');
    abort;
  end;
