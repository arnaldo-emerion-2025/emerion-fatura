inherited fmFatR02: TfmFatR02
  Left = 259
  Top = 147
  Caption = 'Resumo de Notas de Saidas - Sintetico'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object Label8: TLabel
    ...
    Width = 124
    Height = 13
    Caption = 'Devolvidas no Periodo de '
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -11
    Font.Name = 'Tahoma'
  ...
  object grFat: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          ...
          item
            ColumnName = 'grFatTOTPIS'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grFatTOTCOF'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grFatTOTFRT'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end>
    ...
    object grFatHREFAT: TdxDBGridColumn
      Caption = 'Horario'
      Width = 71
      BandIndex = 0
      RowIndex = 0
    ...
    object grFatAPETRA: TdxDBGridColumn
    ...
    object grFatTOTFAT: TdxDBGridColumn
    ...
    object grFatTOTPIS: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 86
      BandIndex = 0
      RowIndex = 0
    ...
    object grFatTOTCOF: TdxDBGridMaskColumn
      HeaderAlignment = taRightJustify
      Width = 100
      BandIndex = 0
      RowIndex = 0
    ...
    object grFatTOTFRT: TdxDBGridColumn
    ...
    object grFatSITFAT: TdxDBGridColumn
      Caption = 'Situação'
      HeaderAlignment = taRightJustify
      Width = 140
      BandIndex = 0
    ...
    object grFatColumn16: TdxDBGridColumn
      Caption = 'Tot. Subst.'
      Width = 84
      BandIndex = 0
      RowIndex = 0
  ...
  object FatPed: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           FatPed.TotSub, '
        ...
        '           (Select FinTra.ApeTra From FinTra Where FinTra.CodTra' +
        ' = FatPed.TraSda) as ApeTra'
      'From FatPed,FinCli'
      'Where FatPed.CodCli = FinCli.CodCli'
      '     and FatPed.DteFat = :DteFat'
      '     and FatPed.ModPfa = '#39'Vendas'#39
    ...
    object FatPedTOTFAT: TFloatField
      DisplayLabel = 'Tota Itens S/IPI'
      FieldName = 'TOTFAT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object FatPedTOTGER: TFloatField
      DisplayLabel = 'Tota Itens C/IPI'
      FieldName = 'TOTGER'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    ...
    object FatPedAPETRA: TStringField
      FieldName = 'APETRA'
      FixedChar = True
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = 'Resumo de Notas de Saidas - Sintetico'#13#10#13#10
      BandColor = clWhite
