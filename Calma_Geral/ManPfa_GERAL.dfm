inherited fmManPfa_GERAL: TfmManPfa_GERAL
  Left = 423
  Top = 82
  ...
  object Label19: TLabel
    ...
    Width = 124
    Height = 13
    Caption = 'Situação tributária do IPI:'
    Color = clBtnFace
  ...
  object pcPfa: TPageControl
    ...
    object pcPag1: TTabSheet
      ...
      object Panel1: TPanel
        ...
        object grPfa: ThGrid
          ...
          Selected.Strings = (
            ...
            'ALIQPIS'#9'10'#9'ALIQPIS'
            'ALIQCOF'#9'10'#9'ALIQCOF'
            'CSTPIS'#9'2'#9'CSTPIS'
            'CSTCOF'#9'2'#9'CSTCOF'
            'SOMAR_FRETE_NA_BASE_COFINS'#9'10'#9'SOMAR_FRETE_NA_BASE_COFINS'
            'SOMAR_FRETE_NA_BASE_PIS'#9'10'#9'SOMAR_FRETE_NA_BASE_PIS')
      ...
      object edTipClass: TdxColorPickEdit
        Left = 133
        Top = 89
        Width = 172
        Color = 16577773
    ...
    object pcPag2: TTabSheet
      ...
      object GroupBox1: TGroupBox
        ...
        object Label17: TLabel
          ...
          Width = 121
          Height = 13
          Caption = 'Tributar PIS por produto:'
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'Tahoma'
        ...
        object edCSTPIS: TdxDBColorEdit
          Left = 161
          Top = 40
          Width = 50
          Color = 16577773
        ...
        object edAliquotaPis: TdxDBColorCurrencyEdit
          Left = 315
          Top = 16
          Width = 68
          Hint = 'Quantidade Pedida para o Item'
        ...
        object DBCheckBox1: TDBCheckBox
          ...
          Height = 17
          TabStop = False
          Caption = 'Somar Frete na Base de Calculo'
          DataField = 'SOMAR_FRETE_NA_BASE_PIS'
          DataSource = DsPfa
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -11
      ...
      object GroupBox4: TGroupBox
        ...
        object Label18: TLabel
          ...
          Width = 143
          Height = 13
          Caption = 'Tributar COFINS por produto:'
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -11
          Font.Name = 'Tahoma'
        ...
        object edCSTCOF: TdxDBColorEdit
          Left = 161
          Top = 38
          Width = 50
          Color = 16577773
        ...
        object edAliquotaCof: TdxDBColorCurrencyEdit
          Left = 315
          Top = 14
          Width = 68
          Hint = 'Quantidade Pedida para o Item'
        ...
        object DBCheckBox2: TDBCheckBox
          ...
          TabStop = False
          Caption = 'Somar Frete na Base de Calculo'
          DataField = 'SOMAR_FRETE_NA_BASE_COFINS'
          DataSource = DsPfa
          Font.Charset = ANSI_CHARSET
          Font.Color = clBlack
          Font.Height = -11
  ...
  object nvPfa: ThDBNavigator
    ...
    DataSource = DsPfa
    BaseAtualizar = 'TxfIpiTxfIcmEstIcmEstIpiEstSip'
    UsaAppend = True
    Salvar = False
  end
  object EdId_EstSip: TdxDBColorEdit
    Left = 161
    Top = 773
    Width = 78
    Color = 16577773
  ...
  object CbNomSip: TdxDBColorLookupEdit
    Left = 312
    Top = 773
    Width = 424
    Color = 16577773
  ...
  object EstPfa: TwwQuery
    Active = True
    CachedUpdates = True
    AfterOpen = EstPfaAfterOpen
    AfterScroll = EstPfaAfterScroll
    OnNewRecord = EstPfaNewRecord
    DatabaseName = 'ISade'
    SessionName = 'Default'
    SQL.Strings = (
      'Select * From EstPfa '
      '   WHERE CODPFA = '#39'5.102'#39
      'Order by CodPfa')
    UpdateObject = UpPfa
    ControlType.Strings = (
    ...
    object EstPfaALIQPIS: TFloatField
      DisplayWidth = 10
      FieldName = 'ALIQPIS'
      Origin = 'ISADE.ESTPFA.ALIQPIS'
    end
    object EstPfaALIQCOF: TFloatField
      DisplayWidth = 10
      FieldName = 'ALIQCOF'
      Origin = 'ISADE.ESTPFA.ALIQCOF'
    end
    object EstPfaCSTPIS: TStringField
      DisplayWidth = 2
      FieldName = 'CSTPIS'
      Origin = 'ISADE.ESTPFA.CSTPIS'
      FixedChar = True
      Size = 2
    end
    object EstPfaCSTCOF: TStringField
      DisplayWidth = 2
      FieldName = 'CSTCOF'
      Origin = 'ISADE.ESTPFA.CSTCOF'
      FixedChar = True
      Size = 2
    end
    ...
    object EstPfaID_ESTSIP: TIntegerField
      DisplayWidth = 10
      FieldName = 'ID_ESTSIP'
      Origin = 'ISADE.ESTPFA.ID_ESTSIP'
      Visible = False
    end
    ...
    object EstPfasignfePis: TStringField
      FieldKind = fkLookup
      FieldName = 'signfePis'
      LookupDataSet = EstPis
      LookupKeyFields = 'ID_ESTPIS'
      LookupResultField = 'SIGNFE'
      KeyFields = 'ID_ESTPIS'
      Visible = False
      Size = 2
      Lookup = True
    end
    object EstPfasignfeCof: TStringField
      FieldKind = fkLookup
      FieldName = 'signfeCof'
    ...
    object EstPfasignfeSip: TStringField
      FieldKind = fkLookup
      FieldName = 'signfeSip'
      LookupDataSet = EstSip
      LookupKeyFields = 'ID_ESTSIP'
      LookupResultField = 'SIGNFE'
      KeyFields = 'ID_ESTSIP'
      Visible = False
      Size = 2
    ...
    object EstPfaCONSUMST: TFloatField
      FieldName = 'CONSUMST'
      Origin = 'ISADE.ESTPFA.CONSUMST'
      Visible = False
    end
    object EstPfaDSCICM: TFloatField
      FieldName = 'DSCICM'
      Origin = 'ISADE.ESTPFA.DSCICM'
      Visible = False
    end
    object EstPfaDSCIPI: TFloatField
      FieldName = 'DSCIPI'
      Origin = 'ISADE.ESTPFA.DSCIPI'
      Visible = False
    end
    object EstPfaFRTSUB: TFloatField
      FieldName = 'FRTSUB'
      Origin = 'ISADE.ESTPFA.FRTSUB'
      Visible = False
    end
    object EstPfaSEGSUB: TFloatField
      FieldName = 'SEGSUB'
      Origin = 'ISADE.ESTPFA.SEGSUB'
      Visible = False
    end
    object EstPfaDESSUB: TFloatField
      FieldName = 'DESSUB'
      Origin = 'ISADE.ESTPFA.DESSUB'
      Visible = False
    end
    object EstPfaDSCSUB: TFloatField
      FieldName = 'DSCSUB'
      Origin = 'ISADE.ESTPFA.DSCSUB'
      Visible = False
    end
    object EstPfaID_ESTICM: TIntegerField
      FieldName = 'ID_ESTICM'
      Origin = 'ISADE.ESTPFA.ID_ESTICM'
      Visible = False
    end
    object EstPfaID_ESTIPI: TIntegerField
      FieldName = 'ID_ESTIPI'
      Origin = 'ISADE.ESTPFA.ID_ESTIPI'
      Visible = False
    end
    object EstPfaFRTPIS: TFloatField
      FieldName = 'FRTPIS'
      Origin = 'ISADE.ESTPFA.FRTPIS'
      Visible = False
    end
    object EstPfaSEGPIS: TFloatField
      FieldName = 'SEGPIS'
      Origin = 'ISADE.ESTPFA.SEGPIS'
      Visible = False
    end
    object EstPfaDESPIS: TFloatField
      FieldName = 'DESPIS'
      Origin = 'ISADE.ESTPFA.DESPIS'
      Visible = False
    end
    object EstPfaDSCPIS: TFloatField
      FieldName = 'DSCPIS'
      Origin = 'ISADE.ESTPFA.DSCPIS'
      Visible = False
    end
    object EstPfaCONSUMPIS: TFloatField
      FieldName = 'CONSUMPIS'
      Origin = 'ISADE.ESTPFA.CONSUMPIS'
      Visible = False
    end
    object EstPfaFRTCOF: TFloatField
      FieldName = 'FRTCOF'
      Origin = 'ISADE.ESTPFA.FRTCOF'
      Visible = False
    end
    object EstPfaSEGCOF: TFloatField
      FieldName = 'SEGCOF'
      Origin = 'ISADE.ESTPFA.SEGCOF'
      Visible = False
    end
    object EstPfaDESCOF: TFloatField
      FieldName = 'DESCOF'
      Origin = 'ISADE.ESTPFA.DESCOF'
      Visible = False
    end
    object EstPfaDSCCOF: TFloatField
      FieldName = 'DSCCOF'
      Origin = 'ISADE.ESTPFA.DSCCOF'
      Visible = False
    end
    object EstPfaCONSUMCOF: TFloatField
      FieldName = 'CONSUMCOF'
      Origin = 'ISADE.ESTPFA.CONSUMCOF'
      Visible = False
    end
    object EstPfaFLGATIVO: TSmallintField
      FieldName = 'FLGATIVO'
      Origin = 'ISADE.ESTPFA.FLGATIVO'
      Visible = False
    end
    object EstPfaSOMAR_FRETE_NA_BASE_COFINS: TSmallintField
      FieldName = 'SOMAR_FRETE_NA_BASE_COFINS'
      Origin = 'ISADE.ESTPFA.SOMAR_FRETE_NA_BASE_COFINS'
    end
    object EstPfaSOMAR_FRETE_NA_BASE_PIS: TSmallintField
      FieldName = 'SOMAR_FRETE_NA_BASE_PIS'
      Origin = 'ISADE.ESTPFA.SOMAR_FRETE_NA_BASE_PIS'
    end
  end
  ...
  object UpPfa: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  CONSUMCOF = :CONSUMCOF,'
      '  FLGATIVO = :FLGATIVO,'
      '  somar_frete_na_base_pis = :somar_frete_na_base_pis,'
      '  somar_frete_na_base_cofins = :somar_frete_na_base_cofins'
      'where'
    ...
    InsertSQL.Strings = (
      'insert into EstPfa'
        ...
        '   ID_ESTSIP, ALIQPIS, ALIQCOF, CSTPIS, CSTCOF, DSCICM, DSCIPI, ' +
        'FRTSUB, '
      
        '   SEGSUB, DESSUB, DSCSUB, CONSUMST, ID_ESTICM, ID_ESTIPI, FRTPI' +
        'S, SEGPIS, '
      
        '   DESPIS, DSCPIS, CONSUMPIS, FRTCOF, SEGCOF, DESCOF, DSCCOF, CO' +
        'NSUMCOF, '
      '   FLGATIVO,somar_frete_na_base_pis, somar_frete_na_base_cofins)'
      'values'
        ...
        '   :TRBCOF, :ID_ESTPIS, :ID_ESTCOF, :ID_ESTSIP, :ALIQPIS, :ALIQC' +
        'OF, :CSTPIS, '
      
        '   :CSTCOF, :DSCICM, :DSCIPI, :FRTSUB, :SEGSUB, :DESSUB, :DSCSUB' +
        ', :CONSUMST, '
      
        '   :ID_ESTICM, :ID_ESTIPI, :FRTPIS, :SEGPIS, :DESPIS, :DSCPIS, :' +
        'CONSUMPIS, '
      
        '   :FRTCOF, :SEGCOF, :DESCOF, :DSCCOF, :CONSUMCOF, :FLGATIVO, :s' +
        'omar_frete_na_base_pis,'
      '   :somar_frete_na_base_cofins)'
      ' ')
    DeleteSQL.Strings = (
      'delete from EstPfa'
      'where'
  ...
  object TxfIpi: TwwQuery
    ...
    object TxfIpiDSCTXF: TMemoField
      FieldName = 'DSCTXF'
  ...
  object TxfIcm: TwwQuery
    ...
    object TxfIcmDSCTXF: TMemoField
      FieldName = 'DSCTXF'
      Origin = 'ISADE.ESTTXF.DSCTXF'
      BlobType = ftMemo
      Size = 300
  ...
  object EstSip: TwwQuery
    ...
    SQL.Strings = (
      'Select * From EstSip'
      'Where EstSip.TipSip = :TipSip'
      'Order by EstSip.Id_EstSip')
    ControlType.Strings = (
      'INTFIN;CheckBox;Sim;Nao'
      'GERLIV;CheckBox;Sim;Nao'
    ...
    object EstSipID_ESTSIP: TIntegerField
      FieldName = 'ID_ESTSIP'
      Origin = 'ISADE.ESTSIP.ID_ESTSIP'
    end
    ...
    object EstSipTIPSIP: TStringField
      FieldName = 'TIPSIP'
      Origin = 'ISADE.ESTSIP.TIPSIP'
      Size = 8
    end
