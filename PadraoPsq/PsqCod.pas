...
procedure TfmPsqCod.EdCodGruExit(Sender: TObject);
begin
...
procedure TfmPsqCod.EdCodGruKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfmPsqCod.EdCodSubKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if key = 112 then begin {F1 - Iniciais}
...
procedure TfmPsqCod.EdCodSubExit(Sender: TObject);
begin
...
procedure TfmPsqCod.EdCodProExit(Sender: TObject);
begin
...
procedure TfmPsqCod.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 27 then Close;
end;

procedure TfmPsqCod.EdCodProKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  if key = 112 then begin {f1 - Iniciais}
...
procedure TfmPsqCod.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TfmPsqCod.PaintBoxPaint(Sender: TObject);
begin
  with Sender as TPaintBox do FillGrayGradientRect(PaintBox.Canvas, PaintBox.ClientRect, PaintBox.Color);
end;

procedure TfmPsqCod.EdCodGruKeyPress(Sender: TObject; var Key: Char);
begin
  if not ( key in [ '0'..'9' ] ) and not ( key = ',' ) then key := #0;
end;

procedure TfmPsqCod.bPsqCatClick(Sender: TObject);
begin
...
procedure TfmPsqCod.bPsqTipClick(Sender: TObject);
begin
...
procedure TfmPsqCod.bPsqMrcClick(Sender: TObject);
begin
...
procedure TfmPsqCod.bPsqGruClick(Sender: TObject);
begin
...
procedure TfmPsqCod.bPsqSubClick(Sender: TObject);
begin
...
procedure TfmPsqCod.bPsqProClick(Sender: TObject);
begin
...
procedure TfmPsqCod.EdCodCatKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then begin {F1 - Iniciais}
...
procedure TfmPsqCod.EdCodTipKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then begin {F1 - Iniciais}
...
procedure TfmPsqCod.EdCodMrcKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then begin {F1 - Iniciais}
...
procedure TfmPsqCod.EdCodCatExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPsqCod.EdCodTipExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPsqCod.EdCodMrcExit(Sender: TObject);
begin
  inherited;
...
procedure TfmPsqCod.EdCodProKeyPress(Sender: TObject; var Key: Char);
begin
