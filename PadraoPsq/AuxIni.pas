...
type
  ...
  public
    ...
    Id_FinCt5 : integer;
    Id_FinCt6 : integer;
    TestaSimilar,CodMaq,NomMaq,TipIcm,NomDes,NomTla,NomUfe,NomCie : string;
    ...
    ApeCon,NomCon,CgcCon,CodUnd,NomUnd,CodIcm,NomTen,TipTla,NomHol : string;
    NomPfa,NomTra,UfeTra,NomAtd,FlgPesq,AtuEst,NomTer,TipIpi,CodIpi : string;
    CodAgb,NomAgb,CodCnb,TipoPesq,TipPfa,ModPfa,LocPfa,NomIcm,NomIpi : string;
    ...
    ExibeTodas,NomCli,UffCli,NomVen,NomFor,CodClp,CodGru,CodSub,CodPro,NomPai : string;
    LogUsu,IntFin,CodAnt,CodStr,TipStr,NomStr,NomOpe,NomImp,NomPor,NomAge,TipAge,NomBan,NomCnb : string;
  end;
...
uses dxDemoUtils, BbMensag, PsqCli, PsqVen, PsqPro, PsqRef, PsqGru, PsqSub,
     PsqBan, PsqAgb, PsqCnb, PsqFor, PsqPfa, PsqTra, PsqAtd, PsqCpr, PsqTip,
     PsqClp, PsqMrc, PsqPrc, PsqPar, PsqUsu, PsqRep, PsqPcp, PsqAt2, PsqUnd,
     PsqIcms, PsqIpi, PsqCAn, PsqStr, PsqTer, PsqMaq, PsqOpt, PsqCon, PsqVei,
     PsqMot, PsqImp, PsqPor, PsqAge, PsqTen, PsqDes, PsqUfe, PsqPo1, PsqPlc,
     PsqSpl, PsqTla, PsqCie, PsqPai, PsqCtb, PsqCt2, PsqCt3, PsqCt4, PsqCt5,
     PsqCt6;

{$R *.DFM}

procedure TfmAuxIni.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  ...
  if key = 13 then begin
     ...
     if UpperCase(TipoPesq) = 'CATEGORIA' then begin {Categoria de Produtos}
        ...
        try
           ...
           fmPsqCpr := TfmPsqCpr.Create(Self);

           with fmPsqCpr.EstCat,SQL do begin
           ...
           if fmPsqCpr.CodCat > 0 then begin

              CodCat := fmPsqCpr.CodCat;
              NomCat := fmPsqCpr.NomCat;
     ...
     if UpperCase(TipoPesq) = 'UNIDADE' then begin

        try

           fmPsqUnd := TfmPsqUnd.Create(Self);

           with fmPsqUnd.EstUnd,SQL do begin

                Close;
                Text := ' Select * From EstUnd';

                if Trim( EdPsqTexto.Text ) <> '' then begin

                   if pos('#',EdPsqTexto.Text) > 0 then begin

                      Text := Text + ' Where EstUnd.NomUnd LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + '   and EstUnd.NomUnd LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' Where EstUnd.NomUnd LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                end;

                Text := Text + ' Order by EstUnd.NomUnd';
           ...
           if Trim( fmPsqUnd.CodUnd ) <> '' then begin
              ...
              CodUnd := fmPsqUnd.CodUnd;
              NomUnd := fmPsqUnd.NomUnd;
     ...
     if UpperCase(TipoPesq) = 'ICMS' then begin

        try

           fmPsqIcms := TfmPsqIcms.Create(Self);

           with fmPsqIcms.EstIcm,SQL do begin

                Close;
                Text := ' Select EstIcm.NomIcm,'+
                        '        EstIcm.CodIcm,'+
                        '        EstIcm.TipIcm,'+
                        '        EstIcm.PerIcm From EstIcm';

                Text := Text + ' Where EstIcm.TipIcm = '+ QuotedStr(TipIcm);

                if Trim( EdPsqTexto.Text ) <> '' then begin

                   if pos('#',EdPsqTexto.Text) > 0 then begin

                      Text := Text + ' and EstIcm.NomIcm LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + ' and EstIcm.NomIcm LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' and EstIcm.NomIcm LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                end;

                Text := Text + ' Order by EstIcm.NomIcm';
           ...
           if Trim( fmPsqIcms.CodIcm ) <> '' then begin

              CodIcm := fmPsqIcms.CodIcm;
              NomIcm := fmPsqIcms.NomIcm;
              PerIcm := fmPsqIcms.PerIcm;

           end;

        finally

           FreeAndNil(fmPsqIcms);

        end;

        if Trim( CodIcm ) <> '' then Close;

     end;

     if UpperCase(TipoPesq) = 'IPI' then begin

        try

           fmPsqIpi := TfmPsqIpi.Create(Self);

           with fmPsqIpi.EstIpi,SQL do begin

                Close;
                Text := ' Select EstIpi.NomIpi,'+
                        '        EstIpi.CodIpi,'+
                        '        EstIpi.TipIpi,'+
                        '        EstIpi.PerIpi,'+
                        '        EstIpi.ClsIpi From EstIpi';

                Text := Text + ' Where EstIpi.TipIpi = '+ QuotedStr(TipIpi);

                if Trim( EdPsqTexto.Text ) <> '' then begin

                   if pos('#',EdPsqTexto.Text) > 0 then begin

                      Text := Text + ' and EstIpi.NomIpi LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + ' and EstIpi.NomIpi LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' and EstIpi.NomIpi LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                end;

                Text := Text + ' Order by EstIpi.ClsIpi';
           ...
           if Trim( fmPsqIpi.CodIpi ) <> '' then begin
              ...
              CodIpi := fmPsqIpi.CodIpi;
              NomIpi := fmPsqIpi.NomIpi;
              PerIpi := fmPsqIpi.PerIpi;
     ...
     if UpperCase(TipoPesq) = 'TIPO2' then begin {Tipos de Produtos}
           ...
           with fmPsqTip.EstTip,SQL do begin
                ...
                if Trim( EdPsqTexto.Text ) <> '' then begin
                   ...
                   if pos('#',EdPsqTexto.Text) > 0 then begin
                      ...
                      Text := Text + ' Where EstTip.NomTip LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + '   and EstTip.NomTip LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' Where EstTip.NomTip LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                end;

                Text := Text + ' Order by EstTip.NomTip';
     ...
     if UpperCase(TipoPesq) = 'MARCA2' then begin {Marcas de Produtos}
           ...
           with fmPsqMrc.EstMrc,SQL do begin
                ...
                if Trim( EdPsqTexto.Text ) <> '' then begin
                   ...
                   if pos('#',EdPsqTexto.Text) > 0 then begin
                      ...
                      Text := Text + ' Where NomMrc LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + '   and NomMrc LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' Where NomMrc LIKE '+ QuotedStr(EdPsqTexto.Text +'%');
     ...
     if UpperCase(TipoPesq) = 'CLS' then begin {Classificação}
        ...
        try
           ...
           with fmPsqClp.EstClp,SQL do begin
                ...
                Text := Text + ' Where Exists(Select * From EstPro Where EstPro.CodClp = EstClp.CodClp';
                ...
                if Trim( EdPsqTexto.Text ) <> '' then begin
                   ...
                   if pos('#',EdPsqTexto.Text) > 0 then begin
                      ...
                      Text := Text + ' and NomClp LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + ' and NomClp LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' and NomClp LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                end;

                Text := Text + ' Order by NomClp';
           ...
           if Trim( fmPsqClp.CodClp ) <> '' then begin
              ...
              CodClp := fmPsqClp.CodClp;
              NomClp := fmPsqClp.NomClp;
        ...
        if Trim( CodClp ) <> '' then Close;

     end;

     if UpperCase(TipoPesq) = 'CLASSIFICACAO' then begin {Classificação}
           ...
           with fmPsqClp.EstClp,SQL do begin
                ...
                if Trim( EdPsqTexto.Text ) <> '' then begin
                   ...
                   if pos('#',EdPsqTexto.Text) > 0 then begin
                      ...
                      Text := Text + ' Where EstClp.NomClp LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + '   and EstClp.NomClp LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' Where EstClp.NomClp LIKE '+ QuotedStr(EdPsqTexto.Text +'%');
           ...
           with fmPsqVen.FinVen,SQL do begin
                ...
                if Trim( EdPsqTexto.Text ) <> '' then begin
                   ...
                   if pos('#',EdPsqTexto.Text) > 0 then begin
                      ...
                      Text := Text + ' and FinVen.NomVen LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + ' and FinVen.NomVen LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' and FinVen.NomVen LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                end;

                if sCodCve > 0 then Text := Text + ' and FinVen.CodCve = '+ QuotedStr(IntToStr(sCodCve));

                Text := Text + ' Order by FinVen.NomVen';
     ...
     if UpperCase(TipoPesq) = 'LB' then begin {Lançamentos bancarios}
        ...
        try
           ...
           with fmPsqRep.FinRep,SQL do begin
                ...
                if pos('#',EdPsqTexto.Text) > 0 then begin
                   ...
                   Text := Text + ' and FinRep.NomRep LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                   Text := Text + ' and FinRep.NomRep LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                   end
                else
                   Text := Text + ' and FinRep.NomRep LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                Text := Text + ' Order by FinRep.NomRep';
     ...
     if UpperCase(TipoPesq) = 'I' then begin {Itens}
        ...
        try
           ...
           with fmPsqPro.EstPro,SQL do begin
                ...
                if TestaSimilar = 'S' then Text := Text + ' and SimPro is not Null';
           ...
           if Trim( fmPsqPro.CodPro ) <> '' then begin
     ...
     if UpperCase(TipoPesq) = 'IC' then begin {Itens}
        ...
        try
           ...
           if Trim( fmPsqPrc.CodPro ) <> '' then begin
     ...
     if UpperCase(TipoPesq) = 'R' then begin {Referência}
        ...
        try
           ...
           if Trim( fmPsqRef.CodPro ) <> '' then begin
     ...
     if UpperCase(TipoPesq) = 'G' then begin {Grupos}
        ...
        try
           ...
           with fmPsqGru.EstGru,SQL do begin
                ...
                Text := Text + ' Where Exists(Select * From EstPro Where EstPro.CodGru = EstGru.CodGru';
           ...
           if Trim( fmPsqGru.CodGru ) <> '' then begin
              ...
              CodGru := fmPsqGru.CodGru;
              NomGru := fmPsqGru.NomGru;
     ...
     if UpperCase(TipoPesq) = 'UF' then begin {Uf's}

        try

           fmPsqUfe := TfmPsqUfe.Create(Self);

           with fmPsqUfe.GerUfe,SQL do begin

                Close;
                Text := ' Select * From GerUfe';

                if Trim( EdPsqTexto.Text ) <> '' then begin

                   if pos('#',EdPsqTexto.Text) > 0 then begin

                      Text := Text + ' and GerUfe.NomUfe LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + ' and GerUfe.NomUfe LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' and GerUfe.NomUfe LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                end;

                Text := Text + ' Order by GerUfe.NomUfe ';
           ...
           if Trim( fmPsqUfe.SigUfe ) <> '' then begin
              ...
              SigUfe := fmPsqUfe.SigUfe;
              NomUfe := fmPsqUfe.NomUfe;
           ...
           with fmPsqGru.EstGru,SQL do begin
                ...
                if Trim( EdPsqTexto.Text ) <> '' then begin
                   ...
                   if pos('#',EdPsqTexto.Text) > 0 then begin
                      ...
                      Text := Text + ' Where EstGru.NomGru LIKE '+ QuotedStr(EdPsqTexto.Text +'%');
     ...
     if UpperCase(TipoPesq) = 'S' then begin {Sub-Grupos}
        ...
        try
           ...
           with fmPsqSub.EstSub,SQL do begin
                ...
                Text := Text + ' Where Exists(Select * From EstPro Where EstPro.CodGru = EstSub.CodGru and EstPro.CodSub = EstSub.CodSub';
           ...
           if Trim( fmPsqSub.CodSub ) <> '' then begin
              ...
              CodGru := fmPsqSub.CodGru;
              NomGru := fmPsqSub.NomGru;
              CodSub := fmPsqSub.CodSub;
              NomSub := fmPsqSub.NomSub;
        ...
        try
           ...
           with fmPsqAgb.FinAgb,SQL do begin
                ...
                if CodBan > 0 then begin
                   ...
                   if pos('Where',Text) > 0 then
                      Text := Text + '   and CodBan = '+ QuotedStr(IntToStr(CodBan))
                   else
                      Text := Text + ' Where CodBan = '+ QuotedStr(IntToStr(CodBan));
                ...
                if Trim( EdPsqTexto.Text ) <> '' then begin
                   ...
                   if pos('#',EdPsqTexto.Text) > 0 then begin
                      ...
                      Text := Text + ' and NomAgb LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + ' and NomAgb LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' and NomAgb LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                end;

                Text := Text + ' Order by NomAgb ';
        ...
        try
           ...
           with fmPsqCnb.FinCnb,SQL do begin
                ...
                if Trim( CodAgb ) <> '' then begin
                   ...
                   if pos('Where',Text) > 0 then
                      Text := Text + '   and CodAgb = '+ QuotedStr(CodAgb)
                   else
                      Text := Text + ' Where CodAgb = '+ QuotedStr(CodAgb);
                ...
                if Trim( EdPsqTexto.Text ) <> '' then begin
                   ...
                   if pos('#',EdPsqTexto.Text) > 0 then begin
                      ...
                      Text := Text + ' and NomCnb LIKE '+ QuotedStr(copy(EdPsqTexto.Text,1,pos('#',EdPsqTexto.Text)-1)  +'%');
                      Text := Text + ' and NomCnb LIKE '+ QuotedStr(copy(EdPsqTexto.Text,pos('#',EdPsqTexto.Text)+1,60) +'%');

                      end
                   else
                      Text := Text + ' and NomCnb LIKE '+ QuotedStr(EdPsqTexto.Text +'%');

                end;

                Text := Text + ' Order by NomCnb';
           ...
           if Trim( fmPsqCnb.CodCnb ) <> '' then begin
              ...
              NomBan := fmPsqCnb.NomBan;
              CodAgb := fmPsqCnb.CodAgb;
              NomAgb := fmPsqCnb.NomAgb;
              CodCnb := fmPsqCnb.CodCnb;
              NomCnb := fmPsqCnb.NomCnb;
...
procedure TfmAuxIni.FormCreate(Sender: TObject);
begin
  TestaSimilar := 'N';
end;

procedure TfmAuxIni.PaintBoxPaint(Sender: TObject);
begin
