  ...
  object PedLb2: TwwQuery
    ...
    SQL.Strings = (
      'Select PedR20.*,'
        ...
        '           TextoOcor(IntStrZeros(PedR20.CodVen,7),'#39'-'#39',FinVen.Ape' +
        'Ven,'#39#39','#39#39','#39#39','#39#39') as ApeVen,'
      
        '           TextoOcor(IntStrZeros(PedR20.CodCli,7),'#39'-'#39',FinCli.Nom' +
        'Cli,'#39#39','#39#39','#39#39','#39#39') as NomCli,'
      
        '           TextoOcor(PedR20.CodGru,'#39'.'#39',PedR20.CodSub,'#39'.'#39',PedR20.' +
      ...
      'From PedR20 LEFT JOIN EstPro ON (PedR20.CodClp = EstPro.CodClp)'
        ...
        '                      LEFT JOIN FinVen ON (PedR20.CodVen = FinVe' +
        'n.CodVen)'
      
        '                        LEFT JOIN FinCli ON (PedR20.CodCli = Fin' +
        'Cli.CodCli)'
      'Where PedR20.DteFat = :DteFat')
