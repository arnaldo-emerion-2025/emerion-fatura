inherited fmManLn5: TfmManLn5
  Left = 357
  Top = 118
  Caption = 'Notas fiscais (Comercial) - Impressão de duplicatas'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object bPsqBan: TSpeedButton
    ...
    Width = 23
    Height = 21
    Hint = 'Pesquisar Locais de Cobrança Existentes'
    Flat = True
    Glyph.Data = {
      36030000424D3603000000000000360000002800000010000000100000000100
      18000000000000030000C40E0000C40E00000000000000000000C0CFD0C0CFD0
  ...
  object EdPsqNumRes1: TdxColorEdit
    Left = 158
    Top = 13
    Width = 87
    Color = 16577773
    ...
    Style.Shadow = True
    TabOrder = 0
    OnKeyPress = EdPsqNumRes1KeyPress
  ...
  object EdPsqTotFat1: TdxColorCurrencyEdit
    Left = 158
    Top = 151
    Width = 87
    Color = 16577773
  ...
  object EdPsqTotFat2: TdxColorCurrencyEdit
    Left = 269
    Top = 151
    Width = 87
    Color = 16577773
  ...
  object EdPsqNumRes2: TdxColorEdit
    Left = 269
    Top = 13
    Width = 87
    Color = 16577773
  ...
  object FatDup: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           FinCli.InsCli,'
      '           FinCli.RfcCli'
      'From FatDup LEFT JOIN FinCrp ON (FatDup.CodEmp = FinCrp.CodEmp)'
        ...
        '                      LEFT JOIN FinCre ON (FinCrp.CodEmp = FinCr' +
        'e.CodEmp)'
        ...
        '                       LEFT JOIN FinCli ON (FinCre.CodCli = FinC' +
        'li.CodCli)'
      'Where FatDup.ArqDup = :ArqDup'
      'Order by FatDup.CodEmp,FatDup.DteCre,FatDup.NumCre,FatDup.NumCrp'
      ' ')
    UpdateObject = UpDup
    ControlType.Strings = (
      'FLGIMP;CheckBox;*; ')
    ...
    object FatDupNUMCRE: TFloatField
      Alignment = taLeftJustify
      DisplayLabel = 'No. Documento'
      DisplayWidth = 10
      FieldName = 'NUMCRE'
      Origin = 'ISADE.FINCRP.NUMCRE'
    end
    object FatDupNROCRP: TIntegerField
      Alignment = taLeftJustify
      DisplayLabel = 'Nº'
      DisplayWidth = 4
      FieldName = 'NROCRP'
      Origin = 'ISADE.FINCRP.NROCRP'
    end
    object FatDupPRACRP: TIntegerField
      Alignment = taLeftJustify
      DisplayLabel = 'Prazo'
      DisplayWidth = 5
      FieldName = 'PRACRP'
      Origin = 'ISADE.FINCRP.PRACRP'
    end
    object FatDupDTVCRP: TDateTimeField
      DisplayLabel = '       Vencto'
      DisplayWidth = 10
      FieldName = 'DTVCRP'
      Origin = 'ISADE.FINCRP.DTVCRP'
      EditMask = '!99/99/9999;1; '
    end
    object FatDupVLPCRP: TFloatField
      DisplayLabel = '     Valor da Parcela'
      DisplayWidth = 10
      FieldName = 'VLPCRP'
      Origin = 'ISADE.FINCRP.VLPCRP'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object FatDupVPPCRP: TFloatField
      DisplayLabel = '            Valor Pago'
      DisplayWidth = 10
      FieldName = 'VPPCRP'
      Origin = 'ISADE.FINCRP.VPPCRP'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object FatDupDULCRP: TDateTimeField
      DisplayLabel = '  Data Pgto'
      DisplayWidth = 10
      FieldName = 'DULCRP'
      Origin = 'ISADE.FINCRP.DULCRP'
      EditMask = '!99/99/9999;1; '
    end
    object FatDupVJPCRP: TFloatField
      DisplayLabel = '         Juros'
      DisplayWidth = 10
      FieldName = 'VJPCRP'
      Origin = 'ISADE.FINCRP.VJPCRP'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object FatDupVDSCRP: TFloatField
      DisplayLabel = '        Descontos'
      DisplayWidth = 10
      FieldName = 'VDSCRP'
      Origin = 'ISADE.FINCRP.VDSCRP'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object FatDupFLGIMP: TStringField
      Alignment = taCenter
      DisplayLabel = '  E  '
      DisplayWidth = 3
      FieldName = 'FLGIMP'
    ...
    object FatDupCODEMP: TIntegerField
      DisplayWidth = 10
      FieldName = 'CODEMP'
      Origin = 'ISADE.FINCRP.CODEMP'
      Visible = False
    end
    object FatDupDTECRE: TDateTimeField
      DisplayWidth = 18
      FieldName = 'DTECRE'
      Origin = 'ISADE.FINCRP.DTECRE'
      Visible = False
    end
    object FatDupTECCLI: TStringField
      FieldName = 'TECCLI'
      Visible = False
      FixedChar = True
      Size = 10
    end
    object FatDupENCCLI: TStringField
      FieldName = 'ENCCLI'
      Visible = False
      FixedChar = True
      Size = 70
    end
    object FatDupBACCLI: TStringField
      FieldName = 'BACCLI'
      Visible = False
      FixedChar = True
    end
    object FatDupCICCLI: TStringField
      FieldName = 'CICCLI'
      Visible = False
      FixedChar = True
    end
    object FatDupCECCLI: TStringField
      FieldName = 'CECCLI'
      Visible = False
      FixedChar = True
      Size = 8
    end
    object FatDupUFCCLI: TStringField
      FieldName = 'UFCCLI'
      Visible = False
      FixedChar = True
      Size = 2
    end
    object FatDupNRCCLI: TStringField
      FieldName = 'NRCCLI'
      Visible = False
      FixedChar = True
      Size = 10
    end
    object FatDupNOMCLI: TStringField
      DisplayWidth = 70
      FieldName = 'NOMCLI'
      Visible = False
      FixedChar = True
    ...
    object FatDupCODCLI: TIntegerField
      DisplayWidth = 10
      FieldName = 'CODCLI'
      Visible = False
    end
    object FatDupCGCCLI: TStringField
      DisplayWidth = 18
      FieldName = 'CGCCLI'
      Visible = False
      FixedChar = True
    ...
    object FatDupINSCLI: TStringField
      DisplayWidth = 18
      FieldName = 'INSCLI'
      Visible = False
      FixedChar = True
    ...
    object FatDupARQDUP: TStringField
      FieldName = 'ARQDUP'
      Visible = False
      FixedChar = True
      Size = 22
    end
    object FatDupCODBAN: TIntegerField
      FieldName = 'CODBAN'
      Visible = False
    end
    object FatDupCODUSU: TIntegerField
      FieldName = 'CODUSU'
      Visible = False
    end
    object FatDupTOTCRE: TFloatField
      FieldName = 'TOTCRE'
      Visible = False
    end
    object FatDupRFCCLI: TStringField
      FieldName = 'RFCCLI'
      Visible = False
      FixedChar = True
      Size = 40
    end
    object FatDupRESFAT: TIntegerField
      DisplayWidth = 10
      FieldName = 'RESFAT'
      Visible = False
    end
    object FatDupRESORC: TIntegerField
      DisplayWidth = 10
      FieldName = 'RESORC'
      Visible = False
    end
    object FatDupNUMRES: TIntegerField
      DisplayWidth = 10
      FieldName = 'NUMRES'
      Visible = False
    end
    object FatDupNRONFS: TIntegerField
      FieldName = 'NRONFS'
      Visible = False
    end
    object FatDupVLSCRP: TFloatField
      FieldName = 'VLSCRP'
      Visible = False
    end
    object FatDupNUMCRP: TIntegerField
      FieldName = 'NUMCRP'
    end
  end
  object DsDup: TwwDataSource
    DataSet = FatDup
    Left = 36
    Top = 351
  end
  ...
  object RDprint1: TRDprint
    ...
    OpcoesPreview.CaptionPreview = 'Impressão de Duplicatas'
    ...
    CaptionSetup = 'Setup'
    TitulodoRelatorio = 'Impressão de Duplicatas'
  ...
  object UpDup: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into FatDup'
        ...
        '  (ARQDUP, CODEMP, DTECRE, NUMCRE, NUMCRP, PRACRP, DTVCRP, VLPCR' +
        'P, VPPCRP, '
      
        '   VJPCRP, VDSCRP, DULCRP, CODBAN, CODUSU, FLGIMP, RESFAT, RESOR' +
        'C, NUMRES, '
      '   NRONFS, NROCRP)'
      'values'
      
        '  (:ARQDUP, :CODEMP, :DTECRE, :NUMCRE, :NUMCRP, :PRACRP, :DTVCRP' +
        ', :VLPCRP, '
      
        '   :VPPCRP, :VJPCRP, :VDSCRP, :DULCRP, :CODBAN, :CODUSU, :FLGIMP' +
        ', :RESFAT, '
      '   :RESORC, :NUMRES, :NRONFS, :NROCRP)')
    DeleteSQL.Strings = (
      'delete from FatDup'
      'where'
      '  ARQDUP = :OLD_ARQDUP and'
