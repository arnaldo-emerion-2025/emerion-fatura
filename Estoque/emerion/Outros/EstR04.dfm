inherited fmEstR04: TfmEstR04
  ...
  object DsR04: TwwDataSource
    DataSet = EstR04
    Left = 324
    Top = 273
  end
  object EstR04: TwwQuery
    Tag = 1
    CachedUpdates = True
    DatabaseName = 'ISade'
    SQL.Strings = (
    ...
    object EstR04DTEHIS: TDateTimeField
      DisplayLabel = 'Emissão'
      FieldName = 'DTEHIS'
    end
    object EstR04CODUNS: TStringField
      DisplayLabel = 'Und'
      FieldName = 'CODUNS'
      FixedChar = True
      Size = 3
    end
    object EstR04OPERACAO: TStringField
      DisplayLabel = 'Operação'
      FieldName = 'OPERACAO'
      Size = 45
    end
    object EstR04QTMOVI: TFloatField
      DisplayLabel = 'Qtd Movimentada'
      FieldName = 'QTMOVI'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object EstR04ITEM: TStringField
      FieldName = 'ITEM'
      Size = 18
    end
    object EstR04DSCPRO: TStringField
      FieldName = 'DSCPRO'
      FixedChar = True
      Size = 70
    end
    object EstR04NUMFAT: TIntegerField
      FieldName = 'NUMFAT'
    end
    object EstR04NUMLOJ: TIntegerField
      FieldName = 'NUMLOJ'
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = 'Saidas'#13#10#13#10
      BandColor = clWhite
