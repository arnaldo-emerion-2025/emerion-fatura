...
begin
  ...
  if rgValor.ItemIndex = 1 then sBase := ' Select EstIte.CodEmp,'+
                                         ...
                                         '        EstIte.QtdRma,'+
                                         '        EstIte.QmaIte,'+
                                         '        Round(EstIte.QtdIte * EstIte.Vb2Ite,2) as Total,'+
                                         '        EstIte.CodClp || _UNICODE_FSS '+ QuotedStr('-') +' || EstIte.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodPro as CodIte'+
                                         ' From EstIte LEFT JOIN EstPro ON (EstIte.CodClp = EstPro.CodClp '+
                                         '                             AND  EstIte.CodGru = EstPro.CodGru '+
                                         '                             AND  EstIte.CodSub = EstPro.CodSub '+
  ...
  if rgValor.ItemIndex = 2 then sBase := ' Select EstIte.CodEmp,'+
                                         ...
                                         '        EstIte.QtdRma,'+
                                         '        EstIte.QmaIte,'+
                                         '        Round(EstIte.QtdIte * EstIte.Vb3Ite,2) as Total,'+
                                         '        EstIte.CodClp || _UNICODE_FSS '+ QuotedStr('-') +' || EstIte.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodPro as CodIte'+
                                         ' From EstIte LEFT JOIN EstPro ON (EstIte.CodClp = EstPro.CodClp '+
                                         '                             AND  EstIte.CodGru = EstPro.CodGru '+
                                         '                             AND  EstIte.CodSub = EstPro.CodSub '+
  ...
  if rgValor.ItemIndex = 3 then sBase := ' Select EstIte.CodEmp,'+
                                         ...
                                         '        EstIte.QtdRma,'+
                                         '        EstIte.QmaIte,'+
                                         '        Round(EstIte.QtdIte * EstIte.Vb4Ite,2) as Total,'+
                                         '        EstIte.CodClp || _UNICODE_FSS '+ QuotedStr('-') +' || EstIte.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodPro as CodIte'+
                                         ' From EstIte LEFT JOIN EstPro ON (EstIte.CodClp = EstPro.CodClp '+
                                         '                             AND  EstIte.CodGru = EstPro.CodGru '+
                                         '                             AND  EstIte.CodSub = EstPro.CodSub '+
  ...
  if rgValor.ItemIndex = 4 then sBase := ' Select EstIte.CodEmp,'+
                                         ...
                                         '        EstIte.QtdRma,'+
                                         '        EstIte.QmaIte,'+
                                         '        Round(EstIte.QtdIte * EstIte.Vb5Ite,2) as Total,'+
                                         '        EstIte.CodClp || _UNICODE_FSS '+ QuotedStr('-') +' || EstIte.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodPro as CodIte'+
                                         ' From EstIte LEFT JOIN EstPro ON (EstIte.CodClp = EstPro.CodClp '+
                                         '                             AND  EstIte.CodGru = EstPro.CodGru '+
                                         '                             AND  EstIte.CodSub = EstPro.CodSub '+
  ...
  if rgValor.ItemIndex = 5 then sBase := ' Select EstIte.CodEmp,'+
                                         ...
                                         '        EstIte.QtdRma,'+                                         
                                         '        EstIte.QmaIte,'+
                                         '        Round(EstIte.QtdIte * EstIte.CstIte,2) as Total,'+
                                         '        EstIte.CodClp || _UNICODE_FSS '+ QuotedStr('-') +' || EstIte.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodPro as CodIte'+
                                         ' From EstIte LEFT JOIN EstPro ON (EstIte.CodClp = EstPro.CodClp '+
                                         '                             AND  EstIte.CodGru = EstPro.CodGru '+
                                         '                             AND  EstIte.CodSub = EstPro.CodSub '+
  ...
  if rgValor.ItemIndex = 6 then sBase := ' Select EstIte.CodEmp,'+
                                         ...
                                         '        EstIte.QtdRma,'+
                                         '        EstIte.QmaIte,'+
                                         '        Round(EstIte.QtdIte * EstIte.VpfIte,2) as Total,'+
                                         '        EstIte.CodClp || _UNICODE_FSS '+ QuotedStr('-') +' || EstIte.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodPro as CodIte'+
                                         ' From EstIte LEFT JOIN EstPro ON (EstIte.CodClp = EstPro.CodClp)'+
                                         '                             AND (EstIte.CodGru = EstPro.CodGru)'+
                                         '                             AND (EstIte.CodSub = EstPro.CodSub)'+
  ...
  if rgValor.ItemIndex = 7 then sBase := ' Select EstIte.CodEmp,'+
                                         ...
                                         '        EstIte.QtdRma,'+
                                         '        EstIte.QmaIte,'+
                                         '        Round(EstIte.QtdIte * EstIte.VchIte,2) as Total,'+
                                         '        EstIte.CodClp || _UNICODE_FSS '+ QuotedStr('-') +' || EstIte.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodPro as CodIte'+
                                         ' From EstIte LEFT JOIN EstPro ON (EstIte.CodClp = EstPro.CodClp '+
                                         '                             AND  EstIte.CodGru = EstPro.CodGru '+
                                         '                             AND  EstIte.CodSub = EstPro.CodSub '+
  ...
  if rgValor.ItemIndex = 8 then sBase := ' Select EstIte.CodEmp,'+
                                         ...
                                         '        EstIte.QtdRma,'+
                                         '        EstIte.QmaIte,'+
                                         '        Round(EstIte.QtdIte * EstIte.VcrIte,2) as Total,'+
                                         '        EstIte.CodClp || _UNICODE_FSS '+ QuotedStr('-') +' || EstIte.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || EstIte.CodPro as CodIte'+
                                         ' From EstIte LEFT JOIN EstPro ON (EstIte.CodClp = EstPro.CodClp '+
                                         '                             AND  EstIte.CodGru = EstPro.CodGru '+
                                         '                             AND  EstIte.CodSub = EstPro.CodSub '+
