...
type
   TFrmEditNfe = class(TForm)
      ...
      EdObs: TRichEdit;
      Label50: TLabel;
    cdsCabecario: TClientDataSet;
    cdsCabecarioSEQNFE: TStringField;
    cdsCabecarioCGCEMP: TStringField;
    cdsCabecarioINSESTEMP: TStringField;
    cdsCabecarioINSESTSTEMP: TStringField;
    cdsCabecarioNATOPE: TStringField;
    cdsCabecarioNOMCLI: TStringField;
    cdsCabecarioCGCCLI: TStringField;
    cdsCabecarioENDCLI: TStringField;
