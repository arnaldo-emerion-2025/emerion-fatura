object fmManIro: TfmManIro
  ...
  object UpNfs: TUpdateSQL
    ...
    InsertSQL.Strings = (
      'insert into CmpNfs'
        ...
        '   UFFFOR, ID_FINUFF, ID_FINCIF, ID_FINUFE, ID_FINCIE, ID_TRAUFE' +
        ', ID_TRACIE, '
      
        '   CGEFOR, INEFOR, ID_ESTSIP, TRBPIS, NFEPIS, TRBCOF, NFECOF, EN' +
        'VNFE, SEQNFE, '
      
        '   DTENFE, RECNFE, PRONFE, LOTNFE, DTEPNF, HREPNF, DOPNFE, HRENF' +
        'E, USUNFE, '
      
        '   IMPNFE, RETNFE, DTECNE, HRECNE, ARQNFE, DTCNFE, HRCNFE, PRCNF' +
        'E, NROPDI, '
      
        '   DTEPDI, LOCPDI, UFEPDI, DTEADU, EXPPDI, FLGUSA, FLGEMI, CODTR' +
        'A)'
      'values'
        ...
        '   :ID_TRAUFE, :ID_TRACIE, :CGEFOR, :INEFOR, :ID_ESTSIP, :TRBPIS' +
        ', :NFEPIS, '
      
        '   :TRBCOF, :NFECOF, :ENVNFE, :SEQNFE, :DTENFE, :RECNFE, :PRONFE' +
        ', :LOTNFE, '
      
        '   :DTEPNF, :HREPNF, :DOPNFE, :HRENFE, :USUNFE, :IMPNFE, :RETNFE' +
        ', :DTECNE, '
      
        '   :HRECNE, :ARQNFE, :DTCNFE, :HRCNFE, :PRCNFE, :NROPDI, :DTEPDI' +
        ', :LOCPDI, '
      '   :UFEPDI, :DTEADU, :EXPPDI, :FLGUSA, :FLGEMI, :CODTRA)')
    DeleteSQL.Strings = (
      'delete from CmpNfs'
      'where'
      '  ID_CMPNFS = :OLD_ID_CMPNFS')
  ...
  object FatArq: TwwQuery
    ...
    object FatArqARQNFE_1: TBlobField
      FieldName = 'ARQNFE_1'
      BlobType = ftBlob
      Size = 1
    end
