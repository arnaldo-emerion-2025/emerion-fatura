...
type
  ...
  TfmCmpR03 = class(TfmPadrao)
    ...
    grPe2TOTNAT: TdxDBGridColumn;
    CmpPe2DSCPRO: TStringField;
    grPe2CODPRO: TdxDBGridColumn;
...
begin
  ...
  sFiltro := sFiltro + ' and CmpPed.SitPed <> '''+ 'Recebido' +''' and CmpPed.SitPed <> '''+ 'Saldo Nao Atendido' +''' and CmpPed.SitPed <> '''+ 'Nao Concluido' +'''';
  ...
  with CmpPe2,SQL do begin
       ...
       Text := ' Select CmpR04.NumPed,'+
               ...
               '        CmpR04.CodClp || _UNICODE_FSS '''+ '-' +''' || CmpR04.CodGru || _UNICODE_FSS '''+ '.' +''' || CmpR04.CodSub || _UNICODE_FSS '''+ '.' +''' || CmpR04.CodPro as CodIte'+
...
begin
  ...
  try
     ...
     fmManCol.Synchronize(fmCmpR03.grPe2);
