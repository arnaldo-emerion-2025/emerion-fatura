...
procedure TfmCmpR15.Save(ADefaultExt, AFilter, AFileName: string; AMethod: TSaveMethod);
begin
  with SaveDialog do
  begin
...
procedure TfmCmpR15.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.bPesquisaClick(Sender: TObject);
begin
  ...
  begin
    ...
    Close;
    Text := ' Insert Into CmpR15(SeqArq,CodClp,CodGru,CodSub,CodPro,QtdDev,QtdRma,TotDev)' +
      ' Select ''' + SeqArq + ''',' +
      '        FatDv2.CodClp,' +
      '        FatDv2.CodGru,' +
      '        FatDv2.CodSub,' +
      ...
      ' Group by FatDv2.CodClp,FatDv2.CodGru,FatDv2.CodSub,FatDv2.CodPro';
    ExecSQL;
  ...
  begin
    ...
    Text := ' Insert Into CmpR15(SeqArq,CodClp,CodGru,CodSub,CodPro,QtdDev,QtdRma,TotDev)' +
      ...
      ' Group by FatDe2.CodClp,FatDe2.CodGru,FatDe2.CodSub,FatDe2.CodPro';
    ExecSQL;
  ...
  begin
    ...
    Close;
    Text := ' Insert Into CmpR16(SeqArq,CodClp,CodGru,CodSub,CodPro,QtdDev,QtdRma,TotDev)' +
    ...
    Text := Text + ' Group by CmpR15.SeqArq,CmpR15.CodClp,CmpR15.CodGru,CmpR15.CodSub,CmpR15.CodPro';
...
procedure TfmCmpR15.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.PaintBoxPaint(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.bImprimirClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.grR05ReloadGroupList(Sender: TObject);
begin
  inherited;
  (Sender as TdxDBGrid).FullExpand;
end;

procedure TfmCmpR15.HTMLClick(Sender: TObject);
begin
  inherited;
  Save('htm', 'HTML File (*.htm; *.html)|*.htm', 'Curva ABC de Itens.htm', grR05.SaveToHTML);
end;

procedure TfmCmpR15.ExcelClick(Sender: TObject);
begin
  inherited;
  Save('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', 'Curva ABC de Itens.xls', grR05.SaveToXLS);
end;

procedure TfmCmpR15.XMLClick(Sender: TObject);
begin
  inherited;
  Save('xml', 'XML File (*.xml)|*.xml', 'Curva ABC de Itens.xml', grR05.SaveToXML);
end;

procedure TfmCmpR15.BbPsqEmpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodEmpExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodEmp.Text) <> '' then
  begin
...
procedure TfmCmpR15.EdCodEmpKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
...
procedure TfmCmpR15.BbPsqClpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodClpExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodClp.Text) <> '' then
  begin
...
procedure TfmCmpR15.BbPsqGruClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodGruExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodGru.Text) <> '' then
  begin
...
procedure TfmCmpR15.BbPsqSubClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodSubExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodSub.Text) <> '' then
  begin
...
procedure TfmCmpR15.BbPsqProClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodProExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodPro.Text) <> '' then
  begin
...
procedure TfmCmpR15.BbPsqCliClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodCliExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodCli.Text) <> '' then
  begin
...
procedure TfmCmpR15.BbPsqVenClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodVenExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodVen.Text) <> '' then
  begin
...
procedure TfmCmpR15.bPsqCatClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodCatExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodCat.Text) <> '' then
  begin
...
procedure TfmCmpR15.bPsqTipClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodTipExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodTip.Text) <> '' then
  begin
...
procedure TfmCmpR15.bPsqMrcClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR15.EdCodMrcExit(Sender: TObject);
begin
  inherited;
  if Trim(EdCodMrc.Text) <> '' then
  begin
...
procedure TfmCmpR15.EdCodCatKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then
  begin {F1 - Iniciais}
...
procedure TfmCmpR15.EdCodTipKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then
  begin {F1 - Iniciais}
...
procedure TfmCmpR15.EdCodMrcKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then
  begin {F1 - Iniciais}
...
procedure TfmCmpR15.EdCodClpKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then
  begin {F1 - Iniciais}
...
procedure TfmCmpR15.EdCodGruKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then
  begin {F1 - Iniciais}
...
procedure TfmCmpR15.EdCodSubKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then
  begin {F1 - Iniciais}
...
procedure TfmCmpR15.EdCodProKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then
  begin {F1 - Iniciais}
...
procedure TfmCmpR15.EdCodCliKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then
  begin {F1 - Iniciais}
...
procedure TfmCmpR15.EdCodVenKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 112 then
  begin {F1 - Iniciais}
...
procedure TfmCmpR15.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfmCmpR15.FormDestroy(Sender: TObject);
begin
  inherited;
  fmCmpR15 := nil;
end;
