inherited fmManPco: TfmManPco
    ...
    object pcPag2: TTabSheet
      ...
      object Panel4: TPanel
        ...
        object EdCodPfo: TdxDBColorEdit
          ...
          Style.Shadow = True
          TabOrder = 8
          OnKeyUp = EdCodPfoKeyUp
          OnMouseUp = EdCodPfoMouseUp
          Alignment = taLeftJustify
          CharCase = ecUpperCase
          DataField = 'CODPFO'
          DataSource = DsPfo
        ...
        object EdLotPfo: TdxDBColorEdit
          Left = 651
          Top = 138
          Width = 86
          Color = 16577773
  ...
  object UpPfo: TUpdateSQL
    ModifySQL.Strings = (
      ...
      '  VARPFO = :VARPFO'
      'where'
      '  CODFOR = :OLD_CODFOR and'
      '  SEQPFO = :OLD_SEQPFO')
    InsertSQL.Strings = (
      'insert into CmpPfo'
      
        '  (CODFOR, SEQPFO, CODPFO, CODCLP, CODGRU, CODSUB, CODPRO, VALPF' +
        'O, '
      'DSCPFO, '
      
        '   PERIPI, VALFIN, OBSPFO, NROPFO, FLGTRG, MARKUP, LOTPFO, ULTCM' +
        'P, '
      'ULTQTD, '
      '   DULCMP, DIFICM, ULTPFO, VARPFO)'
      'values'
      
        '  (:CODFOR, :SEQPFO, :CODPFO, :CODCLP, :CODGRU, :CODSUB, :CODPRO' +
        ', '
      ':VALPFO, '
      
        '   :DSCPFO, :PERIPI, :VALFIN, :OBSPFO, :NROPFO, :FLGTRG, :MARKUP' +
        ', '
      ':LOTPFO, '
      '   :ULTCMP, :ULTQTD, :DULCMP, :DIFICM, :ULTPFO, :VARPFO)')
    DeleteSQL.Strings = (
      'delete from CmpPfo'
      'where'
      '  CODFOR = :OLD_CODFOR and'
  ...
  object ppReport: TppReport
    ...
    Template.FileName = 'C:\_WGSYS\Emerion\Compras\Relatorios\RManPco.rtm'
    Units = utMillimeters
    UserName = 'Report'
    DeviceType = 'Screen'
    Left = 66
