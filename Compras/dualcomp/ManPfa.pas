...
begin
  ...
  if nvPfa.Salvar then begin
     ...
     if Trim( EstPfaLocPfa.Value ) <> '' then begin
           ...
           if EstPfaLocPfa.Value = 'Mesmo Estado' then begin
              ...
              if (copy(Trim( EstPfaCodCf1.Value ),1,1) <> '1') and (copy(Trim( EstPfaCodCf1.Value ),1,1) <> '5') then begin
                 ...
                 if (copy(Trim( EstPfaCodCf1.Value ),1,1) = '2') or (copy(Trim( EstPfaCodCf1.Value ),1,1) = '6') then
                    fmsgErro('Origem/Destino do Padrao de Faturamento informado Esta Incorreta. CFOP Informada de Outros Estados.',EdLocPfa)
                 else
                    fmsgErro('Origem/Destino do Padrao de Faturamento informado Esta Incorreta. CFOP Informada de Importacao ou Exportacao.',EdLocPfa);
              ...
              if EstPfaLocPfa.Value = 'Outros Estados' then begin
                 ...
                 if (copy(Trim( EstPfaCodCf1.Value ),1,1) <> '2') and (copy(Trim( EstPfaCodCf1.Value ),1,1) <> '6') then begin
                    ...
                    if (copy(Trim( EstPfaCodCf1.Value ),1,1) = '1') or (copy(Trim( EstPfaCodCf1.Value ),1,1) = '5') then
                       fmsgErro('Origem/Destino do Padrao de Faturamento informado Esta Incorreta. CFOP Informada de Mesmo Estado.',EdLocPfa)
                    else
                       fmsgErro('Origem/Destino do Padrao de Faturamento informado Esta Incorreta. CFOP Informada de Importacao ou Exportacao.',EdLocPfa);
        ...
        fmsgErro('Campo de Preenchimento Obrigatorio não Informado',EdLocPfa);
  end;
end;
