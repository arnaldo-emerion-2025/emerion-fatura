inherited fmCmpR11: TfmCmpR11
  Left = 0
  Caption = 'Relação Sintetica de Entrada de Mercadorias por Tipo de Produto'
  ClientHeight = 481
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grR11: TdxDBGrid
    ...
    object grR11APEFOR: TdxDBGridMaskColumn
      Width = 609
      BandIndex = 0
      RowIndex = 0
      FieldName = 'APEFOR'
    end
    object grR11TOTENT: TdxDBGridMaskColumn
  ...
  object CmpR11: TwwQuery
    Active = True
    CachedUpdates = True
    DatabaseName = 'ISade'
    SQL.Strings = (
      
        'Select TextoOcor(IntStrZeros(CmpEnt.CodFor,5),'#39'-'#39',FinFor.ApeFor,' +
        #39#39','#39#39','#39#39','#39#39') as ApeFor,'
      
        '           Round( Sum(EstHis.QtMovi * EstHis.VpfHis),4) as TotEn' +
        't'
      'From EstHis LEFT JOIN CmpEn2 ON (EstHis.EmpEnt = CmpEn2.CodEmp)'
        ...
        '                    LEFT JOIN CmpEnt ON (CmpEn2.CodEmp = CmpEnt.' +
        'CodEmp)'
        ...
        '                      LEFT JOIN EstPfa ON (CmpEnt.CodPfa = EstPf' +
        'a.CodPfa)'
      
        '                                                  AND (CmpEnt.Ti' +
        'pPfa = EstPfa.TipPfa)'
      
        '                       LEFT JOIN FinFor ON (CmpEnt.CodFor = FinF' +
        'or.CodFor)'
      
        '                      LEFT JOIN EstQte ON (EstHis.CodEmp = EstQt' +
        'e.CodEmp)'
        ...
        '                      LEFT JOIN EstPro ON (EstQte.CodClp = EstPr' +
        'o.CodClp)'
        ...
        '                     LEFT JOIN FinCom ON (EstPro.CodCom = FinCom' +
        '.CodCom)'
      
        '                     LEFT JOIN GerUsu ON (CmpEnt.CodUsu = GerUsu' +
        '.CodUsu)'
      ...
      'Where EstHis.DteHis = :DteHis'
        ...
        'Group by TextoOcor(IntStrZeros(CmpEnt.CodFor,5),'#39'-'#39',FinFor.ApeFo' +
        'r,'#39#39','#39#39','#39#39','#39#39')')
    ...
    object CmpR11TOTENT: TFloatField
      DisplayLabel = 'Total de Entradas'
      FieldName = 'TOTENT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object CmpR11APEFOR: TStringField
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = 
        #13#10'Relação Sintetica de Entrada de Mercadorias por Tipo de Produt' +
        'o'#13#10#13#10
      BandColor = clWhite
