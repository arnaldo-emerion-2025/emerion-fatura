inherited fmCmpR10: TfmCmpR10
  Left = 0
  Caption = 'Relação Sintetica de Entradas de Mercadorias'
  ClientHeight = 481
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grEnt: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          ...
          item
            ColumnName = 'grEntTOTICC'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end
          item
            ColumnName = 'grEntTOTIPC'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end>
    ...
    object grEntNUMDOC: TdxDBGridMaskColumn
    ...
    object grEntNUMENT: TdxDBGridMaskColumn
    ...
    object grEntDTEOPE: TdxDBGridDateColumn
      Caption = 'Dt. Entrada'
      Width = 94
      BandIndex = 0
      RowIndex = 0
    ...
    object grEntDTEDOC: TdxDBGridColumn
    ...
    object grEntAPEFOR: TdxDBGridMaskColumn
      Caption = 'Fornecedor'
      Width = 210
      BandIndex = 0
      RowIndex = 0
    ...
    object grEntTOTENC: TdxDBGridMaskColumn
    ...
    object grEntTOTICC: TdxDBGridMaskColumn
      Caption = 'Total ICMS'
      HeaderAlignment = taRightJustify
      Width = 102
      BandIndex = 0
    ...
    object grEntTOTIPC: TdxDBGridMaskColumn
      Caption = 'Total IPI'
      HeaderAlignment = taRightJustify
      Width = 97
      BandIndex = 0
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação Sintetica de Entradas de Mercadorias'#13#10#13#10
      BandColor = clWhite
