inherited fmCmpR13: TfmCmpR13
  Left = 0
  Caption = 'Relação de Pagamentos Previstos para o Pedidos de Compras'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object Label2: TLabel
    ...
    Width = 150
    Height = 13
    Caption = 'Vencimentos Selecionados'
    Color = clBtnFace
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
  ...
  object grPe5: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          item
            ColumnName = 'grPe5VALPE5'
            SummaryFormat = '###,###,##0.00'
            SummaryType = cstSum
          end>
        Name = 'grPe5SummaryGroup1'
      end>
    SummarySeparator = ', '
    BorderStyle = bsNone
    Color = clInfoBk
    ...
    ShowRowFooter = True
    OnReloadGroupList = grPe5ReloadGroupList
    object grPe5APEFOR: TdxDBGridMaskColumn
      Caption = 'Fornecedor'
      Width = 220
      BandIndex = 0
      RowIndex = 0
    ...
    object grPe5NUMPED: TdxDBGridMaskColumn
      Caption = 'Nro. Pedido'
      Width = 114
      BandIndex = 0
      RowIndex = 0
    ...
    object grPe5DTEPED: TdxDBGridDateColumn
      Caption = 'Emitido Em'
      Width = 107
      BandIndex = 0
      RowIndex = 0
    ...
    object grPe5DPEPED: TdxDBGridDateColumn
      Caption = 'Entregar Em'
      Width = 111
      BandIndex = 0
      RowIndex = 0
    ...
    object grPe5DTVPE5: TdxDBGridDateColumn
    ...
    object grPe5VALPE5: TdxDBGridMaskColumn
      Caption = 'Valor'
    ...
    object grPe5FLGPAG: TdxDBGridColumn
  ...
  object CmpPe5: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           CmpPed.DpePed,'
        ...
        '           TextoOcor(IntStrZeros(CmpPe5.CodFor,5),'#39'-'#39',FinFor.Ape' +
        'For,'#39#39','#39#39','#39#39','#39#39') as ApeFor'
      'From CmpPe5 LEFT JOIN CmpPed ON (CmpPe5.CodEmp = CmpPed.CodEmp)'
      
        '                                                      AND (CmpPe' +
        '5.DtePed = CmpPed.DtePed)'
      
        '                                                      AND (CmpPe' +
        '5.NumPed = CmpPed.NumPed)'
      
        '                           LEFT JOIN FinFor ON (CmpPe5.CodFor = ' +
        'FinFor.CodFor)'
      'Where CmpPe5.DtePed = :DtePed'
      'Order by CmpPe5.CodFor,CmpPe5.DtvPe5')
    ...
    object CmpPe5CODEMP: TIntegerField
      FieldName = 'CODEMP'
    end
    object CmpPe5DTEPED: TDateTimeField
      FieldName = 'DTEPED'
    end
    object CmpPe5NUMPED: TIntegerField
      Alignment = taLeftJustify
      FieldName = 'NUMPED'
    end
    object CmpPe5SEQPE5: TIntegerField
      FieldName = 'SEQPE5'
    end
    object CmpPe5CODFOR: TIntegerField
      Alignment = taLeftJustify
      FieldName = 'CODFOR'
    end
    object CmpPe5DTVPE5: TDateTimeField
      FieldName = 'DTVPE5'
    end
    object CmpPe5VALPE5: TFloatField
      FieldName = 'VALPE5'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object CmpPe5NROPE5: TIntegerField
      FieldName = 'NROPE5'
    end
    object CmpPe5APEFOR: TStringField
      FieldName = 'APEFOR'
      FixedChar = True
      Size = 100
    end
    object CmpPe5DPEPED: TDateTimeField
      FieldName = 'DPEPED'
    end
    object CmpPe5FLGPAG: TStringField
      FieldName = 'FLGPAG'
      FixedChar = True
      Size = 3
    end
    object CmpPe5FLGINT: TStringField
      FieldName = 'FLGINT'
      FixedChar = True
      Size = 1
    end
  end
  object DsPe5: TwwDataSource
    DataSet = CmpPe5
    Left = 244
    Top = 197
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Pagamentos Previstos para o Pedidos de Compras '#13#10
      BandColor = clWhite
