inherited fmCmpR18: TfmCmpR18
  Left = 0
  Caption = 'Relação de Itens Devolvidos por Cliente'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object Label17: TLabel
    ...
    Width = 178
    Height = 13
    Caption = 'Devoluções Realizadas no Periodo de'
  ...
  object grR05: TdxDBGrid
    ...
    object CODPRO: TdxDBGridMaskColumn
    ...
    object grR05CLIENTE: TdxDBGridColumn
      Caption = 'Cliente'
      Sorted = csUp
      Visible = False
      Width = 531
  ...
  object CmpR05: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           EstPro.DscPro,'
        ...
        '           TextoOcor(IntStrZeros(CmpR16.CodCli,5),'#39'-'#39',FinCli.Nom' +
        'Cli,'#39#39','#39#39','#39#39','#39#39') as Cliente,'
      
        '           CmpR16.CodClp || _UNICODE_FSS '#39'-'#39' || CmpR16.CodGru ||' +
        ' _UNICODE_FSS '#39'.'#39' || CmpR16.CodSub || _UNICODE_FSS '#39'.'#39' || CmpR16' +
        '.CodPro as CodIte'
      'From CmpR16 LEFT JOIN EstPro ON (CmpR16.CodClp = EstPro.CodClp'
        ...
        '                       LEFT JOIN FinCli ON (CmpR16.CodCli = FinC' +
        'li.CodCli)'
    ...
    object CmpR05QTDDEV: TFloatField
      FieldName = 'QTDDEV'
      DisplayFormat = '###,###,##0.0000'
    end
    object CmpR05QTDRMA: TFloatField
      FieldName = 'QTDRMA'
      DisplayFormat = '###,###,##0.0000'
    end
    object CmpR05TOTDEV: TFloatField
      FieldName = 'TOTDEV'
      DisplayFormat = '###,###,##0.00'
    end
    object CmpR05CODCLI: TIntegerField
      FieldName = 'CODCLI'
    end
    object CmpR05CLIENTE: TStringField
      FieldName = 'CLIENTE'
      FixedChar = True
      Size = 100
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      Active = True
      Component = grR05
      DateTime = 39891.9558155324
      DesignerHelpContext = 0
      PrinterPage.DMPaper = 119
      PrinterPage.Footer = 6350
      PrinterPage.Header = 6350
      PrinterPage.Margins.Bottom = 12700
      PrinterPage.Margins.Left = 12700
      PrinterPage.Margins.Right = 12700
      PrinterPage.Margins.Top = 32800
      ...
      ReportTitle.Text = #13#10'Relação de Itens Devolvidos por Cliente'#13#10#13#10
      BandColor = clWhite
