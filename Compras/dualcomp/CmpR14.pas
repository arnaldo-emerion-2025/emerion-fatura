...
begin
  ...
  sFiltro := sFiltro + ' and PedLib.AtuEst = '+ QuotedStr('Sim') +' and PedLb2.FlgSep = '+ QuotedStr('Sim');
  ...
  with quSQL,SQL do begin
       ...
       Text := ' Insert Into CmpR14(SeqArq,CodCli,CodVen,NumRes,FlgTab,DteRes,NroNfs,DteFat,DteSda,DteEnt,CodClp,CodGru,CodSub,CodPro,UltQts,TotCst,TotRen,VcsLb2,TotLb2,VlqLb2,SitLib,ModPfa)'+
               ...
               '        PedLb2.TotRen,'+
               '        PedLb2.VcsLb2,'+
               '        (PedLb2.TotGe2 - PedLb2.TotIpc) as TotLb2,'+
  ...
  with PedLb2,SQL do begin
       ...
       Text := ' Select CmpR14.*,'+
               ...
               '        FinCli.NomCli,'+
               '        CmpR14.CodGru || _UNICODE_FSS '+ QuotedStr('.') +' || CmpR14.CodSub || _UNICODE_FSS '+ QuotedStr('.') +' || CmpR14.CodPro || _UNICODE_FSS '+ QuotedStr(' - ') +' || EstPro.DscPro as CodIte'+
               ' From CmpR14,EstPro,FinVen,FinCli'+
               ' Where CmpR14.CodClp = EstPro.CodClp'+
               '   and CmpR14.CodGru = EstPro.CodGru'+
               '   and CmpR14.CodSub = EstPro.CodSub'+
               '   and CmpR14.CodPro = EstPro.CodPro'+
               '   and CmpR14.CodVen = FinVen.CodVen'+
               '   and CmpR14.CodCli = FinCli.CodCli and CmpR14.SeqArq = '+ QuotedStr(SeqArq);
