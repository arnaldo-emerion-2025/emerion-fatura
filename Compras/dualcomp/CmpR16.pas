...
begin
  ...
  if rgValor.ItemIndex = 0 then
    sBase := ' Select EstIte.CodEmp,' +
      ...
      '        EstIte.CodClp || _UNICODE_FSS ''' + '-' + ''' || EstIte.CodGru || _UNICODE_FSS ''' + '.' + ''' || EstIte.CodSub || _UNICODE_FSS ''' + '.' +
        ''' || EstIte.CodPro as CodIte' +
