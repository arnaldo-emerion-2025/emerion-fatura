...
begin
  ...
  with quSQL,SQL do begin
       ...
       Text := ' Insert Into CmpR02(SeqArq,CodEmp,CodFil,LanEst,CodClp,CodGru,CodSub,CodPro,QtdReg,QtdPed)'+
               ...
               ' Group by PedRe2.CodEmp,PedRes.CodFil,PedRes.LanEst,PedRe2.CodClp,PedRe2.CodGru,PedRe2.CodSub,PedRe2.CodPro';
       ExecSQL;
  ...
  with PedRes,SQL do begin
       ...
       Text := ' Select CmpR02.*,'+
               ...
               ' Order by CmpR02.CodGru,CmpR02.CodSub,CmpR02.CodPro';
       Open;
