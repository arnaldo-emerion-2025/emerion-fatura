inherited fmCmpR01: TfmCmpR01
  Left = 0
  Caption = 'Relação de Preços de Fornecedores'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grPfo: TdxDBGrid
    ...
    SummaryGroups = <
      item
        ...
        SummaryItems = <
          item
            ColumnName = 'grPfoCODPFO'
            SummaryFormat = 'Qtd Itens #####0'
            SummaryType = cstCount
          end>
        Name = 'grPfoSummaryGroup1'
      end>
    SummarySeparator = ', '
    BorderStyle = bsNone
    Color = clInfoBk
    ...
    ShowRowFooter = True
    OnReloadGroupList = grPfoReloadGroupList
    object grPfoNOMFOR: TdxDBGridMaskColumn
      Caption = 'Fornecedor'
      Sorted = csUp
      Visible = False
      Width = 507
    ...
    object grPfoCODPFO: TdxDBGridMaskColumn
    ...
    object grPfoCODITE: TdxDBGridMaskColumn
    ...
    object grPfoDSCPRO: TdxDBGridMaskColumn
      Caption = 'Descrição'
      Sorted = csUp
      Width = 253
      BandIndex = 0
    ...
    object grPfoIDEPRO: TdxDBGridColumn
    ...
    object grPfoVALPFO: TdxDBGridMaskColumn
      Caption = 'Valor S/IPI'
      Font.Charset = ANSI_CHARSET
      Font.Color = clRed
      Font.Height = -11
    ...
    object grPfoDSCPFO: TdxDBGridMaskColumn
      Caption = '% Desc'
      Font.Charset = ANSI_CHARSET
      Font.Color = clRed
      Font.Height = -11
    ...
    object grPfoPERIPI: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = '% IPI'
      HeaderAlignment = taRightJustify
      Width = 72
    ...
    object grPfoVALFIN: TdxDBGridColumn
      Caption = 'Valor C/IPI'
      Font.Charset = ANSI_CHARSET
      Font.Color = clRed
      Font.Height = -11
    ...
    object grPfoVARPFO: TdxDBGridColumn
      Alignment = taRightJustify
      Caption = '% Variação'
      HeaderAlignment = taRightJustify
      Width = 86
  ...
  object CmpPfo: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           EstPro.DscPro,'
        ...
        '           CmpPfo.CodClp || _UNICODE_FSS '#39'-'#39' || CmpPfo.CodGru ||' +
        ' _UNICODE_FSS '#39'.'#39' || CmpPfo.CodSub || _UNICODE_FSS '#39'.'#39' || CmpPfo' +
        '.CodPro as CodIte'
      'From CmpPfo LEFT JOIN FinFor ON (CmpPfo.CodFor = FinFor.CodFor)'
      
        '                     LEFT JOIN EstPro ON (CmpPfo.CodClp = EstPro' +
        '.CodClp)'
    ...
    object CmpPfoSEQPFO: TIntegerField
      FieldName = 'SEQPFO'
    end
    ...
    object CmpPfoFLGTRG: TStringField
      FieldName = 'FLGTRG'
      FixedChar = True
      Size = 1
    end
    ...
    object CmpPfoNOMFOR: TStringField
      FieldName = 'NOMFOR'
      FixedChar = True
      Size = 100
    end
    ...
    object CmpPfoIDEPRO: TStringField
      FieldName = 'IDEPRO'
      FixedChar = True
      Size = 30
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Preços de Fornecedores'#13#10#13#10
      BandColor = clWhite
