...
type
  TfmManEn9 = class(TfmShowPadrao)
    ...
    CmpOenNRONFS: TIntegerField;
    CmpOenID_CMPNFS: TIntegerField;
    CmpOenDTEFAT: TDateTimeField;
    CmpOenHREFAT: TStringField;
    CmpOenTOTIT1: TFloatField;
    CmpOenTOTIP1: TFloatField;
    CmpOenTOTSU1: TFloatField;
    CmpOenTOTGE1: TFloatField;
...
procedure TfmManEn9.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
  if key = 27 then close;
end;

procedure TfmManEn9.bretornarClick(Sender: TObject);
begin
  Close;
end;

procedure TfmManEn9.PaintBoxPaint(Sender: TObject);
begin
  with Sender as TPaintBox do
       FillGrayGradientRect(PaintBox.Canvas, PaintBox.ClientRect, PaintBox.Color);
end;

procedure TfmManEn9.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TfmManEn9.grOenKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfmManEn9.DsOenDataChange(Sender: TObject; Field: TField);
begin
  inherited;
