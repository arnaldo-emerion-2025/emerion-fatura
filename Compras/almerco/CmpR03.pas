...
uses dxDemoUtils, Bbgeral, Bbfuncao, Bbmensag, PsqEmp, PsqGru, PsqSub, PsqPro,
     PsqClp, CmpR03c, PsqTip, ManGDB, AuxIni, AuxPsq;

{$R *.DFM}

procedure TfmCmpR03.Save(ADefaultExt, AFilter, AFileName: String; AMethod: TSaveMethod);
begin
...
procedure TfmCmpR03.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.bPesquisaClick(Sender: TObject);
begin
  ...
  sFiltro := sFiltro + ' and not CmpPed.SitPed = '+ QuotedStr('Recebido')
                     + ' and not CmpPed.SitPed = '+ QuotedStr('Saldo Nao Atendido')
                     + ' and not CmpPed.SitPed = '+ QuotedStr('Nao Concluido');
...
procedure TfmCmpR03.FormShow(Sender: TObject);
begin
  inherited;
  EdCodEmp.SetFocus;
end;

procedure TfmCmpR03.PaintBoxPaint(Sender: TObject);
begin
  inherited;
  with Sender as TPaintBox do FillGrayGradientRect(PaintBox.Canvas, PaintBox.ClientRect, PaintBox.Color);
end;

procedure TfmCmpR03.bImprimeClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.grPe2ReloadGroupList(Sender: TObject);
begin
  inherited;
  (Sender as TdxDBGrid).FullExpand;
end;

procedure TfmCmpR03.HTMLClick(Sender: TObject);
begin
  inherited;
  Save('htm', 'HTML File (*.htm; *.html)|*.htm', 'Relação de pedidos de compra pendentes.htm', grPe2.SaveToHTML);
end;

procedure TfmCmpR03.ExcelClick(Sender: TObject);
begin
  inherited;
  Save('xls', 'Microsoft Excel 4.0 Worksheet (*.xls)|*.xls', 'Relação de pedidos de compra pendentes.xls', grPe2.SaveToXLS);
end;

procedure TfmCmpR03.XMLClick(Sender: TObject);
begin
  inherited;
  Save('xml', 'XML File (*.xml)|*.xml', 'Relação de pedidos de compra pendentes.xml', grPe2.SaveToXML);
end;

procedure TfmCmpR03.BbPsqEmpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodEmpExit(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodEmpKeyPress(Sender: TObject; var Key: Char);
begin
  inherited;
  if not ( key in [ '0'..'9' ] ) then key := #0;
end;

procedure TfmCmpR03.BbPsqClpClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodClpExit(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.BbPsqGruClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodGruExit(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.BbPsqSubClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodSubExit(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.BbPsqProClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodProExit(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.Colunas1Click(Sender: TObject);
begin
  inherited;

  try

     fmCmpR03c := TfmCmpR03c.Create(Self);

     fmCmpR03c.ShowModal;

  finally

     FreeAndNil(fmCmpR03c);

  end;
end;

procedure TfmCmpR03.bPsqTipClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodTipExit(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.bPsqCatClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodCatExit(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.bPsqMrcClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodMrcExit(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.EdCodForKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
  inherited;
...
procedure TfmCmpR03.EdCodForExit(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.BbPsqForClick(Sender: TObject);
begin
  inherited;
...
procedure TfmCmpR03.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  inherited;
...
procedure TfmCmpR03.FormDestroy(Sender: TObject);
begin
  inherited;
  fmCmpR03 := nil;
end;
