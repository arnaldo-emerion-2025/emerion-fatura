inherited fmCmpR10: TfmCmpR10
  Left = 0
  Caption = 'Relação sintética de entradas de mercadorias'
  ClientHeight = 481
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object Label28: TLabel
    ...
    Width = 166
    Height = 13
    Caption = 'Operação realizada no periodo de:'
  ...
  object Label15: TLabel
    ...
    Width = 164
    Height = 13
    Caption = 'Documento emitido no periodo de:'
    Font.Charset = ANSI_CHARSET
    Font.Color = clBlack
    Font.Height = -11
    Font.Name = 'Tahoma'
  ...
  object grEnt: TdxDBGrid
    ...
    object NUMDOC: TdxDBGridMaskColumn
    ...
    object ID_CMPENT: TdxDBGridMaskColumn
    ...
    object DTEOPE: TdxDBGridDateColumn
      Caption = 'Dt. Entrada'
      Width = 94
      BandIndex = 0
      RowIndex = 0
    ...
    object TOTENC: TdxDBGridMaskColumn
    ...
    object TOTICC: TdxDBGridMaskColumn
      Caption = 'Total ICMS'
      HeaderAlignment = taRightJustify
      Width = 102
      BandIndex = 0
    ...
    object TOTIPC: TdxDBGridMaskColumn
      Caption = 'Total IPI'
      HeaderAlignment = taRightJustify
      Width = 97
      BandIndex = 0
    ...
    object TOTGEC: TdxDBGridMaskColumn
  ...
  object CmpEnt: TwwQuery
    ...
    SQL.Strings = (
      ...
      'Where CmpEnt.DteOpe = :DteOpe'
      'Order by CmpEnt.NumDoc')
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      PrinterPage.PageHeader.LeftTitle.Strings = (
        ...
        'Operação realizada no periodo de:'
        'Documento emitido no periodo de:')
      ...
      ReportTitle.Text = #13#10'Relação sintética de entradas de mercadorias'#13#10
      BandColor = clWhite
