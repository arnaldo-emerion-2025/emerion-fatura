inherited fmManMLc: TfmManMLc
  Left = 60
  Top = 105
  Caption = 'Agrupamento de tipos de lançamento'
  ClientHeight = 439
  ClientWidth = 598
  Color = 15788249
  OnClose = FormClose
  ...
  object pcMLc: TPageControl
    ...
    object pcPag1: TTabSheet
      ...
      object Label3: TLabel
        ...
        Width = 160
        Height = 13
        Caption = 'Agrupamentos selecionados'
        Color = clBtnFace
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
      ...
      object Panel1: TPanel
        ...
        object grMLc: ThGrid
          ...
          Height = 257
          Selected.Strings = (
            'ID_CMPMLC'#9'13'#9'Código'
            
              'NOMMLC'#9'84'#9'Descrição                                             ' +
              '                                                                ' +
              '                                          ')
    ...
    object pcPag2: TTabSheet
      ...
      object EdNomMLc: TdxDBColorEdit
        Left = 121
        Top = 45
        Width = 476
        Color = 16577773
  ...
  object CmpMlc: TwwQuery
    Active = True
    CachedUpdates = True
    OnNewRecord = CmpMlcNewRecord
    DatabaseName = 'ISade'
    SessionName = 'Default'
    SQL.Strings = (
      'Select * From CmpMLc'
      'Order by CmpMLc.Id_CmpMLc')
    UpdateObject = upCmpMLc
  ...
  object upCmpMLc: TUpdateSQL
    ModifySQL.Strings = (
      'update CmpMLc'
      'set'
      '  NOMMLC = :NOMMLC'
      'where'
      '  ID_CMPMLC = :OLD_ID_CMPMLC')
    InsertSQL.Strings = (
      'insert into CmpMLc'
      '  (ID_CMPMLC, NOMMLC)'
      'values'
  ...
  object ppReport: TppReport
    ...
    Template.FileName = 'C:\_WGSYS\Emerion\Compras\Almerco\Relatorios\RManMlc.rtm'
    Units = utMillimeters
    UserName = 'Report'
    CachePages = True
    DeviceType = 'Screen'
    ...
    object hbReport: TppHeaderBand
      ...
      object ppLabel20: TppLabel
        UserName = 'QrTitulo1'
        Caption = 'Agrupamento de tipos de lançamentos'
        Font.Charset = ANSI_CHARSET
        Font.Color = clNavy
        Font.Name = 'Tahoma'
        Font.Size = 10
