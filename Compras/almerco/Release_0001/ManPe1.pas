...
begin
  ...
  fmManPed.CmpPedCepEnt.Value := Trim(fmManPed.CmpPedCepEnt.Value);
  fmManPed.CmpPedTenEnt.Value := Trim(fmManPed.CmpPedTenEnt.Value);
  fmManPed.CmpPedEndEnt.Value := Trim(fmManPed.CmpPedEndEnt.Value);
  fmManPed.CmpPedNumEnt.Value := Trim(fmManPed.CmpPedNumEnt.Value);
  fmManPed.CmpPedRefEnt.Value := Trim(fmManPed.CmpPedRefEnt.Value);
  fmManPed.CmpPedRefEnt.Value := Trim(fmManPed.CmpPedRefEnt.Value);
  fmManPed.CmpPedBaiEnt.Value := Trim(fmManPed.CmpPedBaiEnt.Value);
  fmManPed.CmpPedCidEnt.Value := Trim(fmManPed.CmpPedCidEnt.Value);
  fmManPed.CmpPedUfeEnt.Value := Trim(fmManPed.CmpPedUfeEnt.Value);
