...
uses Bbgeral, Bbacesso, Bbmensag, Bbfuncao, Bberro, ManGDB, VerUsu, ManTSe,
     ...
     ManAce, ManEpe, ManPco, CmpR01, ManApr, CmpR03, CmpR04, PsqEs2, CmpR10,
     EstR06, CmpR07, CmpR08, CmpR14, CmpR11, ManEnt, CmpR05, ManRom, CmpR12,
     EstR04, EstR03, CmpR13, CmpR15, CmpR16, CmpR17, CmpR18, ManGFo, ManAco,
     ManCen, CmpR20, ManLro, ManLr2, ManLr3, ManLic, ManAut, ManReq, CmpR02,
     ManPor, ManArm, ManAge, ManDes, ManImp, ManSco, ManRo6, ManRo7;
...
begin
  ...
  if sNome = 'CMP0109' then CriarForm(TfmManPor, fmManPor);
  if sNome = 'CMP0110' then CriarForm(TfmManArm, fmManArm);
  if sNome = 'CMP0111' then CriarForm(TfmManAge, fmManAge);
  if sNome = 'CMP0112' then CriarForm(TfmManImp, fmManImp);
  if sNome = 'CMP0113' then CriarForm(TfmManDes, fmManDes);
  ...
  if sNome = 'CMP0107' then CriarForm(TfmManSco, fmManSco);
  ...
  if sNome = 'CMP020406' then CriarForm(TfmManRo6, fmManRo6);
  if sNome = 'CMP020407' then CriarForm(TfmManRo7, fmManRo7);
     ...
     if sCancelar = 'N' then begin
        ...
        with quSQL,SQL do begin
             ...
             Text := ' Select Count(*) as QtdReg'+
                     ' From CmpReq'+
                     ' Where CmpReq.SldReq > '+ QuotedStr('0');
             Open;
        ...
        if quSQL.FieldbyName('QtdReg').AsInteger > 0 then begin
           ...
           try
              ...
              fmManReq := TfmManReq.Create(Self);
              fmManReq.ShowModal;
