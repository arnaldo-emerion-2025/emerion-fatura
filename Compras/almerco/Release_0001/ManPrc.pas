...
type
  TfmManPrc = class(TfmShowPadrao)
    ...
    CmpAenID_CMPEN2: TIntegerField;
    CmpAenCODCLP: TStringField;
...
begin
  ...
  if CmpAenId_CmpEn2.Value > 0 then
     pnCodIte.Caption := CmpAenCodClp.Value+ '-' +
                         CmpAenCodGru.Value+ '.' +
                         CmpAenCodSub.Value+ '.' +
                         CmpAenCodPro.Value
  else
  ...
  pnTotEn2.Caption := FormatFloat('###,###,##0.00',CmpAenTotEn2.Value)+' ';
  pnTotGe2.Caption := FormatFloat('###,###,##0.00',CmpAenTotGe2.Value)+' ';
  pnValIpi.Caption := FormatFloat('###,###,##0.00',CmpAenValIpi.Value)+' ';
  pnValIcm.Caption := FormatFloat('###,###,##0.00',CmpAenValIcm.Value)+' ';
  ...
  pnTotImp.Caption := FormatFloat('###,###,##0.00',CmpAenTotImp.Value)+' ';
  pnValDsc.Caption := FormatFloat('###,###,##0.00',CmpAenValDsc.Value)+' ';
  pnValAcr.Caption := FormatFloat('###,###,##0.00',CmpAenValAcr.Value)+' ';
  pnValFrt.Caption := FormatFloat('###,###,##0.00',CmpAenValFrt.Value)+' ';
  pnValSeg.Caption := FormatFloat('###,###,##0.00',CmpAenValSeg.Value)+' ';

  if CmpAenValSub.Value > 0 then
     pnValDes.Caption := FormatFloat('###,###,##0.00',CmpAenValDes.Value + CmpAenValSub.Value)+' '
  else
     pnValDes.Caption := FormatFloat('###,###,##0.00',CmpAenValDes.Value)+' ';
