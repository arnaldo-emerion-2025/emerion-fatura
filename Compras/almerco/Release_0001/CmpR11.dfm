inherited fmCmpR11: TfmCmpR11
  Left = 0
  Caption = 'Relação sintética de entrada de mercadorias por tipo de produto'
  ClientHeight = 481
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object CmpR11: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           Round(Sum(EstHis.QtMovi * EstHis.VpfHis),4) as TotEnt'
        ...
        'From EstHis LEFT JOIN CmpEn2 ON (EstHis.Id_CmpEn2 = CmpEn2.Id_Cm' +
        'pEn2)'
      
        '                    LEFT JOIN CmpEnt ON (CmpEn2.Id_CmpEnt = CmpE' +
        'nt.Id_CmpEnt)'
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = 
        #13#10'Relação sintética de entrada de mercadorias por tipo de produt' +
        'o'#13#10
      BandColor = clWhite
