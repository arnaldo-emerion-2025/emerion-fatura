inherited fmCmpR12: TfmCmpR12
  Left = 0
  Caption = 'Relação de romaneios pendentes'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grPe2: TdxDBGrid
    ...
    object ID_CMPPED: TdxDBGridMaskColumn
      Caption = 'No. Romaneio'
      Width = 103
      BandIndex = 0
      RowIndex = 0
    ...
    object DTEPED: TdxDBGridDateColumn
      Caption = 'Emissão'
      Width = 87
      BandIndex = 0
      RowIndex = 0
    ...
    object QTRPE2: TdxDBGridMaskColumn
      Caption = 'Recebido'
      HeaderAlignment = taRightJustify
      Width = 103
      BandIndex = 0
    ...
    object SLDPE2: TdxDBGridMaskColumn
      Caption = 'A Receber'
      HeaderAlignment = taRightJustify
      Width = 104
      BandIndex = 0
    ...
    object VLUPE2: TdxDBGridMaskColumn
      Caption = 'Unitário'
      HeaderAlignment = taRightJustify
      Width = 90
      BandIndex = 0
    ...
    object IPIPE2: TdxDBGridMaskColumn
      Caption = '% IPI'
      HeaderAlignment = taRightJustify
      Width = 70
      BandIndex = 0
    ...
    object ICMPE2: TdxDBGridMaskColumn
      Caption = '% ICMS'
      HeaderAlignment = taRightJustify
      Width = 75
      BandIndex = 0
    ...
    object APEFOR: TdxDBGridMaskColumn
      Caption = 'Fornecedor'
      Sorted = csUp
      Visible = False
      Width = 127
  ...
  object CmpNf2: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           Round(CmpR12.SldPe2 * CmpR12.VluPe2,4) as TotNat,'
        ...
        '           TextoOcor(IntStrZeros(CmpR12.CodFor,5),'#39'-'#39',FinFor.Ape' +
        'For,'#39#39','#39#39','#39#39','#39#39') as ApeFor,'
      
        '           CmpR12.CodClp || _UNICODE_FSS '#39'-'#39' || CmpR12.CodGru ||' +
        ' _UNICODE_FSS '#39'.'#39' || CmpR12.CodSub || _UNICODE_FSS '#39'.'#39' || CmpR12' +
        '.CodPro as CodIte'
      'From CmpR12 LEFT JOIN EstPro ON (CmpR12.CodClp = EstPro.CodPro'
        ...
        '                        LEFT JOIN FinFor ON (CmpR12.CodFor = Fin' +
        'For.CodFor)'
      
        '                      LEFT JOIN GerUsu ON (CmpR12.CodUsu = GerUs' +
        'u.CodUsu)'
      'Where CmpR12.SeqArq = :SeqArq'
      
        'Order by CmpR12.CodClp,CmpR12.CodGru,CmpR12.CodSub,CmpR12.CodPro' +
        ',CmpR12.Id_CmpPed'
      ''
      '')
    ...
    object CmpNf2DTEPED: TDateTimeField
      DisplayWidth = 10
      FieldName = 'DTEPED'
      EditMask = '!99/99/9999;1;_'
    end
    object CmpNf2DPEPED: TDateTimeField
      DisplayWidth = 10
      FieldName = 'DPEPED'
      EditMask = '!99/99/9999;1;_'
    end
    ...
    object CmpNf2QTPPE2: TFloatField
      FieldName = 'QTPPE2'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object CmpNf2QTRPE2: TFloatField
      FieldName = 'QTRPE2'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object CmpNf2SLDPE2: TFloatField
      FieldName = 'SLDPE2'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    object CmpNf2VLUPE2: TFloatField
      FieldName = 'VLUPE2'
      DisplayFormat = '###,###,##0.0000'
      Precision = 4
    end
    ...
    object CmpNf2IPIPE2: TFloatField
      FieldName = 'IPIPE2'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object CmpNf2ICMPE2: TFloatField
      FieldName = 'ICMPE2'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object CmpNf2DSCPE2: TFloatField
      FieldName = 'DSCPE2'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object CmpNf2PACPE2: TFloatField
      FieldName = 'PACPE2'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    object CmpNf2LOGUSU: TStringField
      FieldName = 'LOGUSU'
      FixedChar = True
      Size = 15
    end
    object CmpNf2APEFOR: TStringField
      FieldName = 'APEFOR'
      FixedChar = True
      Size = 100
    end
    object CmpNf2DSCPRO: TStringField
      FieldName = 'DSCPRO'
      FixedChar = True
      Size = 70
    end
    object CmpNf2TOTNAT: TFloatField
      FieldName = 'TOTNAT'
      DisplayFormat = '###,###,##0.00'
      Precision = 2
    end
    ...
    object CmpNf2ID_CMPPED: TIntegerField
      Alignment = taLeftJustify
      FieldName = 'ID_CMPPED'
    end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de Romaneios Pendentes'#13#10
      BandColor = clWhite
