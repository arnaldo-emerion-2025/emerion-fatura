inherited fmCmpR05: TfmCmpR05
  Left = 0
  Caption = 'Curva ABC de itens'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grR05: TdxDBGrid
    ...
    object QTDVEN: TdxDBGridMaskColumn
      Caption = 'Qtd. Vend'
      HeaderAlignment = taRightJustify
      Width = 80
      BandIndex = 0
    ...
    object TOTVEN: TdxDBGridMaskColumn
      Caption = 'Total Vend'
      HeaderAlignment = taRightJustify
      Width = 100
      BandIndex = 0
    ...
    object TOTCST: TdxDBGridMaskColumn
      Caption = 'Custo'
      HeaderAlignment = taRightJustify
      Width = 79
      BandIndex = 0
    ...
    object MARKUP: TdxDBGridMaskColumn
      Caption = '% Mk'
      HeaderAlignment = taRightJustify
      Width = 63
      BandIndex = 0
    ...
    object QTDNAT: TdxDBGridMaskColumn
    ...
    object QTDPED: TdxDBGridMaskColumn
      Caption = 'Reservas'
      HeaderAlignment = taRightJustify
      Width = 76
      BandIndex = 0
    ...
    object QTDCMP: TdxDBGridMaskColumn
      Caption = 'Adquirido'
      HeaderAlignment = taRightJustify
      Width = 78
      BandIndex = 0
    ...
    object SUGCMP: TdxDBGridMaskColumn
      Caption = 'Reposicao'
      HeaderAlignment = taRightJustify
      Width = 82
      BandIndex = 0
  ...
  object CmpR05: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           EstPro.QtdEmb,'
        ...
        '           TextoOcor(IntStrZeros(EstPro.CodCat,3),'#39'-'#39',EstCat.Nom' +
        'Cat,'#39#39','#39#39','#39#39','#39#39') as Categoria,'
      '           '#39'__________'#39' as QtdCon,'
      
        '           CmpR06.CodClp || _UNICODE_FSS '#39'-'#39' || CmpR06.CodGru ||' +
        ' _UNICODE_FSS '#39'.'#39' || CmpR06.CodSub || _UNICODE_FSS '#39'.'#39' || CmpR06' +
        '.CodPro as CodIte'
      'From CmpR06 LEFT JOIN EstPro ON (CmpR06.CodClp = EstPro.CodClp'
        ...
        '                       LEFT JOIN EstCat ON (EstPro.CodCat = EstC' +
        'at.CodCat)'
      'Where CmpR06.SeqArq = :SeqArq')
    ...
    object CmpR05QTDTRF: TFloatField
      FieldName = 'QTDTRF'
      DisplayFormat = '###,###,##0'
    end
    ...
    object CmpR05MARCA: TStringField
      FieldName = 'MARCA'
      FixedChar = True
      Size = 100
    end
    object CmpR05ULTCMP: TFloatField
      FieldName = 'ULTCMP'
      DisplayFormat = '###,###,##0'
      Precision = 4
    end
    object CmpR05DULCMP: TDateTimeField
      FieldName = 'DULCMP'
    end
    object CmpR05CODITE: TStringField
      FieldName = 'CODITE'
      Size = 18
    end
    object CmpR05IDEPRO: TStringField
      FieldName = 'IDEPRO'
      FixedChar = True
      Size = 30
    end
    object CmpR05CODANT: TStringField
      FieldName = 'CODANT'
      FixedChar = True
      Size = 30
    end
    object CmpR05NUMPRO: TStringField
      FieldName = 'NUMPRO'
      FixedChar = True
      Size = 30
    end
    object CmpR05CODCAT: TIntegerField
      FieldName = 'CODCAT'
    end
    object CmpR05CODTIP: TIntegerField
      FieldName = 'CODTIP'
    end
    object CmpR05CODMRC: TIntegerField
      FieldName = 'CODMRC'
    end
    object CmpR05QTDEMB: TFloatField
      FieldName = 'QTDEMB'
      DisplayFormat = '###,###,##0'
      Precision = 4
    end
    object CmpR05QTDMAX: TFloatField
      FieldName = 'QTDMAX'
      DisplayFormat = '###,###,##0'
    end
    object CmpR05QTDCON: TStringField
      FieldName = 'QTDCON'
      FixedChar = True
      Size = 10
    end
    object CmpR05CATEGORIA: TStringField
      FieldName = 'CATEGORIA'
      FixedChar = True
      Size = 100
    end
    object CmpR05REFPRO: TStringField
      FieldName = 'REFPRO'
    end
  end
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      Active = True
      Component = grR05
      DateTime = 40080.7242584375
      DesignerHelpContext = 0
      PrinterPage.DMPaper = 9
      PrinterPage.Footer = 6350
      PrinterPage.Header = 6350
      PrinterPage.Margins.Bottom = 12700
      PrinterPage.Margins.Left = 3400
      PrinterPage.Margins.Right = 3200
      PrinterPage.Margins.Top = 49500
      ...
      ReportTitle.Text = #13#10'Curva ABC de itens'#13#10#13#10
      BandColor = clWhite
