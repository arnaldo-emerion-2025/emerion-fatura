inherited fmCmpR08: TfmCmpR08
  Left = 0
  Caption = 'Curva ABC de fornecedores - Entradas de itens '
  ClientHeight = 481
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object EdPsqCodTp1: TdxColorEdit
    Left = 143
    Top = 35
    Width = 87
    Color = 16577773
  ...
  object EdPsqCodTp2: TdxColorEdit
    Left = 254
    Top = 35
    Width = 87
    Color = 16577773
  ...
  object CmpEnt: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           GerUsu.LogUsu as ConFor,'
        ...
        '           TextoOcor(IntStrZeros(CmpR01.CodFor,5),'#39'-'#39',FinFor.Ape' +
        'For,'#39#39','#39#39','#39#39','#39#39') as NomFor'
      'From CmpR01 LEFT JOIN FinFor ON (CmpR01.CodFor = FinFor.CodFor)'
      
        '                       LEFT JOIN GerUsu ON (FinFor.CodSup = GerU' +
        'su.CodUsu)'
      'Where CmpR01.SeqArq = :SeqArq')
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Curva ABC de fornecedores - Entradas de itens'#13#10#13#10
      BandColor = clWhite
