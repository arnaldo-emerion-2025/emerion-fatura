inherited fmCmpR13: TfmCmpR13
  Left = 0
  Caption = 'Relação de pagamentos previstos para pedidos de compra'
  ClientHeight = 482
  ClientWidth = 786
  Position = poDesigned
  OnClose = FormClose
  ...
  object grPe5: TdxDBGrid
    ...
    object grPe5ID_CMPPED: TdxDBGridMaskColumn
      Caption = 'Nro. Pedido'
      Width = 113
      BandIndex = 0
      RowIndex = 0
  ...
  object CmpPe5: TwwQuery
    ...
    SQL.Strings = (
      ...
      '           CmpPe5.ValPe5,'
        ...
        'From CmpPe5 LEFT JOIN CmpPed ON (CmpPe5.Id_CmpPed = CmpPed.Id_Cm' +
        'pPed)'
      
        '                           LEFT JOIN FinFor ON (CmpPe5.CodFor = ' +
        'FinFor.CodFor)'
      'Where CmpPed.DtePed = :DtePed'
    ...
    object CmpPe5ID_CMPPED: TIntegerField
  ...
  object dxComponentPrinter: TdxComponentPrinter
    ...
    object dxComponentPrinterLink1: TdxDBGridReportLink
      ...
      ReportTitle.Text = #13#10'Relação de pagamentos previstos para pedidos de compra '#13#10
      BandColor = clWhite
